...
## templated vector in aGrUM_wrap_BASE.i

Les templates de vecteurs suivants définis en ligne 74-77 semblent être utilisés uniquement dans certain typemaps de pyagrum.i. Il serait plus propre de les définir directement dans pyagrum.i, ou mieux, de les remplacer par des typemaps utilisant `std::vector` directement.
...
- Vérifier si le code de tensor.i, et en particulier les opérateurs **getitem**/**setitem** peuvent profiter de
