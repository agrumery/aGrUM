...
namespace gum {
  ...
  /**
   * @class DefaultInfluenceDiagramInference defaultInfluenceDiagramInference.h <agrum/ID/inference/defaultInfluenceDiagramInference.h>
...
#include <agrum/ID/inference/defaultInfluenceDiagramInference.tcc>
