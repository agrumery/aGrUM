...
namespace gum {
  ...
  /**
   * @class InfluenceDiagramInference influenceDiagramInference.h <agrum/ID/inference/influenceDiagramInference.h>
  ...
  class InfluenceDiagramInference: public IInfluenceDiagramInference<GUM_SCALAR> {
    ...
    public:
      ...
      /// @see gum::IInfluenceDiagramInference::getBestDecisionChoice( NodeId decisionId )
