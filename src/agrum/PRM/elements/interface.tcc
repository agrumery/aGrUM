...
namespace gum {
  namespace prm {
    ...
    template<typename GUM_SCALAR>
    Interface<GUM_SCALAR>::Interface( const std::string& name, Interface<GUM_SCALAR>& super ) :
      ClassElementContainer<GUM_SCALAR> ( name ), __dag( super.__dag ), __super( &super ) {
      GUM_CONSTRUCTOR( Interface );
    ...
    Interface<GUM_SCALAR>::__inheritInterface( const Interface<GUM_SCALAR>& i ) {
      ...
      for( const auto i_ref :  i.__referenceSlots ) {
        ReferenceSlot<GUM_SCALAR>* ref = new ReferenceSlot<GUM_SCALAR> ( i_ref->name(),
    ...
    template<typename GUM_SCALAR>
    NodeId
    Interface<GUM_SCALAR>::add( ClassElement<GUM_SCALAR>* elt ) {
    ...
    Interface<GUM_SCALAR>::overload( ClassElement<GUM_SCALAR>* overloader ) {
      ...
      switch( overloader->elt_type() ) {
        ...
        case ClassElement<GUM_SCALAR>::prm_refslot: {
          ReferenceSlot<GUM_SCALAR>* ref = static_cast<ReferenceSlot<GUM_SCALAR>*>( overloader );
          ...
          __referenceSlots.erase( static_cast<ReferenceSlot<GUM_SCALAR>*>( overloaded ) );
          delete overloaded;
          break;
        }
        ...
        case ClassElement<GUM_SCALAR>::prm_slotchain: {
          GUM_ERROR( WrongClassElement, "wrong ClassElement<GUM_SCALAR> to overload can not be overloaded" );
          break;
        }
    ...
    template<typename GUM_SCALAR>
    void
    Interface<GUM_SCALAR>::__addCastDescendants( Attribute<GUM_SCALAR>* start, Attribute<GUM_SCALAR>* end ) {
    ...
    template<typename GUM_SCALAR>
    void
    Interface<GUM_SCALAR>::__checkOverloadLegality( const ClassElement<GUM_SCALAR>* overloaded, const ClassElement<GUM_SCALAR>* overloader ) {
    ...
    template<typename GUM_SCALAR>
    bool
    Interface<GUM_SCALAR>::isSubTypeOf( const ClassElementContainer<GUM_SCALAR>& cec ) const {
      switch( cec.obj_type() ) {
    ...
    Interface<GUM_SCALAR>::_updateDescendants( const ClassElement<GUM_SCALAR>& elt ) {
      ...
      for( const auto impl : __implementations ) {
        ...
        ClassElementContainer<GUM_SCALAR>* c = reinterpret_cast<ClassElementContainer<GUM_SCALAR>*>( impl );
    ...
    template<typename GUM_SCALAR> INLINE
    const Interface<GUM_SCALAR>&
    Interface<GUM_SCALAR>::super() const {
      if( __super )
        return *__super;
      else
        GUM_ERROR( NotFound, "this Interface is not a sub interface" );
    ...
    template<typename GUM_SCALAR> INLINE
    void
    Interface<GUM_SCALAR>::__addExtension( Interface* i ) {
      __extensions.insert( i );
    }

    template<typename GUM_SCALAR> INLINE
    ClassElement<GUM_SCALAR>&
    Interface<GUM_SCALAR>::operator[]( NodeId id ) {
      return get( id );
    }

    template<typename GUM_SCALAR> INLINE
    const ClassElement<GUM_SCALAR>&
    Interface<GUM_SCALAR>::operator[]( NodeId id ) const {
      return get( id );
    }

    template<typename GUM_SCALAR> INLINE
    ClassElement<GUM_SCALAR>&
    Interface<GUM_SCALAR>::operator[]( const std::string& name ) {
      return get( name );
    }

    template<typename GUM_SCALAR> INLINE
    const ClassElement<GUM_SCALAR>&
    Interface<GUM_SCALAR>::operator[]( const std::string& name ) const {
      return get( name );
    }

    template<typename GUM_SCALAR> INLINE
    typename PRMObject::PRMType
    Interface<GUM_SCALAR>::obj_type() const {
    ...
    template<typename GUM_SCALAR> INLINE
    ClassElement<GUM_SCALAR>&
    Interface<GUM_SCALAR>::get( NodeId id ) {
      try {
    ...
    template<typename GUM_SCALAR> INLINE
    Set<Class<GUM_SCALAR>*>&
    Interface<GUM_SCALAR>::implementations() {
