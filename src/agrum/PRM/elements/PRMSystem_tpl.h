...
namespace gum {
    namespace prm {
        ...
        template<typename GUM_SCALAR>
        INLINE PRMSystem<GUM_SCALAR>::PRMSystem(const PRMSystem &from) : PRMObject(from), skeleton_(from.skeleton_),
                                                                         nodeIdMap_(from.nodeIdMap_),
                                                                         nameMap_(from.nameMap_),
                                                                         instanceMap_(from.instanceMap_),
                                                                         arrayMap_(from.arrayMap_) {
