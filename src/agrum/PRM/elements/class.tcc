...
namespace gum {
  namespace prm {
    ...
    template <typename GUM_SCALAR>
    void
    Class<GUM_SCALAR>::__overloadAttribute(Attribute<GUM_SCALAR>* overloader,
    ...
    template <typename GUM_SCALAR>
    void
    Class<GUM_SCALAR>::__overloadParameter(Parameter<GUM_SCALAR>* overloader,
