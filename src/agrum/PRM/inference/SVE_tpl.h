...
namespace gum {
  namespace prm {
    ...
    template < typename GUM_SCALAR >
    void SVE< GUM_SCALAR >::_posterior(const Chain&             chain,
    ...
    template < typename GUM_SCALAR >
    INLINE bool SVE< GUM_SCALAR >::__checkElimOrder(
    ...
    template < typename GUM_SCALAR >
    INLINE Potential< GUM_SCALAR >* SVE< GUM_SCALAR >::__getAggPotential(
