...
namespace gum {
  namespace prm {
    ...
    PRM<GUM_SCALAR>*
    ClusteredLayerGenerator<GUM_SCALAR>::generate() {
      if ( __layers.size() == 0 ) {
    ...
    template<typename GUM_SCALAR>
    std::string
    ClusteredLayerGenerator<GUM_SCALAR>::__generateType ( PRMFactory<GUM_SCALAR>& factory ) {
    ...
    template<typename GUM_SCALAR>
    void
    ClusteredLayerGenerator<GUM_SCALAR>::__generateInterfaces ( PRMFactory<GUM_SCALAR>& f,
      ...
      for ( Size lvl = 0; lvl < __layers.size(); ++lvl ) {
        ...
        for ( Size a = 0; a < __layers[lvl].a; ++a ) {
          l[lvl].a.push_back ( this->_name_gen.nextName ( PRMObject::PRMType::CLASS_ELT ) );
          f.addAttribute ( type, l[lvl].a.back() );
        }

        if ( lvl ) {
          for ( Size g = 0; g < __layers[lvl].g; ++g ) {
            l[lvl].g.push_back ( this->_name_gen.nextName ( PRMObject::PRMType::CLASS_ELT ) );
    ...
    template<typename GUM_SCALAR>
    void
    ClusteredLayerGenerator<GUM_SCALAR>::__generateClasses ( PRMFactory<GUM_SCALAR>& f,
        const std::string& type,
        std::vector<ClusteredLayerGenerator<GUM_SCALAR>::MyData>& l ) {
    ...
    template<typename GUM_SCALAR>
    void
    ClusteredLayerGenerator<GUM_SCALAR>::__generateCluster ( PRMFactory<GUM_SCALAR>& f,
        const std::string& type,
        std::vector<ClusteredLayerGenerator<GUM_SCALAR>::MyData>& l,
        Size lvl,
        Set<std::string>& i ) {
    ...
    template<typename GUM_SCALAR>
    void
    ClusteredLayerGenerator<GUM_SCALAR>::__generateClass ( PRMFactory<GUM_SCALAR>& f,
        const std::string& type,
        std::vector<ClusteredLayerGenerator<GUM_SCALAR>::MyData>& l,
        Size lvl,
        Set<std::string>& i ) {
    ...
    template<typename GUM_SCALAR>
    void
    ClusteredLayerGenerator<GUM_SCALAR>::__generateClassDag ( Size lvl, DAG& dag,
        Bijection<std::string, NodeId>& names,
        std::vector<ClusteredLayerGenerator<GUM_SCALAR>::MyData>& l ) {
    ...
    template<typename GUM_SCALAR>
    void
    ClusteredLayerGenerator<GUM_SCALAR>::__generateSystem ( PRMFactory<GUM_SCALAR>& factory, std::vector<ClusteredLayerGenerator<GUM_SCALAR>::MyData>& l ) {
    ...
    template<typename GUM_SCALAR> INLINE
    Size
    ClusteredLayerGenerator<GUM_SCALAR>::getDomainSize() const {
    ...
    template<typename GUM_SCALAR> INLINE
    double
    ClusteredLayerGenerator<GUM_SCALAR>::getClusterRatio() const {
