  ...
  namespace prm {
    namespace o3prm {
      ...
      class O3ClassFactory {
        ...
        bool  _checkLocalParent_(const PRMClass< GUM_SCALAR >& c,
                                const O3Label&                prnt);
        ...
        bool  _checkLabelsNumber_(const O3RuleCPT&         attr,
        ...
        bool  _checkAggParameters_(O3Class&       o3class,
                                  O3Aggregate&   agg,
                                  const PRMType* t);
