    ...
    namespace o3prm {
      ...
      void Parser::TYPE_UNIT() {
        ...
        if ( la->kind == _type ) {
          auto t = O3Type();
          TYPE_DECLARATION(
              t.position(), t.name(), t.superLabel(), t.labels() );
          if ( __ok( n ) ) {
      ...
      void Parser::TYPE_DECLARATION( O3Position& pos,
                                     O3Label& name,
                                     O3Label& super,
                                     LabelMap& labels ) {
        TYPE( pos );
      ...
      void Parser::INT_TYPE_DECLARATION( O3Position& pos,
                                         O3Label& name,
                                         O3Integer& start,
                                         O3Integer& end ) {
        INT( pos );
      ...
      void Parser::REAL_TYPE_DECLARATION( O3Position& pos,
                                          O3Label& name,
                                          O3FloatList& values ) {
        REAL( pos );
        Expect( 27 /* "(" */ );
      ...
      bool Parser::StartOf( int s ) {
        ...
        static bool set[3][32] = {
            ...
            {x, x, x, x, x, x, x, x, x, x, T, T, T, x, T, x,
             x, x, T, T, x, x, x, x, x, x, x, x, x, x, x, x},
            {x, T, T, T, x, x, x, x, x, x, x, x, x, x, x, x,
