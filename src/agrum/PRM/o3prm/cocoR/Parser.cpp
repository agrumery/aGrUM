    ...
    namespace o3prm {
      ...
      void Parser::INTERFACE_UNIT() {
        ...
        INTERFACE_DECLARATION(
            i.position(), i.name(), i.superLabel(), i.elements() );
        if ( __ok( n ) ) {
          __addO3Interface( std::move( i ) );
        }
      }
      ...
      void Parser::CLASS_BODY( O3Class& c ) {
        ...
        } else if ( la->kind == _labels || la->kind == _int ||
                    la->kind == _real ) {
      ...
      void Parser::ARRAY_REFERENCE_SLOT( O3Label&             type,
        ...
        if ( StartOf( 4 ) ) {
          ...
          if ( StartOf( 5 ) ) {
            ...
            EXTENDED_TYPE_DECLARATION(
                t.deprecated(), t.superLabel(), t.labels() );
          }
          if ( __ok( n ) ) {
            __addO3Type( std::move( t ) );
          }
      ...
      void Parser::DISCRETE_TYPE_DECLARATION( bool&     deprecated,
                                              LabelMap& labels ) {
        if ( la->kind == _labels ) {
          Get();
          Expect( 26 /* "(" */ );
      ...
      void Parser::EXTENDED_TYPE_DECLARATION( bool&     deprecated,
                                              O3Label&  super,
                                              LabelMap& labels ) {
        Expect( _extends );
        CHAIN( super );
      ...
      void Parser::SYSTEM_BODY( O3System& sys ) {
        ...
        if ( la->kind == _dot ) {
          ...
          auto tmp_pos =
              O3Position( narrow( scanner->filename() ), t->line, t->col );
          if ( la->kind == _label || la->kind == _dot ||
               la->kind == 28 /* "[" */ ) {
            left_value << ".";
            left_value << tmp;
            while ( la->kind == _dot ) {
      ...
      bool Parser::StartOf( int s ) {
        ...
        static bool set[6][34] = {
            ...
            {x, x, x, x, x, x, x, x, x, x, T, T, T, x, T, x, x,
             x, x, x, T, T, x, x, x, x, x, x, x, x, x, x, x, x},
            {x, x, x, T, x, x, x, x, x, x, x, x, x, x, x, x, x,
             x, T, T, T, T, x, x, x, x, x, x, x, x, x, x, x, x},
            {x, T, T, T, x, x, x, x, x, x, x, x, x, x, x, x, x,
             x, x, x, x, x, x, x, x, x, x, x, x, x, x, T, x, x},
            {x, T, T, T, x, x, x, x, x, x, x, x, x, T, x, x, x,
             x, x, T, x, x, x, x, x, x, x, x, x, x, x, x, x, x},
            {x, T, T, T, x, x, x, x, x, x, x, x, x, x, x, x, x,
             x, x, T, x, x, x, x, x, x, x, x, x, x, x, x, x, x}};
      ...
      Parser::SynErr( const std::wstring& filename, int line, int col, int n ) {
        ...
        switch ( n ) {
          ...
          case 17:
            ...
            break;
          case 18:
            s = coco_string_create( L"param expected" );
            break;
          case 19:
            s = coco_string_create( L"labels expected" );
            break;
          case 20:
            s = coco_string_create( L"int expected" );
            break;
          case 21:
            s = coco_string_create( L"real expected" );
            break;
          case 22:
            s = coco_string_create( L"inc expected" );
            break;
          case 23:
          ...
          case 33:
            ...
            break;
          case 34:
            s = coco_string_create( L"invalid TYPE_UNIT" );
            break;
          case 35:
            s = coco_string_create( L"invalid CLASS_BODY" );
            break;
          case 36:
            s = coco_string_create( L"invalid CLASS_PARAMETER" );
            break;
          case 37:
            s = coco_string_create( L"invalid CLASS_ANON_TYPE_ATTR" );
            break;
          case 38:
            s = coco_string_create( L"invalid CLASS_ELEMENT" );
            break;
          case 39:
            s = coco_string_create( L"invalid ATTRIBUTE" );
            break;
          case 40:
            s = coco_string_create( L"invalid NAMED_CLASS_ELEMENT" );
            break;
          case 41:
            s = coco_string_create( L"invalid AGGREGATE_PARENTS" );
            break;
          case 42:
            s = coco_string_create( L"invalid TYPE_DECLARATION" );
            break;
          case 43:
            s = coco_string_create( L"invalid DISCRETE_TYPE_DECLARATION" );
            break;
          case 44:
            s = coco_string_create( L"invalid EXTENDED_TYPE_DECLARATION" );
            break;
          case 45:
            s = coco_string_create( L"invalid FLOAT_OR_INT" );
            break;
          case 46:
            s = coco_string_create( L"invalid TYPE_LABEL" );
            break;
          case 47:
            s = coco_string_create( L"invalid SYSTEM_BODY" );
            break;
          case 48:
            s = coco_string_create( L"invalid SYSTEM_BODY" );
            break;
          ...
          case 50:
            ...
            break;
          case 51:
            s = coco_string_create( L"invalid PARAMETER" );
            break;
          case 52:
            s = coco_string_create( L"invalid LABEL_OR_INT" );
            break;
          case 53:
            s = coco_string_create( L"invalid LABEL_OR_STAR" );
            break;
          case 54:
            s = coco_string_create( L"invalid FORMULA" );
            break;
