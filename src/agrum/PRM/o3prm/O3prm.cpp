...
namespace gum {
  namespace prm {
    namespace o3prm {
      ...
      O3Position::O3Position() : __file(""), __line(0), __column(0) {
        GUM_CONSTRUCTOR(O3Position);
      }

      O3Position::O3Position(const std::string& file, int line, int column) :
          __file(file), __line(line), __column(column) {
        GUM_CONSTRUCTOR(O3Position);
      }

      O3Position::O3Position(const O3Position& src) :
          __file(src.__file), __line(src.__line), __column(src.__column) {
        GUM_CONS_CPY(O3Position);
      }

      O3Position::O3Position(O3Position&& src) :
          __file(std::move(src.__file)), __line(std::move(src.__line)),
      ...
      O3Integer::O3Integer() : __pos(), __value(0) { GUM_CONSTRUCTOR(O3Integer); }

      O3Integer::O3Integer(const O3Position& pos, int value) :
          __pos(pos), __value(value) {
        GUM_CONSTRUCTOR(O3Integer);
      }

      O3Integer::O3Integer(const O3Integer& src) :
          __pos(src.__pos), __value(src.__value) {
        GUM_CONS_CPY(O3Integer);
      }

      O3Integer::O3Integer(O3Integer&& src) :
          __pos(std::move(src.__pos)), __value(std::move(src.__value)) {
      ...
      O3Formula::O3Formula() :
          __pos(), __formula(std::unique_ptr< Formula >(new Formula(""))) {
        GUM_CONSTRUCTOR(O3Formula);
      }

      O3Formula::O3Formula(const O3Position& pos, const Formula& formula) :
          __pos(pos), __formula(std::unique_ptr< Formula >(new Formula(formula))) {
        GUM_CONSTRUCTOR(O3Formula);
      }
      ...
      O3Formula::O3Formula(O3Formula&& src) :
          __pos(std::move(src.__pos)), __formula(std::move(src.__formula)) {
      ...
      O3Label::O3Label() : __pos(), __label() { GUM_CONSTRUCTOR(O3Label); }

      O3Label::O3Label(const O3Position& pos, const std::string& label) :
          __pos(pos), __label(label) {
        GUM_CONSTRUCTOR(O3Label);
      }

      O3Label::O3Label(const O3Label& src) :
          __pos(src.__pos), __label(src.__label) {
        GUM_CONS_CPY(O3Label);
      }

      O3Label::O3Label(O3Label&& src) :
          __pos(std::move(src.__pos)), __label(std::move(src.__label)) {
      ...
      O3Type::O3Type() : __dep_flag(false) { GUM_CONSTRUCTOR(O3Type); }

      O3Type::O3Type(const O3Type& src) :
          __pos(src.__pos), __name(src.__name), __superLabel(src.__superLabel),
          __labels(src.__labels), __dep_flag(src.__dep_flag) {
        GUM_CONS_CPY(O3Type);
      }

      O3Type::O3Type(O3Type&& src) :
          __pos(std::move(src.__pos)), __name(std::move(src.__name)),
      ...
      O3IntType::O3IntType() : __dep_flag(false) { GUM_CONSTRUCTOR(O3IntType); }

      O3IntType::O3IntType(const O3IntType& src) :
          __pos(src.__pos), __name(src.__name), __start(src.__start),
          __end(src.__end), __dep_flag(src.__dep_flag) {
        GUM_CONS_CPY(O3IntType);
      }

      O3IntType::O3IntType(O3IntType&& src) :
          __pos(std::move(src.__pos)), __name(std::move(src.__name)),
          __start(std::move(src.__start)), __end(std::move(src.__end)),
          __dep_flag(std::move(src.__dep_flag)) {
      ...
      O3RealType::O3RealType() : __dep_flag(false) { GUM_CONSTRUCTOR(O3RealType); }

      O3RealType::O3RealType(const O3RealType& src) :
          __pos(src.__pos), __name(src.__name), __values(src.__values),
          __dep_flag(src.__dep_flag) {
      ...
      O3PRM::O3PRM(O3PRM&& src) :
          __types(std::move(src.__types)), __int_types(std::move(src.__int_types)),
          __real_types(std::move(src.__real_types)),
          __interfaces(std::move(src.__interfaces)),
          __classes(std::move(src.__classes)), __systems(std::move(src.__systems)),
      ...
      O3InterfaceElement::O3InterfaceElement() : __isArray(false) {
      ...
      O3Interface::O3Interface() : __elts(new O3InterfaceElementList()) {
      ...
      O3Attribute::O3Attribute(const O3Label&     type,
          ...
          __type(type),
          __name(name), __parents(parents) {
        GUM_CONSTRUCTOR(O3Attribute);
      }

      O3Attribute::O3Attribute(const O3Attribute& src) :
          __type(src.__type), __name(src.__name), __parents(src.__parents) {
      ...
      O3RawCPT::O3RawCPT() : O3Attribute(), __values{new O3FormulaList{}} {
      ...
      O3RawCPT::O3RawCPT(O3RawCPT&& src) :
          O3Attribute(src), __values(std::move(src.__values)) {
      ...
      O3RuleCPT::O3RuleCPT() : O3Attribute(), __rules{new O3RuleList{}} {
      ...
      O3RuleCPT::O3RuleCPT(O3RuleCPT&& src) :
          O3Attribute(src), __rules(std::move(src.__rules)) {
      ...
      O3Class::O3Class(O3Class&& src) :
          ...
          __superLabel(std::move(src.__superLabel)),
          __interfaces(std::move(src.__interfaces)),
          __params(std::move(src.__params)), __refs(std::move(src.__refs)),
          __attrs(std::move(src.__attrs)), __aggs(std::move(src.__aggs)) {
      ...
      O3Parameter::O3Parameter() : __type(O3Parameter::PRMType::NONE) {
      ...
      O3Parameter::O3Parameter(const O3Position& pos,
          ...
          __pos(pos), __name(name), __value(value) {
        GUM_CONSTRUCTOR(O3Parameter);
      }

      O3Parameter::O3Parameter(const O3Parameter& src) :
          __type(src.__type), __pos(src.__pos), __name(src.__name),
          __value(src.__value) {
        GUM_CONS_CPY(O3Parameter);
      }

      O3Parameter::O3Parameter(O3Parameter&& src) :
          __type(std::move(src.__type)), __pos(std::move(src.__pos)),
          __name(std::move(src.__name)), __value(std::move(src.__value)) {
      ...
      O3Aggregate::O3Aggregate() :
          __variableType(), __aggregateType(), __name(), __parents(),
          __parameters() {
        GUM_CONSTRUCTOR(O3Aggregate);
      }

      O3Aggregate::O3Aggregate(const O3Aggregate& src) :
          __variableType(src.__variableType), __aggregateType(src.__aggregateType),
          __name(src.__name), __parents(src.__parents),
      ...
      O3Aggregate::O3Aggregate(O3Aggregate&& src) :
          ...
          __name(std::move(src.__name)), __parents(std::move(src.__parents)),
      ...
      O3Assignment::O3Assignment(const O3Assignment& src) :
          __leftInstance(src.__leftInstance), __leftIndex(src.__leftIndex),
          __leftReference(src.__leftReference),
          __rightInstance(src.__rightInstance), __rightIndex(src.__rightIndex) {
      ...
      O3Instance::O3Instance(const O3Instance& src) :
          __type(src.__type), __name(src.__name), __size(src.__size),
          __parameters(src.__parameters) {
      ...
      O3System::O3System(const O3System& src) :
          __name(src.__name), __instances(src.__instances),
          __assigments(src.__assigments), __increments(src.__increments) {
        GUM_CONS_CPY(O3System);
      }

      O3System::O3System(O3System&& src) :
          __name(std::move(src.__name)), __instances(std::move(src.__instances)),
      ...
      O3InstanceParameter::O3InstanceParameter() : __isInteger(false) {
        GUM_CONSTRUCTOR(O3InstanceParameter);
      }

      O3InstanceParameter::O3InstanceParameter(const O3InstanceParameter& src) :
          __name(src.__name), __value(src.__value), __isInteger(src.__isInteger) {
      ...
      O3Import::O3Import(const O3Import& src) : __import(src.__import) {
        GUM_CONSTRUCTOR(O3Import);
      }

      O3Import::O3Import(O3Import&& src) : __import(std::move(src.__import)) {
