...
namespace gum {
  ...
  class HashTableIteratorStaticEnd {
    private:
      ...
      static const HashTableIteratorSafe<int,int>* __HashTableIterEnd;

      // creates (if needed) and returns the iterator __HashTableIterEnd
      static const HashTableIteratorSafe<int,int>* end4Statics();

      // creates (if needed) and returns the iterator __HashTableIterEnd
      static const HashTableConstIteratorSafe<int,int>* constEnd4Statics();
  ...
  template <typename Key, typename Val> struct HashTableBucket {
    ...
    HashTableBucket( const Key& k, const Val& v ) : pair ( std::move ( k ), std::move ( v ) ) {}
    HashTableBucket( Key&& k, Val&& v ) : pair ( k, v ) {}
    ~HashTableBucket() {}
  ...
  template <typename Key, typename Val> class HashTable {
    ...
    private:
      ...
      mutable const_iterator_safe* __iterator_list;
  ...
  template <typename Key, typename Val> class HashTableConstIteratorSafe {
    public:
       ...
       * first element).
       * @throw UndefinedIteratorSafeValue exception is thrown if the element cannot
       * be found */
  ...
  const Val& val () const;
    ...
    private:
      ...
      HashTableConstIteratorSafe<Key, Val>* __next;

      /// preceding iterator of the hashtable registered list of iterators
      HashTableConstIteratorSafe<Key, Val>* __prev;
  ...
  extern const HashTableIteratorSafe<int,int>* HashTableIterEnd;
