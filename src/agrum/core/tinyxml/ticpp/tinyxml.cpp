...
bool TiXmlDocument::LoadFile(FILE *file, TiXmlEncoding encoding) {
  ...
  // The document parser may decide the document ends sooner than the entire file,
  // however.
  TIXML_STRING data;
  data.reserve(length);
  ...
  // translating
  // both the two-character sequence #xD #xA and any #xD that is not followed by #xA
  // to
  ...
  // platform.
  // Generally, you expect fgets to translate from the convention of the OS to the
  // c/unix
...
void TiXmlStylesheetReference::Print(FILE *cfile, int /*depth*/,
