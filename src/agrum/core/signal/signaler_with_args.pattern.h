...
namespace gum {
  ...
  namespace __sig__ {
    ...
    protected:
      ...
      typedef ListConstIterator< MAKE_NAME ( IConnector ) <LIST_CLASSES>*> ConnectorIterator;
      ...
      MAKE_NAME ( BasicSignaler ) ( const MAKE_NAME ( BasicSignaler ) & s ) :
        ...
        for ( ConnectorIterator it = _connectors.begin ();
    ...
    public:
      virtual ~MAKE_NAME ( BasicSignaler ) () {
        ...
        for ( ConnectorIterator it = _connectors.rbegin ();
              it != _connectors.rend(); --it ) {
  ...
  public:
    ...
    INLINE void operator() ( const void *src , LIST_DECL_ARGS ) {
      for ( ConnectorIterator it = this->_connectors.begin ();
            it != this->_connectors.end (); ++it ) {
