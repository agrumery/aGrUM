...
namespace gum {
  ...
  class Rational {
     ...
     *
     * @param iters Number of tests of each type ( numbers lower than 1 and
     *greater
     *than 1 ).
     */
    ...
    /**
     * Find the rational close enough to a given ( decimal ) number in [-1,1]
     *and
     *whose denominator is not higher than a given integer number.
     *
     * Because of the double constraint on precision and size of the
     *denominator,
     *there is no guarantee on the precision of the approximation if \c den_max
     *is
     ...
     *denminator such that no other rational with smaller denominator is a
     *better
     ...
     *den_max
     *is infinite. Use this functions because you are sure to get an approx
     *within \c
     *zero of \c number.
     *
