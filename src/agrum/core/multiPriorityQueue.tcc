...
namespace gum {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  const Val&
  MultiPriorityQueue<Val,Priority,Cmp,Alloc>::top () const {
    if ( !__nb_elements ) {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  Size MultiPriorityQueue<Val,Priority,Cmp,Alloc>::size () const noexcept {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  Size MultiPriorityQueue<Val,Priority,Cmp,Alloc>::capacity () const noexcept {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  void MultiPriorityQueue<Val,Priority,Cmp,Alloc>::resize ( Size new_size ) {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  void MultiPriorityQueue<Val,Priority,Cmp,Alloc>::erase ( const Val& val ) {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  void MultiPriorityQueue<Val,Priority,Cmp,Alloc>::eraseTop () {
    eraseByPos ( 0 );
  }
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  Val MultiPriorityQueue<Val,Priority,Cmp,Alloc>::pop () {
    if ( !__nb_elements ) {
      GUM_ERROR ( NotFound, "empty priority queue" );
    }
  ...
  MultiPriorityQueue<Val,Priority,Cmp,Alloc>::allValues () const  {
    return
      reinterpret_cast<const HashTable< Val, std::vector<Size> >&> ( __indices );
  }
  ...
  ( const Val& val,
    ...
    std::pair<Priority,const Val*>
      new_heap_val = std::move ( __heap [ __nb_elements ] );
    ++__nb_elements;
  ...
  Size MultiPriorityQueue<Val,Priority,Cmp,Alloc>::emplace
  ( Args&&... args ) {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  bool MultiPriorityQueue<Val,Priority,Cmp,Alloc>::empty () const noexcept {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc> INLINE
  const Val&
  MultiPriorityQueue<Val,Priority,Cmp,Alloc>::operator[] ( Size index ) const {
  ...
  template <typename Val,typename Priority,typename Cmp,typename Alloc>
  Size
  MultiPriorityQueue<Val,Priority,Cmp,Alloc>::setPriorityByPos
  ( Size index,
