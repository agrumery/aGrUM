...
namespace gum {
  ...
  const HashTableIteratorSafe<int,int>* HashTableIteratorStaticEnd::end4Statics() {
    static bool first_time = true;

    if ( first_time ) {
      first_time = false;
      __HashTableIterEnd = new HashTableIteratorSafe<int,int>;
    }
  ...
  HashTableIteratorStaticEnd::constEnd4Statics() {
    return
      reinterpret_cast<const HashTableConstIteratorSafe<int,int>*>( end4Statics() );
  }
