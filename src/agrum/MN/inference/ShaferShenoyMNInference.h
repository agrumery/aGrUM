...
namespace gum {
  ...
  class ShaferShenoyMNInference:
    ...
    /// default constructor
    explicit ShaferShenoyMNInference(
    ...
    virtual void _onMarkovNetChanged(const IMarkovNet< GUM_SCALAR >* mn) final;
    ...
    /** This variable is useful for method _updateOutdatedMNPotentials: it
    ...
    void __diffuseMessageInvalidations(NodeId   from,
                                       NodeId   to,
