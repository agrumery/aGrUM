...
namespace gum {
  ...
  template < typename GUM_SCALAR >
  IMarkovNet< GUM_SCALAR >::IMarkovNet(const IMarkovNet< GUM_SCALAR >& source) : UGmodel(source) {
  ...
  template < typename GUM_SCALAR >
  void IMarkovNet< GUM_SCALAR >::_minimalCondSetVisit_(NodeId         node,
                                                       const NodeSet& soids,
                                                       NodeSet&       minimal,
  ...
  template < typename GUM_SCALAR >
  NodeSet IMarkovNet< GUM_SCALAR >::minimalCondSet(NodeId target, const NodeSet& soids) const {
