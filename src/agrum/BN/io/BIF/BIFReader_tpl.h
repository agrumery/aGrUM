...
namespace gum {
  ...
  BIFReader< GUM_SCALAR >::BIFReader(BayesNet< GUM_SCALAR >* bn, std::string_view filename) :
  ...
  template < GUM_Numeric GUM_SCALAR >
  bool BIFReader< GUM_SCALAR >::trace() const {
