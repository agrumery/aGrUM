...
#if !defined( _gum_BIF_COCO_PARSER_H_)
#define  _gum_BIF_COCO_PARSER_H_
...
void  _checkSizeOfProbabilityAssignation_(const std::vector<float>&v,const std::string& var) {
