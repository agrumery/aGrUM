...
namespace gum {
  namespace BIF {
    ...
    void Parser::VARIABLE() {
      ...
      int nbr = 0;
      TRY( nbr = factory()
                     .varInBN( factory().variableId( name_of_var ) )
                     .domainSize() );
      if ( nbrMod < nbr )
    ...
    bool Parser::StartOf( int s ) {
      ...
      static bool set[5][27] = {{T, x, x, x, x, x, x, x, x, T, x, x, x, x,
                                 x, x, T, x, x, x, x, x, x, x, x, x, x},
                                {T, T, T, x, x, x, x, x, x, T, x, x, x, x,
                                 x, x, T, x, x, x, x, x, x, x, x, x, x},
                                {T, T, x, x, x, x, x, x, x, T, x, x, x, x,
                                 x, x, T, x, x, x, x, x, x, x, x, x, x},
                                {x, x, T, T, x, x, x, x, x, x, x, x, x, x,
                                 x, T, x, x, T, x, x, x, x, x, x, x, x},
                                {T, T, T, x, x, x, x, x, x, T, x, x, x, x,
                                 x, x, T, x, x, x, x, x, T, x, x, x, x}};
