...
#include <agrum/BN/io/UAI/UAIBNWriter.h>   // to ease IDE parser
...
namespace gum {
  ...
  UAIBNWriter< GUM_SCALAR >::UAIBNWriter() {
  ...
  template < GUM_Numeric GUM_SCALAR >
  std::string UAIBNWriter< GUM_SCALAR >::_preambule_(const IBayesNet< GUM_SCALAR >& bn) {
