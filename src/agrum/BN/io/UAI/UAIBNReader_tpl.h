...
namespace gum {
  ...
  template < typename GUM_SCALAR >
  INLINE void UAIBNReader< GUM_SCALAR >::__addFatalError(Idx                lig,
                                                       Idx                col,
                                                       const std::string& s) {
  ...
  template < typename GUM_SCALAR >
  INLINE void UAIBNReader< GUM_SCALAR >::__addError(Idx lig, Idx col, const std::string& s) {
    __parser->errors().addError(s, __streamName, lig, col);
  }
  template < typename GUM_SCALAR >
  INLINE void UAIBNReader< GUM_SCALAR >::__addWarning(Idx                lig,
                                                    Idx                col,
                                                    const std::string& s) {
