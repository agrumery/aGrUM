...
namespace gum {
  ...
  template<typename T_DATA, template<class> class IApproximationPolicy > INLINE
    GeneralizedCNFWriter<T_DATA,IApproximationPolicy>::GeneralizedCNFWriter() {
  ...
  template<typename T_DATA, template<class> class IApproximationPolicy > INLINE
    void
    GeneralizedCNFWriter<T_DATA, IApproximationPolicy >::write( std::ostream &output, const BayesNet<T_DATA>& bn ) {
      if ( ! output.good() )
  ...
  template<typename T_DATA, template<class> class IApproximationPolicy > INLINE
    void
    GeneralizedCNFWriter<T_DATA, IApproximationPolicy>::write( std::string filePath, const BayesNet<T_DATA>& bn ) {
