...
#include <agrum/BN/io/net/netReader.h>   // to ease IDE parser
...
namespace gum {
  ...
  template < GUM_Numeric GUM_SCALAR >
  bool NetReader< GUM_SCALAR >::trace() const {
  ...
  template < GUM_Numeric GUM_SCALAR >
  std::string NetReader< GUM_SCALAR >::errMsg(Idx i) {
