...
namespace gum {
  ...
  class LazyPropagation: public BayesNetInference<T_DATA> {
    ...
    private:
      ...
      typename Property< List <const Potential<T_DATA>*> >::onNodes __clique_potentials;

      /// the list of all the evidence stored in the cliques
      typename Property< List <const Potential<T_DATA>*> >::onNodes __clique_evidence;
