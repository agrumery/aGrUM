...
namespace gum {
  ...
  namespace learning {
    ...
    std::string ScorefNML::isAprioriCompatible(const std::string& apriori_type, double weight) {
      ...
      msg << "The apriori '" << apriori_type << "' is not yet compatible with the score 'fNML'.";
      return msg.str();
    }
