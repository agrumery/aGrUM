...
namespace gum {
  ...
  namespace learning {
    ...
    std::string ScoreBIC::isPriorCompatible(PriorType apriori_type, double weight) {
      ...
      msg << "The apriori '" << priorTypeToString(apriori_type) << "' is not yet compatible with the score 'BIC'.";
      return msg.str();
    }
