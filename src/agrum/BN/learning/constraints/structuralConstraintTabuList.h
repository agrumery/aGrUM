...
#  undef GUM_CONSTRAINT_CLASS_NAME
       ...
       * a graph is defined by its set of arcs. More precisely, each arc is hashed
       * and the graph is a XOR of all these hash values. To be more robust, an arc
       * hash value is a pair of Size generated by a hash function over the pair of
       * nodes of the arc.
       */
