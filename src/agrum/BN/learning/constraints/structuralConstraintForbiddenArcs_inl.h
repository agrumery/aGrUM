 ...
 */
#include <agrum/BN/learning/constraints/structuralConstraintForbiddenArcs.h>   // to ease IDE parser
...
namespace gum::learning {
  ...
  INLINE const ArcSet& StructuralConstraintForbiddenArcs::arcs() const { return _forbidden_arcs_; }
