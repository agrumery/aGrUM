...
namespace gum {
 ...
 namespace learning {
   ...
   /// copy constructor
   StructuralConstraintNoParentNodes::StructuralConstraintNoParentNodes(
       const StructuralConstraintNoParentNodes& from) :
       _noParentNodes_(from._noParentNodes_) {
     GUM_CONS_CPY(StructuralConstraintNoParentNodes);
   }

   /// move constructor
   StructuralConstraintNoParentNodes::StructuralConstraintNoParentNodes(
       StructuralConstraintNoParentNodes&& from) :
   ...
   /// copy operator
   StructuralConstraintNoParentNodes& StructuralConstraintNoParentNodes::operator=(
       const StructuralConstraintNoParentNodes& from) {
