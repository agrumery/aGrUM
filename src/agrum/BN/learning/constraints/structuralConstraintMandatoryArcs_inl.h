 ...
 */
#include <agrum/BN/learning/constraints/structuralConstraintMandatoryArcs.h>   // to ease IDE parser
...
namespace gum {
  ...
  namespace learning {
    ...
    INLINE bool
        StructuralConstraintMandatoryArcs::checkArcTriangleDeletion1Alone(NodeId node1,
                                                                          NodeId node2,
                                                                          NodeId node3) const {
      return !_MandatoryArcs_mandatory_arcs_.exists(Arc(node2, node1))
          && !_MandatoryArcs_mandatory_arcs_.exists(Arc(node3, node1));
    }

    /// checks whether the constraints enable to apply an ArcTriangleDeletion2
    INLINE bool
        StructuralConstraintMandatoryArcs::checkArcTriangleDeletion2Alone(NodeId node1,
                                                                          NodeId node2,
                                                                          NodeId node3) const {
      return !_MandatoryArcs_mandatory_arcs_.exists(Arc(node3, node2));
    }
    ...
    /// notify the constraint of a modification of the graph
    INLINE void
        StructuralConstraintMandatoryArcs::modifyGraphAlone(const ArcTriangleDeletion1& change) {}

    /// notify the constraint of a modification of the graph
    INLINE void
        StructuralConstraintMandatoryArcs::modifyGraphAlone(const ArcTriangleDeletion2& change) {}
