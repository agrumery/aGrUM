...
namespace gum {
  ...
  namespace learning {
    ...
    INLINE bool StructuralConstraintMandatoryArcs::checkArcTriangleDeletion1Alone(NodeId node1,
                                                                                  NodeId node2,
                                                                                  NodeId node3) const {
    ...
    INLINE bool StructuralConstraintMandatoryArcs::checkArcTriangleDeletion2Alone(NodeId node1,
                                                                                  NodeId node2,
                                                                                  NodeId node3) const {
