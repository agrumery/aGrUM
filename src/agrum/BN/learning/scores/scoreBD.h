...
namespace gum {
  ...
  namespace learning {
    ...
    /** @class ScoreBD
     * @brief the class for computing Bayesian Dirichlet (BD) log2 scores
     * @headerfile scoreBD.h <agrum/BN/learning/scores/scoreBD.h>
     * @ingroup learning_scores
     *
     * @warning This class computes the "general" log2 (BD score). If you wish to
     * reduce the number of hyperparameters, try using ScoreBD or ScoreK2.
     *
     * @warning As BD already includes an implicit smoothing prior on all
    ...
    class ScoreBD: public Score {
      ...
      ScoreBD(const DBRowGeneratorParser&                                 parser,
              const Prior&                                                prior,
       ...
       * score with a Laplace Prior ( smoothing(1) ). BD is a BD score with
...
#  include <agrum/BN/learning/scores/scoreBD_inl.h>
#endif /* GUM_NO_INLINE */
