...
namespace gum {
  ...
  namespace learning {
    ...
    class PYGUM_SHARED_PUBLIC ScoreBIC: public Score {
      ...
      [[nodiscard]] ScoreBIC* clone() const override;
...
#  include <agrum/BN/learning/scores/scoreBIC_inl.h>
#endif /* GUM_NO_INLINE */
