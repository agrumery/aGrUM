...
namespace gum {
  ...
  namespace learning {
     ...
     * @brief the class for computing Log2-likelihood scores
     * @headerfile scoreLog2Likelihood.h <agrum/BN/learning/scores/scoreLog2Likelihood.h>
     * @ingroup learning_scores
     *
     * @warning If you pass an prior to the score, this one will be added
     * into the log-likelihood part of the score.
     */
    class ScoreLog2Likelihood: public Score {
      public:
      // ##########################################################################
      ...
      ScoreLog2Likelihood(const DBRowGeneratorParser&                                 parser,
                          const Prior&                                                prior,
...
#  include <agrum/BN/learning/scores/scoreLog2Likelihood_inl.h>
#endif /* GUM_NO_INLINE */
