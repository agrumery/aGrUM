...
namespace gum {
  ...
  /**
   * @class sdyna sdyna.h <agrum/FMDP/learning/SDyna/sdyna.h>
   * @brief
   * @ingroup fmdp_group
   *
  ...
  class SDYNA {
    ...
    public:
         ...
         */
        // ==========================================================================
        virtual void addAction(const Idx actionId, const std::string &actionName );
         ...
         */
        // ==========================================================================
        virtual void addVariable( const DiscreteVariable* var ) = 0;
    ...
    protected :
         ...
         */
        // ==========================================================================
        virtual bool _learnTransition( Idx actionId, const Observation* obs ) = 0;
