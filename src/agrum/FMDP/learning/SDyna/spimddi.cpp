...
namespace gum {
  ...
  // ==========================================================================
    ...
    SPIMDDI::SPIMDDI (Idx observationPhaseLenght,
      ...
      __learner = new FMDPLearner<GTEST, GTEST, IMDDILEARNER>(this->_fmdp, learningThreshold, similarityThreshold );

      __planer = new SPUMDD<double>(this->_fmdp, epsilon);
  ...
  // ==========================================================================
     ...
     */
    // ###################################################################
    void SPIMDDI::feedback(const Instantiation & reachedState, double obtainedReward){
     ...
     */
    // ==========================================================================
    ActionSet SPIMDDI::_stateActionSet(const Instantiation& curState){
     ...
     */
    // ###################################################################
    bool SPIMDDI::_learnTransition( Idx actionId, const Observation* obs ){
     ...
     */
    // ###################################################################
    void SPIMDDI::_makePlanning( Idx nbValueIterationStep){
