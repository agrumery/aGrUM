...
namespace gum {
  ...
  // ##########################################################################
    ...
    // ==========================================================================
    template <typename GUM_SCALAR>
    void VarInfo<GUM_SCALAR>::__checkRelevance(){
    ...
    // ==========================================================================
    template <typename GUM_SCALAR>
    double VarInfo<GUM_SCALAR>::__probaZValue ( double z ) {
      double y, x, w;
    ...
    // ==========================================================================
    template <typename GUM_SCALAR>
    double VarInfo<GUM_SCALAR>::__probaChi2 ( double x, unsigned long df ) {
      double a, y = 0, s;
      double e, c, z;
