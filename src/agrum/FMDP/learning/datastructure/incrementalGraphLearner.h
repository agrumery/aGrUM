...
namespace gum {
   ...
   * @ingroup fmdp_group
   *
   * Abstract class for incrementaly learn a graphical representation of a function.
   * Can handle both function of real values, and function explaining the behaviour
   * of a variable given set of other variables (as typically in conditionnal probabilities)
   *
   * Maintains two graph in memory, one which is incrementaly updated and the other one
