...
namespace gum {
  ...
  /**
   * @class ComposedLeaf composedLeaf.h <agrum/FMDP/learning/datastructure/leaves/composedLeaf.h>
  ...
  class ComposedLeaf : public AbstractLeaf {
    ...
    public:
      ...
      /// @{
        ...
        void operator delete(void* p){ SmallObjectAllocator::instance().deallocate(p, sizeof(ComposedLeaf));}
