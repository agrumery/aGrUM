...
namespace gum {
  ...
  INLINE void IDecisionStrategy::initialize(const FMDP< double >* fmdp) {
    optPol_ = nullptr;
  ...
  INLINE void IDecisionStrategy::setOptimalStrategy(
      MultiDimFunctionGraph< ActionSet, SetTerminalNodePolicy >* optPol) {
    optPol_ = optPol;
  }

  INLINE ActionSet IDecisionStrategy::stateOptimalPolicy(const Instantiation& curState) {
