    ...
    Parser::SynErr( const std::wstring& filename, int line, int col, int n ) {
      ...
      switch ( n ) {
        ...
        case 19:
          ...
          break;
        case 20:
          s = coco_string_create( L"invalid REWARD_DECISION_GRAPH" );
          break;
        case 21:
          s = coco_string_create( L"invalid REWARD_DECISION_GRAPH" );
          break;
        ...
        case 23:
          ...
          break;
        case 24:
          s = coco_string_create( L"invalid TRANSITION_DECISION_GRAPH" );
          break;
        case 25:
          s = coco_string_create( L"invalid SUB_TRANSITION_DECISION_GRAPH" );
          break;
        case 26:
          s = coco_string_create( L"invalid SUB_DECISION_GRAPH" );
          break;
...
=======
      ...
      void Parser::SynErr(
          const std::wstring& filename, int line, int col, int n ) {
        wchar_t* s;
        ...
        switch ( n ) {
          ...
          case 25:
            s = coco_string_create(
                L"invalid SUB_TRANSITION_DECISION_DIAGRAM" );
            break;
          case 26:
