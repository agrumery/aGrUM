    ...
    Parser::SynErr( const std::wstring& filename, int line, int col, int n ) {
      ...
      switch ( n ) {
        ...
        case 19:
          ...
          break;
        case 20:
          s = coco_string_create( L"invalid REWARD_FUNCTION_GRAPH" );
          break;
        case 21:
          s = coco_string_create( L"invalid REWARD_FUNCTION_GRAPH" );
          break;
        ...
        case 23:
          ...
          break;
        case 24:
          s = coco_string_create( L"invalid TRANSITION_FUNCTION_GRAPH" );
          break;
        case 25:
          s = coco_string_create( L"invalid SUB_TRANSITION_FUNCTION_GRAPH" );
          break;
        case 26:
          s = coco_string_create( L"invalid SUB_FUNCTION_GRAPH" );
          break;
