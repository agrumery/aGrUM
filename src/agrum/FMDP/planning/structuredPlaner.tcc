...
namespace gum {
  ...
  /* ************************************************************************************************** **/
    ...
    StructuredPlaner<GUM_SCALAR>::StructuredPlaner ( IOperatorStrategy<GUM_SCALAR>* opi, GUM_SCALAR discountFactor, GUM_SCALAR epsilon )
    ...
    // ===========================================================================
    template<typename GUM_SCALAR> INLINE
    StructuredPlaner<GUM_SCALAR>::~StructuredPlaner() {
...
//        std::cout << " ------------------- Fin itération n° " << nbIte << std::endl << " Gap : " << gap <<  " - " << __threshold << std::endl;
  ...
  /* ************************************************************************************************** **/
    ...
    // ===========================================================================
    template<typename GUM_SCALAR>
    MultiDimFunctionGraph< GUM_SCALAR >* StructuredPlaner<GUM_SCALAR>::_valueIteration() {
    ...
    StructuredPlaner<GUM_SCALAR>::_evalQaction( const MultiDimFunctionGraph< GUM_SCALAR >* Vold, Idx actionId ){
    ...
    template<typename GUM_SCALAR>
    MultiDimFunctionGraph< GUM_SCALAR >*
    StructuredPlaner<GUM_SCALAR>::_maximiseQactions( std::vector<MultiDimFunctionGraph<GUM_SCALAR>*>& qActionsSet) {
  ...
  /* ************************************************************************************************** **/
    ...
    template<typename GUM_SCALAR>
    void
    StructuredPlaner<GUM_SCALAR>::_evalPolicy (  ) {
    ...
    StructuredPlaner<GUM_SCALAR>::_makeArgMax ( const MultiDimFunctionGraph<GUM_SCALAR>* qAction, Idx actionId ) {
    ...
    // ==========================================================================
    template<typename GUM_SCALAR>
    NodeId StructuredPlaner<GUM_SCALAR>::__recurArgMaxCopy(NodeId currentNodeId,
                                                      Idx actionId,
    ...
    template<typename GUM_SCALAR>
    MultiDimFunctionGraph<ArgMaxSet<GUM_SCALAR, Idx>, SetTerminalNodePolicy>*
    StructuredPlaner<GUM_SCALAR>::_argmaximiseQactions( std::vector<MultiDimFunctionGraph<ArgMaxSet<GUM_SCALAR, Idx>, SetTerminalNodePolicy>*>& qActionsSet) {
    ...
    template<typename GUM_SCALAR>
    void
    StructuredPlaner<GUM_SCALAR>::_extractOptimalPolicy (
    ...
    // ==========================================================================
    template<typename GUM_SCALAR>
    NodeId StructuredPlaner<GUM_SCALAR>::__recurExtractOptPol(NodeId currentNodeId,
    ...
    // ==========================================================================
    template<typename GUM_SCALAR>
    void StructuredPlaner<GUM_SCALAR>::__transferActionIds( const ArgMaxSet<GUM_SCALAR, Idx>& src, ActionSet& dest){
