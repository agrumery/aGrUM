...
namespace gum {
  ...
  INLINE AdaptiveRMaxPlaner*
      AdaptiveRMaxPlaner::ReducedAndOrderedInstance(const ILearningStrategy* learner,
  ...
  INLINE AdaptiveRMaxPlaner* AdaptiveRMaxPlaner::TreeInstance(const ILearningStrategy* learner,
                                                              double discountFactor,
                                                              double epsilon,
                                                              bool   verbose) {
  ...
  INLINE void AdaptiveRMaxPlaner::checkState(const Instantiation& newState, Idx actionId) {
