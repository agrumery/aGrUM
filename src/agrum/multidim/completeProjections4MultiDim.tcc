...
namespace gum {
  ...
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION(x,y) if ( y > x ) x = y
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION_NEUTRAL std::numeric_limits<T_DATA>::min()
  ...
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION(x,y) if ( x > y ) x = y
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION_NEUTRAL std::numeric_limits<T_DATA>::max()
  #include <agrum/multidim/patterns/completeProjectionPattern4MultiDimArray.h>
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION_NAME
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION_NEUTRAL
  ...
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION_NEUTRAL (T_DATA) 0
  #include <agrum/multidim/patterns/completeProjectionPattern4MultiDimArray.h>
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION_NAME
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION_NEUTRAL
  ...
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION(x,y) (x) *= (y) 
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION_NEUTRAL (T_DATA) 1
  #include <agrum/multidim/patterns/completeProjectionPattern4MultiDimArray.h>
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION_NAME
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION_NEUTRAL
  ...
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION_POINTER_IMPL2ARRAY_NAME projectProductMultiDimArray4Pointers
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION(x,y) (*x) *= (*y)
  #define GUM_MULTI_DIM_COMPLETE_PROJECTION_NEUTRAL (T_DATA) 1
  #include <agrum/multidim/patterns/completeProjectionPattern4MultiDimArray.h>
  #undef GUM_MULTI_DIM_COMPLETE_PROJECTION_POINTER_IMPL2ARRAY_NAME
  ...
  void completeProjections4MultiDimInit () {
    ...
    if ( first_init ) {
      ...
      registerCompleteProjection<T_DATA> ( "max", MultiDimArrayString,
                                           &projectMaxMultiDimArray);
      registerCompleteProjection<T_DATA> ( "min", MultiDimArrayString,
                                           &projectMinMultiDimArray);
      registerCompleteProjection<T_DATA> ( "sum", MultiDimArrayString,
                                           &projectSumMultiDimArray);
      registerCompleteProjection<T_DATA> ( "product", MultiDimArrayString,
                                           &projectProductMultiDimArray);
    
      // register default basename functions 
      registerCompleteProjection<T_DATA> ( "max", BaseNameString,
                                           &projectMaxMultiDimImplementation);
      registerCompleteProjection<T_DATA> ( "min", BaseNameString,
                                           &projectMinMultiDimImplementation);
      registerCompleteProjection<T_DATA> ( "sum", BaseNameString,
                                           &projectSumMultiDimImplementation);
      registerCompleteProjection<T_DATA> ( "product", BaseNameString,
