...
// ==============================================================================
INLINE Idx SetInst::nbrDim() const  {
    return __vars.size();
}
...
// ==============================================================================
INLINE bool SetInst::inOverflow() const  {
    return __overflow;
}
...
// ==============================================================================
INLINE bool SetInst::rend() const  {
    return inOverflow();
}
...
// ==============================================================================
INLINE void SetInst::unsetOverflow()  {
    __overflow = false;
}
...
/// is this empty ?
INLINE bool SetInst::empty() const  {
    return __vals.empty();
}
