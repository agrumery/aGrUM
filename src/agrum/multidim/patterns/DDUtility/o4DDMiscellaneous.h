...
/**
* @file
* @brief Files containing structures and functions used to manipulate data
*structures
...
namespace gum {
  ...
  template <typename T> class OperatorData {
    ...
    /// Table to remind us wich part of both diagram have already been explored,
    /// and
    /// the resulting node
    ...
    /**
      ***************************************************************************************************
      ** Initializes the data structure with operated DD1 et DD2, and compute
      *order
    ...
    virtual void initialize( const MultiDimDecisionDiagramBase<T>* dD1,
      ...
      // First, we determine leading order and the sens in which we perform
      // operation
      // on diagrams
    ...
    protected:
    virtual void __getLeadingSequence(
        const MultiDimDecisionDiagramBase<T>* dD1,
        const MultiDimDecisionDiagramBase<T>* dD2,
        gum::Sequence<const DiscreteVariable*>& leadingOrder ) = 0;
  };

  //========================================================================================================================================
  /// OperatorData contains all is needed to perform an operation beteween
  /// seamingly
  ...
  template <typename T> class OrderedOperatorData : public OperatorData<T> {
    ...
    /**
     ***************************************************************************************************
     ** The very implementation of the function that gave order for final
     *diagram
     **
     ***********************************************************************************************
     ***/
  ...
  template <typename T> class NonOrderedOperatorData : public OperatorData<T> {
    ...
    virtual void initialize( const MultiDimDecisionDiagramBase<T>* dD1,
      ...
      this->DD2->findRetrogradeVariables(
          &( this->factory->variablesSequence() ), retrogradeVarTable );
    ...
    virtual void __getLeadingSequence(
      ...
      if ( __evalRetrogradeVarSpaceSize( mergedVarSeq1,
           ...
           __evalRetrogradeVarSpaceSize( mergedVarSeq2,
                                         dD1->variablesSequence() ) ) {
    ...
    /**
     ***************************************************************************************************
     ** Creates the sequence of variable for returned diagram considering the
     *first
     *variables sequence
     ...
     ***********************************************************************************************
     ***/
    void __makeMergedVariableSequence(
        const Sequence<const DiscreteVariable*>& dD1VarSeq,
    ...
    /**
      ***************************************************************************************************
      ** Computes size of retrograde var state space generated by the final
      *sequence
      **
      ***********************************************************************************************
      ***/
  ...
  NodeId insertNonTerminalNode( OperatorData<T>& opData,
    ...
    if ( countTable.size() == 1 &&
         ( defaultSon == 0 || ctIter.key() == defaultSon ) )
      return ctIter.key();
