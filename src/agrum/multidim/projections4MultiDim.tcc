...
namespace gum {
  ...
  #define GUM_MULTI_DIM_PROJECTION_NEUTRAL std::numeric_limits<T_DATA>::min()
  ...
  #define GUM_DECISION_DIAGRAM_PROJECTION_SUB_DIAGRAM_OPERATOR_FUNCTION maximize2MultiDimDecisionDiagrams
  ...
  #define GUM_DECISION_DIAGRAM_PROJECTION_ELEMINATE_NODE_FUNCTION_DEFINITION
  #define GUM_DECISION_DIAGRAM_PROJECTION_SUB_DIAGRAM_OPERATOR_FUNCTION minimize2MultiDimDecisionDiagrams
  #include <agrum/multidim/patterns/DecisionDiagramRecursionFunctions.h>
  #undef GUM_DECISION_DIAGRAM_PROJECTION_SUB_DIAGRAM_OPERATOR_FUNCTION
  #undef GUM_DECISION_DIAGRAM_PROJECTION_ELEMINATE_NODE_FUNCTION_DEFINITION
  ...
  #define GUM_DECISION_DIAGRAM_PROJECTION_ELEMINATE_NODE_FUNCTION_DEFINITION
  #define GUM_DECISION_DIAGRAM_PROJECTION_SUB_DIAGRAM_OPERATOR_FUNCTION add2MultiDimDecisionDiagrams
  #include <agrum/multidim/patterns/DecisionDiagramRecursionFunctions.h>
  #undef GUM_DECISION_DIAGRAM_PROJECTION_SUB_DIAGRAM_OPERATOR_FUNCTION
  #undef GUM_DECISION_DIAGRAM_PROJECTION_ELEMINATE_NODE_FUNCTION_DEFINITION
  ...
  #define GUM_DECISION_DIAGRAM_PROJECTION_ELEMINATE_NODE_FUNCTION_DEFINITION
  #define GUM_DECISION_DIAGRAM_PROJECTION_SUB_DIAGRAM_OPERATOR_FUNCTION multiply2MultiDimDecisionDiagrams
  #include <agrum/multidim/patterns/DecisionDiagramRecursionFunctions.h>
  #undef GUM_DECISION_DIAGRAM_PROJECTION_SUB_DIAGRAM_OPERATOR_FUNCTION
  #undef GUM_DECISION_DIAGRAM_PROJECTION_ELEMINATE_NODE_FUNCTION_DEFINITION
  ...
  */
  ...
  void projections4MultiDimInit () {
    ...
    if ( first_init ) {
      ...
      registerProjection<T_DATA> ( "max", MultiDimArrayString,
                                   &projectMaxMultiDimArray);
      registerProjection<T_DATA> ( "min", MultiDimArrayString,
                                   &projectMinMultiDimArray);
      registerProjection<T_DATA> ( "sum", MultiDimArrayString,
      ...
      registerProjection<T_DATA> ( "min", BaseNameString,
                                   &projectMinMultiDimImplementation);
      registerProjection<T_DATA> ( "sum", BaseNameString,
                                   &projectSumMultiDimImplementation);
      registerProjection<T_DATA> ( "product", BaseNameString,
