...
namespace gum {
  ...
  /// a specialized function for projecting a multiDimFunctionGraph using a Max
  /// operator
  /** The function projects a table over the subset of its variables NOT IN
  ...
  * function if it is appropriate for your projection. */
  ...
  /// a specialized function for projecting a multiDimFunctionGraph using a Min
  /// operator
  /** The function projects a table over the subset of its variables NOT IN
  * the set of variables del_vars. For instance, if table is a
  * MultiDimFunctionGraph
  ...
  * function if it is appropriate for your projection. */
  ...
  /// a specialized function for projecting a multiDimFunctionGraph using a
  /// summation
  /** The function projects a table over the subset of its variables NOT IN
  * the set of variables del_vars. For instance, if table is a
  * MultiDimFunctionGraph
  ...
  * function if it is appropriate for your projection. */
  ...
  /// a specialized function for projecting a multiDimFunctionGraph using
  /// products
  /** The function projects a table over the subset of its variables NOT IN
  * the set of variables del_vars. For instance, if table is a
  * MultiDimFunctionGraph
