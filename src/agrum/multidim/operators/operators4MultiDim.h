...
namespace gum {
  ...
  /// a specialized function for compare value from two multiDimFunctionGraphs
  /// and gets the maximal
  /** The function produces a tensorial comparison between t1 and t2, that is,
   * if t1
   * and t2 are multiDimFunctionGraphs over variables A,B,C,D and D,B,E
   * respectively,
   * function maximise2MultiDimFunctionGraphs will return a
   * multiDimFunctionGraph T defined as
