 ...
 * producing a new (combined) Ti object. By default, the combination operation
 *"op"
 ...
 * pairs of MultiDimImplementation the first one of which being a utility function
 * and
