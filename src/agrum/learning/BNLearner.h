  ...
  namespace learning {
    ...
    class BNLearner: public gum::IApproximationSchemeConfiguration {
      ...
      public:
         ...
         * methods useAprioriXXX () + the implicit apriori of the score, else we
         * just take into account the apriori specified by useAprioriXXX ()
         * @throw MissingVariableInDatabase if a variable of the BN is not found in the database.
         * @throw UnknownLabelInDatabase if a label is found in the databast that do not correpond to the variable.
         */
        template <typename GUM_SCALAR = float>
