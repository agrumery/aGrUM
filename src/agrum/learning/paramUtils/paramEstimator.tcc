...
namespace gum {
  ...
  namespace learning {
    ...
    INLINE ParamEstimator<IdSetAlloc, CountAlloc>::ParamEstimator(
            ...
            : Counter<IdSetAlloc, CountAlloc>(filter, var_modalities), _apriori(&apriori),
    ...
    ParamEstimator<IdSetAlloc, CountAlloc>::ParamEstimator(
            ...
            : Counter<IdSetAlloc, CountAlloc>(from), _apriori(from._apriori),
              _score_internal_apriori(from._score_internal_apriori->copyFactory()), _is_normalized(from._is_normalized),
              __apriori_computed(from.__apriori_computed), __score_apriori_inserted(from.__score_apriori_inserted) {
    ...
    ParamEstimator<IdSetAlloc, CountAlloc>::ParamEstimator(
            ...
            : Counter<IdSetAlloc, CountAlloc>(std::move(from)), _apriori(std::move(from._apriori)),
              _score_internal_apriori(std::move(from._score_internal_apriori)),
              _is_normalized(std::move(from._is_normalized)), __apriori_computed(std::move(from.__apriori_computed)),
