 ...
 */
#ifndef GUM_LEARNING_PARAM_ESTIMATOR_ML2_H
#define GUM_LEARNING_PARAM_ESTIMATOR_ML2_H
...
#include <agrum/learning/paramUtils/paramEstimatorML2_tpl.h>

#endif /* GUM_LEARNING_PARAM_ESTIMATOR_ML2_H */
