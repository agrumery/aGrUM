...
namespace gum {
  ...
  namespace learning {
    ...
    INLINE DBRow::DBRow ( unsigned int size,
                          const DBCell& default_cell,
                          float weight ) :
    ...
    INLINE DBRow::DBRow ( const std::vector<DBCell>& cells,
                          float weight ) :
      _row ( cells ),
      _weight ( weight ) {
    }
    ...
    /// initializer from a vector of cells
    INLINE DBRow::DBRow ( std::vector<DBCell>&& cells,
                          float weight ) :
      _row ( std::move ( cells ) ),
      _weight ( weight ) {
    }
    ...
    INLINE DBCell& DBRow::operator[] ( unsigned int i ) {
      return _row[i];
    }
    ...
    /// returns the current row
    INLINE std::vector<DBCell>& DBRow::row () noexcept {
      return _row;
    }


    /// returns the weight
    INLINE const float& DBRow::weight () const noexcept {
      return _weight;
    }


    /// returns the weight
    INLINE float& DBRow::weight () noexcept {
      return _weight;
    }
    ...
    /// sets a new weight
    INLINE void DBRow::setWeight ( float new_weight ) {
      _weight = new_weight;
    }

    
    /// returns the size of the row
    INLINE unsigned int DBRow::size () const noexcept {
      return _row.size ();
    }
