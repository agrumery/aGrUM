...
namespace gum {
  ...
  namespace learning {
    ...
    DBInitializerFromCSV<ALLOC>::DBInitializerFromCSV (
      ...
      , __comment_marker ( commentmarker )
      , __quote_marker ( quoteMarker )
    ...
    DBInitializerFromCSV<ALLOC>::DBInitializerFromCSV (
      DBInitializerFromCSV<ALLOC>&& from )
      : DBInitializerFromCSV<ALLOC> ( std::move ( from ),
                                      from.getAllocator () ) {}
    ...
    DBInitializerFromCSV<ALLOC>::clone (
    ...
    template <template<typename> class ALLOC>
    DBInitializerFromCSV<ALLOC>*
    DBInitializerFromCSV<ALLOC>::clone () const {
    ...
    template <template<typename> class ALLOC>
    DBInitializerFromCSV<ALLOC>&
    DBInitializerFromCSV<ALLOC>::operator= (
      const DBInitializerFromCSV<ALLOC>& from ) {
      if ( this != &from ) {
        ...
        __parser.useNewStream ( __input_stream, __delimiter,
                                __comment_marker, __quote_marker );
