  ...
  namespace learning {
    ...
    DBTranslator4DiscretizedVariable<ALLOC>::DBTranslator4DiscretizedVariable (
      ...
      : DBTranslator<ALLOC> ( DBTranslatedValueType::DISCRETE,
                              missing_symbols, false, max_dico_entries, alloc )
    ...
    DBTranslator4DiscretizedVariable<ALLOC>::clone (
      ...
      DBTranslator4DiscretizedVariable<ALLOC>::allocator_type& alloc )
      const {
      ALLOC<DBTranslator4DiscretizedVariable<ALLOC>>
        allocator ( alloc );
      DBTranslator4DiscretizedVariable<ALLOC>*
    ...
    DBTranslator4DiscretizedVariable<ALLOC>::translate (
    ...
    template <template<typename> class ALLOC>
    INLINE std::string
    DBTranslator4DiscretizedVariable<ALLOC>::translateBack (
    ...
    template <template<typename> class ALLOC>
    INLINE bool
    DBTranslator4DiscretizedVariable<ALLOC>::hasEditableDictionary ()
      const {
      return false;
    }
    ...
    template <template<typename> class ALLOC>
    INLINE void
    DBTranslator4DiscretizedVariable<ALLOC>::setEditableDictionaryMode
    ( bool ) {}
