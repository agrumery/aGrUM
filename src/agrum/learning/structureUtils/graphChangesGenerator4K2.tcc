...
namespace gum {
  ...
  namespace learning {
    ...
    template <typename STRUCT_CONSTRAINT>
    void
    GraphChangesGenerator4K2<STRUCT_CONSTRAINT>::setGraph
    ( const DiGraph& graph ) {
    ...
    template <typename STRUCT_CONSTRAINT> INLINE
    void GraphChangesGenerator4K2<STRUCT_CONSTRAINT>::clearChanges ()
      noexcept {
      _legal_changes.clear ();
     }
    ...
    template <typename STRUCT_CONSTRAINT> INLINE
    void GraphChangesGenerator4K2<STRUCT_CONSTRAINT>::modifyGraph
    ...
    template <typename STRUCT_CONSTRAINT> INLINE
    void GraphChangesGenerator4K2<STRUCT_CONSTRAINT>::setMaxNbThreads
