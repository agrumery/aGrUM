  ...
  namespace learning {
    ...
    ( const std::pair<unsigned int, unsigned int>& pair ) {
      return ( __conditioning_size *
               ...
               ( __database->nbrModalities ( pair.second ) - 1 ) );
    }
    ...
    ALWAYS_INLINE void Chi2::setConfidenceProba( float new_proba ) {
