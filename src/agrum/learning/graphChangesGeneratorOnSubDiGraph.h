 ...
 * GraphChangesGeneratorOnSubGraph provides a simple way to compute those that we
 * wish to perform when we wish to limit the set of changes over a subgraph of
 ...
 * target nodes of the GraphChangesGeneratorOnSubGraph to {A,B,C} and the set
 ...
 */
#ifndef GUM_LEARNING_GRAPH_CHANGES_GENERATOR_ON_SUBGRAPH_H
#define GUM_LEARNING_GRAPH_CHANGES_GENERATOR_ON_SUBGRAPH_H
...
namespace gum {
  ...
  namespace learning {
    ...
    /** @class GraphChangesGeneratorOnSubGraph
     * @brief The basic class for computing the next graph changes possible in a
     * structure learning algorithm
     *
     * Structure learning algorithm try different modifications of the graph. Class
     * GraphChangesGeneratorOnSubGraph provides a simple way to compute those that
     * we wish to perform when we wish to limit the set of changes over a subgraph
     * of the graph we learn. For instance, we may wish to relearn an already
     * partially learnt structure just around nodes A,B,C. In this case, we can
     * set the set of target nodes of the GraphChangesGeneratorOnSubGraph to
     * {A,B,C} and the set of "tail" nodes as all the nodes of the graph. In
    ...
    public:
      ...
      /// default constructor
      GraphChangesGeneratorOnSubGraph ( STRUCT_CONSTRAINT& constraint );
      ...
      /// destructor
      virtual ~GraphChangesGeneratorOnSubGraph ();
...
#include <agrum/learning/graphChangesGeneratorOnSubGraph.tcc>


#endif /* GUM_LEARNING_GRAPH_CHANGES_GENERATOR_ON_SUBGRAPH_H */
