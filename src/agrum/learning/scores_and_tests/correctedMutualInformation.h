 ...
 namespace gum {
   ...
   namespace learning {
     ...
     class CorrectedMutualInformation {
       ...
       void _insertIntoCache( Idx var1, Idx var2,
    		   	   const std::vector<Idx>& conditioning_ids,
				   double                  score           );

       /// inserts a new score into the cache
       void _insertIntoCache( Idx var1, Idx var2, Idx var3,
    		   	   const std::vector<Idx>& conditioning_ids,
				   double                  score           );
       ...
       double _K( Idx var1, Idx var2, Idx var3,
    		   	   	   	   	   	   const std::vector<Idx>& conditioning_ids );


       /// inserts a new score into the cache
       void _insertIntoKCache( Idx var1, Idx var2,
    		   	   const std::vector<Idx>& conditioning_ids,
				   double                  score           );

       /// inserts a new score into the cache
       void _insertIntoKCache( Idx var1, Idx var2, Idx var3,
    		   	   const std::vector<Idx>& conditioning_ids,
				   double                  score           );
