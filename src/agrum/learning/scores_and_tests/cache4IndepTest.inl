...
namespace gum {
  ...
  namespace learning {
    ...
    INLINE void
    Cache4IndepTest::erase ( unsigned int var1,
                             unsigned int var2,
                             const std::vector<unsigned int>& conditioning_set ) {
      if ( var1 > var2 ) std::swap ( var1, var2 );
    ...
    INLINE bool
    Cache4IndepTest::exists ( unsigned int var1,
                              unsigned int var2,
                              const std::vector<unsigned int>& conditioning_set ) {
      if ( var1 > var2 ) std::swap ( var1, var2 );
      return
        __scores.exists ( std::tuple<IdSet<>,unsigned int,unsigned int>
                          ( IdSet<> ( conditioning_set,0 ), var1, var2 ) );
    }
    ...
    INLINE float
    Cache4IndepTest::score ( unsigned int var1,
                             unsigned int var2,
                             const std::vector<unsigned int>& conditioning_set ) {
      if ( var1 > var2 ) std::swap ( var1, var2 );
