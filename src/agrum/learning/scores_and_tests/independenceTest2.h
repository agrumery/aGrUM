 ...
 */
#ifndef GUM_LEARNING_INDEPENDENCE_TEST2_H
#define GUM_LEARNING_INDEPENDENCE_TEST2_H
...
#include <agrum/learning/scores_and_tests/independenceTest2_tpl.h>

#endif /* GUM_LEARNING_INDEPENDENCE_TEST2_H */
