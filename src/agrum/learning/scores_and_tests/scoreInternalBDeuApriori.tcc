...
namespace gum {
  ...
  namespace learning {
    ...
    template <typename IdSetAlloc, typename CountAlloc> INLINE
    ScoreInternalBDeuApriori<IdSetAlloc,CountAlloc>*
    ...
    template <typename IdSetAlloc, typename CountAlloc> INLINE
    void ScoreInternalBDeuApriori<IdSetAlloc,CountAlloc>::setEffectiveSampleSize
    ( float ess ) {
      if ( ess < 0 ) {
    ...
    template <typename IdSetAlloc, typename CountAlloc> INLINE
    void ScoreInternalBDeuApriori<IdSetAlloc,CountAlloc>::insertScoreApriori
