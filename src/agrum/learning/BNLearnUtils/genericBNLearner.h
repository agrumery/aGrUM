 ...
 ***************************************************************************/
/** @file
 * @brief A class for generic framework of learning algorithms that can easily be used
 *
  ...
  namespace learning {
    ...
    class genericBNLearner: public gum::IApproximationSchemeConfiguration {
      ...
      public:
        ...
        // ##########################################################################
        // in order to not pollute the proper code of genericBNLearner, we directly implement those
