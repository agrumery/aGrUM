...
namespace gum {
  ...
  class FixedAllocator {
    // clang-format off
    /**
     * @struct Chunk__ fixedAllocator.h <agrum/tools/core/smallobjectallocator/fixedAllocator.h>
     *
    ...
    // ============================================================================
    const size_t& objectSize() { return blockSize__; }
    ...
    // ============================================================================
    typedef std::vector< Chunk__ > Chunks__;
    Chunks__                       chunks__;
