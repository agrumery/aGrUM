...
namespace gum {
  ...
  namespace learning {
    ...
    CSVParser< ALLOC >::CSVParser(std::istream&                                      instream,
        ...
        _emptyData_(true), _instream_(&instream), _data_(alloc),_filename_(filename) {
    ...
    template < template < typename > class ALLOC >
    INLINE std::size_t CSVParser< ALLOC >::_correspondingQuoteMarker_(const std::string& str,
