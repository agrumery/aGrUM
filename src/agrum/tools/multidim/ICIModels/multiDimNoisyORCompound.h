...
namespace gum {
   ...
   * @headerfile multiDimNoisyORCompound.h <agrum/tools/multidim/ICIModels/multiDimNoisyORCompound.h>
...
#include <agrum/tools/multidim/ICIModels/multiDimNoisyORCompound_tpl.h>
