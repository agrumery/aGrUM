  ...
  ScheduleProject< GUM_SCALAR >::ScheduleProject(
     ...
     MultiDimImplementation< GUM_SCALAR >* (*project)(
      ...
      ScheduleOperation< GUM_SCALAR >(
       ...
       _table_(table),  _del_vars_(del_vars),  _args_(0),  _results_(0),
       _project_(project) {
  ...
  ScheduleProject< GUM_SCALAR >::ScheduleProject(
     const ScheduleProject< GUM_SCALAR >& f) :
      ScheduleOperation< GUM_SCALAR >(f),
       _table_(f. _table_),  _del_vars_(f. _del_vars_),
       _result_(new ScheduleMultiDim< GUM_SCALAR >(*(f. _result_))),  _args_(0),
       _results_(0),  _project_(f. _project_) {
    // for debugging purposes
