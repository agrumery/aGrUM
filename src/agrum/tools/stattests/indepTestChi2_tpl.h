...
namespace gum {
  ...
  namespace learning {
    ...
    /// copy constructor
    template < template < typename > class ALLOC >
    INLINE IndepTestChi2< ALLOC >::IndepTestChi2(const IndepTestChi2< ALLOC >& from) :
    ...
    /// copy operator
    template < template < typename > class ALLOC >
    IndepTestChi2< ALLOC >& IndepTestChi2< ALLOC >::operator=(const IndepTestChi2< ALLOC >& from) {
      if (this != &from) {
    ...
    /// move operator
    template < template < typename > class ALLOC >
    IndepTestChi2< ALLOC >& IndepTestChi2< ALLOC >::operator=(IndepTestChi2< ALLOC >&& from) {
      if (this != &from) {
    ...
    std::pair< double, double >
       IndepTestChi2< ALLOC >::statistics(NodeId                                        var1,
                                          NodeId                                        var2,
