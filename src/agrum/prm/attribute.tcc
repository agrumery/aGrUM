...
namespace gum {
  namespace prm {
    ...
    Attribute<GUM_SCALAR>::operator= ( const Attribute<GUM_SCALAR>& from ) {
      GUM_ERROR ( FatalError, "Illegal call to the copy operator of gum::Attribute" );
    }

    template<typename GUM_SCALAR> Attribute<GUM_SCALAR>*
    Attribute<GUM_SCALAR>::getCastDescendant() const {
    ...
    Attribute<GUM_SCALAR>::setAsCastDescendant ( Attribute<GUM_SCALAR>* cast ) {
      try {
    ...
    Attribute<GUM_SCALAR>::cpf() { return *__cpf; }

    template<typename GUM_SCALAR> INLINE
    const Potential<GUM_SCALAR>&
    Attribute<GUM_SCALAR>::cpf() const { return *__cpf; }
