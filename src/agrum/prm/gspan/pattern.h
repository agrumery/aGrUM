...
// 
// /**
//  * @class Pattern pattern.h <agrum/prm/pattern.h>
...
//  * depth first search.
//  *
//  * To retrieve the depth first search tree from Pattern::graph simple consider only
//  * arcs (u, v) with u < v. The set of arcs { (u,v) | u < v} is called the forward edge
//  * set and the set of arcs { (u,v) | u > v} is called the backward edge set.
//  *
//  * The orientation in Pattern::graph is only used to differentiate forward edges
//  * from backward edges.
//  *
//  */
...
// 
//     /// Code alias.
//     typedef DiGraph::NodeIterator NodeIterator;
// 
//     /// Return an iterator at the beginning of the nodes in this Pattern.
//     NodeIterator beginNodes() const;
// 
//     /// Return an iterator at the end of the nodes in this Pattern.
//     const NodeIterator& endNodes() const;
// 
//     /// Code alias.
//     typedef DiGraph::ArcIterator ArcIterator;
// 
//     /// Return an iterator at the beginning of the arcs in this Pattern.
//     ArcIterator beginArcs() const;
// 
//     /// Return an iterator at the end of the arcs in this Pattern.
...
//   public:
//     /// Constructor.
//     NeighborIterator(const ArcSet& parents, const ArcSet& children);
//     /// Copy constructor.
...
//     /// Returns a pointer over the arc currently pointed by this.
//     const Arc* operator->() const;
//   private:
//     /// The set of parents of the node.
//     const ArcSet* __parents;
//     /// The set of children of the node.
//     const ArcSet* __children;
// 
//     /// Iterator over the set of parents.
//     ArcSetIterator __parent_iterator;
//     /// Iterator iver the set of children.
//     ArcSetIterator __children_iterator;
// 
//     /// The iterator used for iteration.
//     ArcSetIterator* __iterator;
//     /// The end iterator if the current __iterator.
//     const ArcSetIterator* __end_iterator;
// };
// 
// } /* namespace gum */
// #ifndef GUM_NO_INLINE
// #include <agrum/prm/pattern.inl>
// #endif // GUM_NO_INLINE
// // ============================================================================
// #endif /* GUM_PATTERN_H */
// // ============================================================================
