...
INLINE
EdgeCode::EdgeCode(Size my_i, Size my_j, Size my_l_i, Size my_l_ij, Size my_l_j):
...
INLINE
bool
EdgeCode::isForward() const { return i < j; }

INLINE
bool
EdgeCode::isBackward() const { return i > j; }
...
INLINE
bool
EdgeCode::operator==(const EdgeCode& code) const {
