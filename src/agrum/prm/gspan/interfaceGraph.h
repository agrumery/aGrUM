...
//  *
//  * @brief This class represent the interface graph of a given gum::Model.
//  *
//  *
//  * An interface graph is a labelled graph over the instances of a gum::Model,
...
// 
//   private:
//     /// The gum::Model represented by this interface graph.
//     Model* __model;
// 
//     /// The interface graph.
//     UndiGraph __graph;
