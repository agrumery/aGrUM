...
//   // Adding nodes
//   for (System::const_iterator iter = begin(); not iter.isEnd(); ++iter) {
...
// 
// void
// System::__groundAgg(const ClassElement& elt, const std::string& name,
...
// 
// void
// System::__groundPotential(const Instance& instance, NodeId node, BayesNetFactory<prm_float>& factory) const {
