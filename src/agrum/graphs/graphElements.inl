...
namespace gum {
  ...
  // ==============================================================================
  INLINE void Link::setFirst( const NodeId& id )  {
    n1 = id;
  }
  ...
  // ==============================================================================
  INLINE void Link::setSecond( const NodeId& id )  {
    n2 = id;
  }
  ...
  INLINE bool Link::operator==( const Link& from ) const  {
    return (( isDirected() == from.isDirected() ) && ( n1 == from.n1 ) && ( n2 == from.n2 ) );
  }
  ...
  // ==============================================================================
  INLINE void Arc::setTail( const NodeId& id )  {
    n1 = id;
  }
  ...
  // ==============================================================================
  INLINE void Arc::setHead( const NodeId& id )  {
    n2 = id;
  }
  ...
  HashFunc<Edge>::operator()( const Edge& key ) const {
    NodeId first=key.first();NodeId second=key.second();
    bool b=first<second;
  ...
  HashFunc<Edge>::resize( Size new_size ) {
    HashFuncBase<Edge>::resize( new_size );
  ...
  HashFunc<Arc>::resize( Size new_size ) {
    HashFuncBase<Arc>::resize( new_size );
    real_func.resize( new_size );
  }
