...
#include <agrum/base/variables/IDiscretizedVariable.h>   // to ease IDE parser
...
namespace gum {
  ...
  /// Default constructor
  INLINE
  IDiscretizedVariable::IDiscretizedVariable(std::string_view aName, std::string_view aDesc) :
