...
namespace gum {
  ...
  namespace aggregator {
    ...
    /**
     * @class Exists
     * @headerfile exists.h <agrum/base/multidim/aggregator/exists.h>
    ...
    extern template class PYGUM_SHARED_PUBLIC Exists< double >;
#endif
...
#include <agrum/base/multidim/aggregators/exists_tpl.h>
