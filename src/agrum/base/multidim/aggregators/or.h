...
namespace gum {
  ...
  namespace aggregator {
    ...
    /**
     * @class Or
     * @headerfile or.h <agrum/base/multidim/aggregators/or.h>
    ...
    extern template class PYGUM_SHARED_PUBLIC Or< double >;
#endif

  }   // namespace aggregator
}   // namespace gum

#include <agrum/base/multidim/aggregators/or_tpl.h>
