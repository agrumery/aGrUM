...
namespace gum {
  ...
  namespace aggregator {
    ...
    /**
     * @class Median
     * @headerfile median.h <agrum/base/multidim/aggregators/median.h>
    ...
    extern template class PYGUM_SHARED_PUBLIC Median< double >;
#endif
...
#include <agrum/base/multidim/aggregators/median_tpl.h>
