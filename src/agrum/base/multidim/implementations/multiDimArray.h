...
namespace gum {
  ...
  /**
   * @class MultiDimArray
   * @headerfile multiDimArray.h <agrum/base/multidim/multiDimArray.h>
  ...
  extern template class PYGUM_SHARED_PUBLIC MultiDimArray< double >;
#endif


} /* namespace gum */

#include <agrum/base/multidim/implementations/multiDimArray_tpl.h>
