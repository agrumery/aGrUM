...
#include <agrum/base/multidim/utils/operators/completeProjectionRegister4MultiDim.h>   // to ease IDE parser
...
#  endif /* GUM_DEBUG_MODE */
  ...
  template < typename GUM_ELEMENT >
  bool CompleteProjectionRegister4MultiDim< GUM_ELEMENT >::exists(
      std::string_view projection_name,
  ...
  // type
  template < typename GUM_ELEMENT >
  CompleteProjectionRegister4MultiDim< GUM_ELEMENT >&
      CompleteProjectionRegister4MultiDim< GUM_ELEMENT >::Register() {
