...
#include <agrum/base/multidim/utils/operators/projections4MultiDim.h>   // to ease IDE parser
...
#  define GUM_MULTI_DIM_PROJECTION(x, y) \
    if (y > x) x = y
#  define GUM_MULTI_DIM_PROJECTION_NEUTRAL std::numeric_limits< GUM_ELEMENT >::min()
#  include <agrum/base/multidim/utils/patterns/projectionPattern4MultiDimArray.h>
...
#  define GUM_MULTI_DIM_PROJECTION(x, y) \
    if (x > y) x = y
#  define GUM_MULTI_DIM_PROJECTION_NEUTRAL std::numeric_limits< GUM_ELEMENT >::max()
#  include <agrum/base/multidim/utils/patterns/projectionPattern4MultiDimArray.h>
#  undef GUM_MULTI_DIM_PROJECTION_NAME
#  undef GUM_MULTI_DIM_PROJECTION_EFFECTIVE_TYPE
#  undef GUM_MULTI_DIM_PROJECTION
...
#  define GUM_MULTI_DIM_PROJECTION_NEUTRAL (GUM_ELEMENT)0
#  include <agrum/base/multidim/utils/patterns/projectionPattern4MultiDimArray.h>
#  undef GUM_MULTI_DIM_PROJECTION_NAME
#  undef GUM_MULTI_DIM_PROJECTION_EFFECTIVE_TYPE
#  undef GUM_MULTI_DIM_PROJECTION
...
#  define GUM_MULTI_DIM_PROJECTION_EFFECTIVE_TYPE
#  define GUM_MULTI_DIM_PROJECTION(x, y)   (x) *= (y)
#  define GUM_MULTI_DIM_PROJECTION_NEUTRAL (GUM_ELEMENT)1
#  include <agrum/base/multidim/utils/patterns/projectionPattern4MultiDimArray.h>
#  undef GUM_MULTI_DIM_PROJECTION_NAME
#  undef GUM_MULTI_DIM_PROJECTION_EFFECTIVE_TYPE
#  undef GUM_MULTI_DIM_PROJECTION
...
#  define GUM_MULTI_DIM_PROJECTION_NEUTRAL  (-1 * std::numeric_limits< GUM_ELEMENT >::max())

#  define GUM_MULTI_DIM_PROJECTION_NAME projectMaxMultiDimFunctionGraph
#  include <agrum/base/multidim/utils/patterns/projectionPattern4MultiDimFunctionGraph.h>
#  undef GUM_MULTI_DIM_PROJECTION_NAME
...
#  include <agrum/base/multidim/utils/patterns/projectionPattern4MultiDimImplementation.h>
#  undef GUM_MULTI_DIM_PROJECTION_NAME
...
#  define GUM_MULTI_DIM_PROJECTION_NEUTRAL std::numeric_limits< GUM_ELEMENT >::min()
#  include <agrum/base/multidim/utils/patterns/projectionPattern4BaseName.h>
#  undef GUM_MULTI_DIM_PROJECTION_NAME
#  undef GUM_MULTI_DIM_PROJECTION
#  undef GUM_MULTI_DIM_PROJECTION_NEUTRAL
...
namespace gum {
  ...
  void projections4MultiDimInit() {
    ...
    std::call_once(first, []() {
      ...
      registerProjection< GUM_ELEMENT >("max", MultiDimArrayString, &projectMaxMultiDimArray);
      registerProjection< GUM_ELEMENT >("min", MultiDimArrayString, &projectMinMultiDimArray);
      registerProjection< GUM_ELEMENT >("sum", MultiDimArrayString, &projectSumMultiDimArray);
      registerProjection< GUM_ELEMENT >("product",
                                        MultiDimArrayString,
                                        &projectProductMultiDimArray);

      // register base functions for multiDimArrays
      registerProjection< GUM_ELEMENT >("max",
                                        MultiDimFunctionGraphString,
                                        &projectMaxMultiDimFunctionGraph);
      registerProjection< GUM_ELEMENT >("min",
                                        MultiDimFunctionGraphString,
                                        &projectMinMultiDimFunctionGraph);
      registerProjection< GUM_ELEMENT >("sum",
                                        MultiDimFunctionGraphString,
      ...
      registerProjection< GUM_ELEMENT >("max", BaseNameString, &projectMaxMultiDimImplementation);
      registerProjection< GUM_ELEMENT >("min", BaseNameString, &projectMinMultiDimImplementation);
      registerProjection< GUM_ELEMENT >("sum", BaseNameString, &projectSumMultiDimImplementation);
      registerProjection< GUM_ELEMENT >("product",
                                        BaseNameString,
