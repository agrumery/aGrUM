...
namespace gum {
   ...
   * @headerfile multiDimNoisyORCompound.h <agrum/base/multidim/ICIModels/multiDimNoisyORCompound.h>
  ...
  extern template class PYGUM_SHARED_PUBLIC MultiDimNoisyORCompound< double >;
#endif
...
#include <agrum/base/multidim/ICIModels/multiDimNoisyORCompound_tpl.h>
