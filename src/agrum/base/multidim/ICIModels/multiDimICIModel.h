...
namespace gum {
   ...
   * @headerfile multiDimICIModel.h <agrum/base/multidim/ICIModels/multiDimICIModel.h>
  ...
  extern template class PYGUM_SHARED_PUBLIC MultiDimICIModel< double >;
#endif

} /* namespace gum */

#include <agrum/base/multidim/ICIModels/multiDimICIModel_tpl.h>
