...
namespace gum {
  ...
  namespace learning {
     ...
     * @headerfile DBTranslator4DiscretizedVariable.h <agrum/base/database/DBTranslator4DiscretizedVariable.h>
     * @brief The databases' cell translators for discretized variables
     *
     ...
     */
    class GUM_SHARED_PUBLIC DBTranslator4DiscretizedVariable: public DBTranslator {
      public:
      // ##########################################################################
      ...
      [[nodiscard]] DBTranslator4DiscretizedVariable* clone() const override;
...
#include <agrum/base/database/DBTranslator4DiscretizedVariable_tpl.h>
