...
namespace gum {
  ...
  namespace learning {
     ...
     * @headerfile DBRowGeneratorParser.h <agrum/base/database/DBRowGeneratorParser.h>
...
#include <agrum/base/database/DBRowGeneratorParser_tpl.h>

/// include the inlined functions if necessary
#ifndef GUM_NO_INLINE
#include <agrum/base/database/DBRowGeneratorParser_inl.h>
#endif /* GUM_NO_INLINE */
