...
namespace gum {
  ...
  namespace learning {
     ...
     * @headerfile DBTranslator4IntegerVariable.h <agrum/base/database/DBTranslator4IntegerVariable.h>
     * @brief The databases' cell translators for integer variables
     *
     ...
     */
    class GUM_SHARED_PUBLIC DBTranslator4IntegerVariable: public DBTranslator {
      public:
      // ##########################################################################
