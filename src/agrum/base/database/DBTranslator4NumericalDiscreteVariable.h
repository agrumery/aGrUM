...
namespace gum {
  ...
  namespace learning {
     ...
     * @headerfile DBTranslator4NumericalDiscreteVariable.h <agrum/base/database/DBTranslator4NumericalDiscreteVariable.h>
     * @brief The databases' cell translators for numerical Discrete variables
     *
     ...
     */
    class GUM_SHARED_PUBLIC DBTranslator4NumericalDiscreteVariable: public DBTranslator {
      public:
      // ##########################################################################
      ...
      [[nodiscard]] DBTranslator4NumericalDiscreteVariable* clone() const override;
