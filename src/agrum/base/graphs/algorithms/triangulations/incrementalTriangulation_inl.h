...
#include <agrum/base/graphs/algorithms/triangulations/incrementalTriangulation.h>   // to ease IDE parser
...
namespace gum {
  ...
  INLINE const UnconstrainedTriangulation& IncrementalTriangulation::triangulationAlgo() const {
