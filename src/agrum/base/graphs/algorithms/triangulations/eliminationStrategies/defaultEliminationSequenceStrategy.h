...
namespace gum {
   ...
   *
   */
  class GUM_SHARED_PUBLIC DefaultEliminationSequenceStrategy:
    ...
    [[nodiscard]] DefaultEliminationSequenceStrategy* newFactory() const final;
    ...
    [[nodiscard]] DefaultEliminationSequenceStrategy* copyFactory() const final;
