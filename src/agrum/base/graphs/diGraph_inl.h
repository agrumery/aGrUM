...
namespace gum {
  ...
  INLINE std::optional< std::vector< NodeId > > DiGraph::directedPath(NodeId node1,
                                                                      NodeId node2) const {
    return graph::directedPath(*this, node1, node2);
  }

  INLINE std::optional< std::vector< NodeId > >
         DiGraph::directedUnorientedPath(NodeId node1, NodeId node2) const {
