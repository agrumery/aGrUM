...
namespace gum {
  ...
  ListBucket< Val >::ListBucket(const Val& v) : _val_{v} {
  ...
  template < typename Val >
  ListBucket< Val >::ListBucket(Val&& v) noexcept : _val_{std::move(v)} {
    // for debugging purposes
    GUM_CONSTRUCTOR(ListBucket);
  }
  ...
  ListBucket< Val >::ListBucket(typename ListBucket< Val >::Emplace, Args&&... args) :
  ...
  // copy constructor
  template < typename Val >
  ListBucket< Val >::ListBucket(const ListBucket< Val >& src) : _val_{src._val_} {
    // for debugging purposes
  ...
  template < typename Val >
  const Val& ListBucket< Val >::operator*() const noexcept {
    return _val_;
  }

  // dereferencing operator
  template < typename Val >
  Val& ListBucket< Val >::operator*() noexcept {
    return _val_;
  }

  // returns the bucket toward the next element
  template < typename Val >
  const ListBucket< Val >* ListBucket< Val >::next() const noexcept {
    return _next_;
  }

  // returns the bucket toward the preceding element
  template < typename Val >
  const ListBucket< Val >* ListBucket< Val >::previous() const noexcept {
    return _prev_;
  }
  ...
  // default constructor
  template < typename Val >
  ListConstIterator< Val >::ListConstIterator() noexcept {
    // for debugging purposes
  ...
  // default constructor
  template < typename Val >
  ListConstIterator< Val >::ListConstIterator(const List< Val >& theList) noexcept :
  ...
  // copy constructor
  template < typename Val >
  ListConstIterator< Val >::ListConstIterator(const ListConstIterator< Val >& src) noexcept :
  ...
  // List.
  template < typename Val >
  ListConstIterator< Val >::ListConstIterator(const List< Val >& theList, Size ind_elt) {
    // for debugging purposes
    GUM_CONSTRUCTOR(ListConstIterator);
  ...
  template < typename Val >
  ListBucket< Val >* ListConstIterator< Val >::_getBucket_() const noexcept {
    return _bucket_;
  }

  // Makes the iterator point toward nothing
  template < typename Val >
  void ListConstIterator< Val >::clear() noexcept {
    _bucket_ = nullptr;
  }

  // positions the iterator to the end of the list
  template < typename Val >
  void ListConstIterator< Val >::setToEnd() noexcept {
    _bucket_ = nullptr;
  }
  ...
  // list
  template < typename Val >
  bool ListConstIterator< Val >::isEnd() const noexcept {
  ...
  // basic constructor
  template < typename Val >
  ListIterator< Val >::ListIterator() noexcept : ListConstIterator< Val >() {
    GUM_CONSTRUCTOR(ListIterator);
  }

  // constructor for a begin
  template < typename Val >
  ListIterator< Val >::ListIterator(const List< Val >& theList) noexcept :
  ...
  // move constructor
  template < typename Val >
  ListIterator< Val >::ListIterator(ListIterator< Val >&& src) noexcept :
  ...
  // List.
  template < typename Val >
  ListIterator< Val >::ListIterator(const List< Val >& theList, Size ind_elt) :
  ...
  // move operator
  template < typename Val >
  ListIterator< Val >& ListIterator< Val >::operator=(ListIterator< Val >&& src) noexcept {
  ...
  // test equality
  template < typename Val >
  bool ListIterator< Val >::operator==(const ListIterator< Val >& src) const noexcept {
  ...
  // basic constructor
  template < typename Val >
  ListConstIteratorSafe< Val >::ListConstIteratorSafe() noexcept {
    // for debugging purposes
  ...
  // Constructor for a begin
  template < typename Val >
  ListConstIteratorSafe< Val >::ListConstIteratorSafe(const List< Val >& theList) :
  ...
  template < typename Val >
  void ListConstIteratorSafe< Val >::_removeFromSafeList_() const {
  ...
  // returns the bucket the iterator is pointing to
  template < typename Val >
  ListBucket< Val >* ListConstIteratorSafe< Val >::_getBucket_() const noexcept {
    return _bucket_;
  }

  // Makes the iterator point toward nothing
  template < typename Val >
  void ListConstIteratorSafe< Val >::clear() {
  ...
  // positions the iterator to the end of the list
  template < typename Val >
  void ListConstIteratorSafe< Val >::setToEnd() {
    clear();
  }
  ...
  // list
  template < typename Val >
  bool ListConstIteratorSafe< Val >::isEnd() const {
  ...
  // makes the iterator point to the next element in the List
  template < typename Val >
  ListConstIteratorSafe< Val >& ListConstIteratorSafe< Val >::operator++() noexcept {
  ...
  // makes the iterator point to i elements before in the List
  template < typename Val >
  ListConstIteratorSafe< Val >& ListConstIteratorSafe< Val >::_opMinus_(Size i) noexcept {
    // check if we are pointing to something that has been deleted
    if (_null_pointing_) {
      _null_pointing_ = false;
  ...
  // makes the iterator point to the next element in the List
  template < typename Val >
  ListConstIteratorSafe< Val >& ListConstIteratorSafe< Val >::_opPlus_(Size i) noexcept {
    // check if we are pointing to something that has been deleted
    if (_null_pointing_) {
      _null_pointing_ = false;
  ...
  // dereferences the value pointed to by the iterator
  template < typename Val >
  const Val* ListConstIteratorSafe< Val >::operator->() const {
    if (_bucket_ != nullptr) return &(_bucket_->_val_);
    else { GUM_ERROR(UndefinedIteratorValue, "Accessing a NULL object") }
  }
  ...
  // basic constructor
  template < typename Val >
  ListIteratorSafe< Val >::ListIteratorSafe() noexcept : ListConstIteratorSafe< Val >() {
  ...
  ListIteratorSafe< Val >::ListIteratorSafe(const List< Val >& theList) :
  ...
  // List.
  template < typename Val >
  ListIteratorSafe< Val >::ListIteratorSafe(const List< Val >& theList, Size ind_elt) :
  ...
  // move constructor
  template < typename Val >
  ListIteratorSafe< Val >::ListIteratorSafe(ListIteratorSafe< Val >&& src) :
  ...
  // Destructor
  template < typename Val >
  ListIteratorSafe< Val >::~ListIteratorSafe() {
    GUM_DESTRUCTOR(ListIteratorSafe);
  }

  // test equality
  template < typename Val >
  bool ListIteratorSafe< Val >::operator==(const ListIteratorSafe< Val >& src) const {
  ...
  // makes the iterator point to the next element in the List
  template < typename Val >
  ListIteratorSafe< Val >& ListIteratorSafe< Val >::operator++() noexcept {
  ...
  // makes the iterator point to the next element in the List
  template < typename Val >
  ListIteratorSafe< Val >& ListIteratorSafe< Val >::operator+=(
  ...
  // dereferences the value pointed to by the iterator
  template < typename Val >
  Val* ListIteratorSafe< Val >::operator->() {
    return const_cast< Val* >(ListConstIteratorSafe< Val >::operator->());
  }

  // dereferences the value pointed to by the iterator
  template < typename Val >
  const Val* ListIteratorSafe< Val >::operator->() const {
  ...
  // move constructor
  template < typename Val >
  List< Val >::List(List< Val >&& src) noexcept :
  ...
  template < typename Val >
  List< Val >::List(std::initializer_list< Val > list) {
    // for debugging purposes
    GUM_CONSTRUCTOR(List);
  ...
  // move operator
  template < typename Val >
  List< Val >& List< Val >::operator=(List< Val >&& src) {
    // avoid self assignment
    if (this != &src) {
      // for debugging purposes
      GUM_OP_MOV(List);
  ...
  template < typename Val >
  const ListConstIteratorSafe< Val >& List< Val >::cendSafe() const noexcept {
    return *(reinterpret_cast< const ListConstIteratorSafe< Val >* >(_list_end_safe_));
  }

  // the iterator pointing to the end of the List
  template < typename Val >
  const ListIteratorSafe< Val >& List< Val >::endSafe() noexcept {
    return *(reinterpret_cast< const ListIteratorSafe< Val >* >(_list_end_safe_));
  }

  // the iterator pointing to the end of the List
  template < typename Val >
  const ListConstIterator< Val >& List< Val >::cend() const noexcept {
    return *(reinterpret_cast< const ListConstIterator< Val >* >(_list_end_));
  }

  // the iterator pointing to the end of the List
  template < typename Val >
  const ListIterator< Val >& List< Val >::end() noexcept {
    return *(reinterpret_cast< const ListIterator< Val >* >(_list_end_));
  }

  // the iterator pointing to the end of the List
  template < typename Val >
  const ListConstIterator< Val >& List< Val >::end() const noexcept {
    return *(reinterpret_cast< const ListConstIterator< Val >* >(_list_end_));
  }

  // the iterator pointing to the rend (just before the beginning) of the List
  template < typename Val >
  const ListConstIteratorSafe< Val >& List< Val >::crendSafe() const noexcept {
    return *(reinterpret_cast< const ListConstIteratorSafe< Val >* >(_list_end_safe_));
  }

  // the iterator pointing to the rend (just before the beginning) of the List
  template < typename Val >
  const ListIteratorSafe< Val >& List< Val >::rendSafe() noexcept {
    return *(reinterpret_cast< const ListIteratorSafe< Val >* >(_list_end_safe_));
  }

  // the iterator pointing to the rend (just before the beginning) of the List
  template < typename Val >
  const ListConstIterator< Val >& List< Val >::crend() const noexcept {
    return *(reinterpret_cast< const ListConstIterator< Val >* >(_list_end_));
  }

  // the iterator pointing to the rend (just before the beginning) of the List
  template < typename Val >
  const ListIterator< Val >& List< Val >::rend() noexcept {
    return *(reinterpret_cast< const ListIterator< Val >* >(_list_end_));
  }

  // the iterator pointing to the rend (just before the beginning) of the List
  template < typename Val >
  const ListConstIterator< Val >& List< Val >::rend() const noexcept {
    return *(reinterpret_cast< const ListConstIterator< Val >* >(_list_end_));
  }

  // the iterator pointing to the beginning of the List
  template < typename Val >
  ListConstIteratorSafe< Val > List< Val >::cbeginSafe() const {
    return ListConstIteratorSafe< Val >{*this};
  }

  // the iterator pointing to the beginning of the List
  template < typename Val >
  ListIteratorSafe< Val > List< Val >::beginSafe() {
    return ListIteratorSafe< Val >{*this};
  }

  // the iterator pointing to the beginning of the List
  template < typename Val >
  ListConstIterator< Val > List< Val >::cbegin() const {
  ...
  template < typename Val >
  ListConstIteratorSafe< Val > List< Val >::crbeginSafe() const {
  ...
  // the iterator pointing to the rbegin (the last element) of the List
  template < typename Val >
  ListIteratorSafe< Val > List< Val >::rbeginSafe() {
  ...
  // the iterator pointing to the rbegin (the last element) of the List
  template < typename Val >
  ListConstIterator< Val > List< Val >::crbegin() const {
  ...
  template < typename Val >
  ListBucket< Val >* List< Val >::_createBucket_(const Val& val) const {
    return new ListBucket< Val >(val);
  }

  // create a new bucket with a given value
  template < typename Val >
  ListBucket< Val >* List< Val >::_createBucket_(Val&& val) const {
  ...
  template < typename Val >
  template < typename... Args >
  ListBucket< Val >* List< Val >::_createEmplaceBucket_(Args&&... args) const {
  ...
  template < typename Val >
  Val& List< Val >::_pushFront_(ListBucket< Val >* new_elt) {
  ...
  template < typename Val >
  Val& List< Val >::_pushBack_(ListBucket< Val >* new_elt) {
  ...
  template < typename Val >
  Val& List< Val >::pushFront(const Val& val) {
    return _pushFront_(_createBucket_(val));
  }

  // Insertion of a new element (a copy) at the beginning of the chained list.
  template < typename Val >
  Val& List< Val >::pushFront(Val&& val) {
  ...
  template < typename Val >
  template < typename... Args >
  Val& List< Val >::push_front(Args&&... args) {
  ...
  template < typename Val >
  template < typename... Args >
  Val& List< Val >::emplaceFront(Args&&... args) {
  ...
  template < typename Val >
  Val& List< Val >::pushBack(const Val& val) {
    return _pushBack_(_createBucket_(val));
  }

  // pushBack for rvalues
  template < typename Val >
  Val& List< Val >::pushBack(Val&& val) {
  ...
  template < typename Val >
  template < typename... Args >
  Val& List< Val >::push_back(Args&&... args) {
  ...
  template < typename Val >
  template < typename... Args >
  Val& List< Val >::emplaceBack(Args&&... args) {
  ...
  // pushBack)
  template < typename Val >
  Val& List< Val >::insert(const Val& val) {
    return pushBack(val);
  }

  // insert for rvalues
  template < typename Val >
  Val& List< Val >::insert(Val&& val) {
    return pushBack(std::move(val));
  }

  // returns the bucket corresponding to the ith position
  template < typename Val >
  ListBucket< Val >* List< Val >::_getIthBucket_(Size i) const noexcept {
    ListBucket< Val >* ptr;
  ...
  template < typename Val >
  Val& List< Val >::insert(Size pos, const Val& val) {
  ...
  template < typename Val >
  Val& List< Val >::insert(Size pos, Val&& val) {
    // if ther are fewer elements than pos, put the value at the end of the list
  ...
  // iterator
  template < typename Val >
  Val& List< Val >::insert(const const_iterator_safe& iter, const Val& val, location place) {
  ...
  // iterator
  template < typename Val >
  Val& List< Val >::insert(const const_iterator_safe& iter, Val&& val, location place) {
    // if the iterator does not point to the list, raise an exception
    if (iter._list_ != this) {
      GUM_ERROR(InvalidArgument, "the iterator does not point to the correct list")
    }
  ...
  // iterator
  template < typename Val >
  Val& List< Val >::insert(const const_iterator& iter, const Val& val, location place) {
    return _insert_(iter, _createBucket_(val), place);
  }
  ...
  // iterator
  template < typename Val >
  Val& List< Val >::insert(const const_iterator& iter, Val&& val, location place) {
    return _insert_(iter, _createBucket_(std::move(val)), place);
  }
  ...
  template < typename Val >
  template < typename... Args >
  Val& List< Val >::emplace(const const_iterator& iter, Args&&... args) {
  ...
  template < typename Val >
  template < typename... Args >
  Val& List< Val >::emplace(const const_iterator_safe& iter, Args&&... args) {
    return _insert_(iter, _createEmplaceBucket_(std::forward< Args >(args)...), location::BEFORE);
  }

  // returns a reference to first element of a list
  template < typename Val >
  Val& List< Val >::front() const {
  ...
  template < typename Val >
  void List< Val >::_erase_(ListBucket< Val >* bucket) {
  ...
  template < typename Val >
  void List< Val >::erase(const iterator_safe& iter) {
    _erase_(iter._getBucket_());
  }

  // erases the element of the List pointed to by the iterator
  template < typename Val >
  void List< Val >::erase(const const_iterator_safe& iter) {
    _erase_(iter._getBucket_());
  }

  // returns the bucket corresponding to a given value.
  template < typename Val >
  ListBucket< Val >* List< Val >::_getBucket_(const Val& val) const noexcept {
    for (ListBucket< Val >* ptr = _deb_list_; ptr != nullptr; ptr = ptr->_next_)
  ...
  template < typename Val >
  bool List< Val >::empty() const noexcept {
  ...
  template < typename Val >
  Val& List< Val >::operator[](const Size i) {
  ...
  // returns the ith element in the current chained list.
  template < typename Val >
  const Val& List< Val >::operator[](const Size i) const {
    // check if we can return the element we ask for
    if (i >= _nb_elements_) { GUM_ERROR(NotFound, "not enough elements in the chained list") }
  ...
  template < typename Val >
  void List< Val >::swap(List& other_list) {
