...
namespace gum {
  ...
  template < typename Key, typename Val >
  const typename HashTable< Key, Val >::iterator_safe&
  ...
  template < typename Key, typename Val >
  typename HashTable< Key, Val >::const_iterator_safe
  ...
  template < typename Key, typename Val >
  HashTableIterator< Key, Val >::HashTableIterator(const HashTable< Key, Val >& tab,
                                                          Size                         ind_elt) :
