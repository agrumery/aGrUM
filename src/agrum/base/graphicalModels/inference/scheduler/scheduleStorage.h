...
namespace gum {
   ...
   * @headerfile scheduleStore.h <agrum/base/graphicalModels/inference/scheduler/scheduleStore.h>
...
#include <agrum/base/graphicalModels/inference/scheduler/scheduleStorage_tpl.h>
