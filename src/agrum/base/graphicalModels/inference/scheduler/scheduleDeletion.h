...
namespace gum {
   ...
   * @headerfile scheduleDeletion.h <agrum/base/graphicalModels/inference/scheduler/scheduleDeletion.h>
   *
...
#include <agrum/base/graphicalModels/inference/scheduler/scheduleDeletion_tpl.h>
