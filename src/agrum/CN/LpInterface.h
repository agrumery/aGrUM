      ...
      */
      class LpCol {
        public:
          ...
          * @return The address of the caller.
          */
          friend std::ostream& operator<< ( std::ostream& out, const LpCol& col );    // calls col.toString(), friend is useless but good for documentation purpose
  ...
  namespace credal {
    namespace lp {
      ...
      */
      ...
      class LpInterface {
        public:
          ...
          */
          template< typename T >
          friend std::ostream& operator<< ( std::ostream& out, const LpInterface< T >& lpi );    // calls lpi.toString(), friend is useless but good for documentation purpose
      ...
      */
      ...
      template< typename T1, forbidden_type<T1, LpExpr&> = 0 , forbidden_type<T1, LpCol&> = 0> LpExpr operator<= ( T1 && lhs,  const LpExpr & rhs );
      template< typename T1, forbidden_type<T1, LpExpr&> = 0 , forbidden_type<T1, LpCol&> = 0> LpExpr operator<= ( T1 && lhs,  const LpCol & rhs );
      */
      template<typename T1,typename T2> LpExpr operator<=(T1 && lhs,T2&& rhs);
