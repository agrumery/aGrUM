...
if (MSVC)
	set(MVSC_FLAGS "-DNOMINMAX /bigobj")
else()
	set(MVSC_FLAGS "")
endif()
set(CMAKE_CXX_FLAGS_DEBUG " -DGUM_NO_INLINE $MVSC_FLAGS")
set(CMAKE_C_FLAGS_DEBUG " -DGUM_NO_INLINE $MVSC_FLAGS")

set(CMAKE_CXX_FLAGS_RELEASE "${AGRUM_OPTIMIZATION} -DNDEBUG ${AGRUM_INLINING_POLICY} ${MVSC_FLAGS}")
set(CMAKE_C_FLAGS_RELEASE "${AGRUM_OPTIMIZATION} -DNDEBUG ${AGRUM_INLINING_POLICY} ${MVSC_FLAGS}")
