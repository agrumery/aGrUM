...
macro(FlexBisonTarget TARGETNAME DIRNAME FILENAME)
  ...
  add_custom_command(
    ...
    ARGS -o${AGRUM_BINARY_DIR}/${FILENAME}_lex.cpp
          ${AGRUM_SOURCE_DIR}/agrum/${DIRNAME}/${TARGETNAME}/${FILENAME}.lpp
    TARGET ${TARGETNAME}
    OUTPUTS ${AGRUM_BINARY_DIR}/${FILENAME}_lex.cpp)
  ...
  add_custom_command(
    ...
    ARGS -y ${AGRUM_SOURCE_DIR}/agrum/${DIRNAME}/${TARGETNAME}/${FILENAME}.ypp
          -o ${AGRUM_BINARY_DIR}/${FILENAME}.cpp
    TARGET ${TARGETNAME}
    DEPENDS ${AGRUM_BINARY_DIR}/${FILENAME}_lex.cpp
    OUTPUTS ${AGRUM_BINARY_DIR}/${FILENAME}.cpp)

  # Add parser to the list of sources
  set(AGRUM_SOURCES ${AGRUM_SOURCES} ${AGRUM_BINARY_DIR}/${FILENAME}.cpp ${AGRUM_BINARY_DIR}/${FILENAME}_lex.cpp)

  # Since parser does not exists yet when cmake is run, mark it as generated
  set_source_files_properties(${AGRUM_BINARY_DIR}/${FILENAME}.cpp GENERATED)
  set_source_files_properties(${AGRUM_BINARY_DIR}/${FILENAME}.hpp GENERATED)
  set_source_files_properties(${AGRUM_BINARY_DIR}/${FILENAME}_lex.cpp GENERATED)
