  ...
  class MultiDimNoisyORNetTestSuite: public CxxTest::TestSuite {
    public:
      ...
      void testComputationInNoisyORNet2() {
        ...
        gum::Instantiation i( p );
        float witness[] = {0.9999,0.0001,0.09999,0.90001,0.29997,0.70003,0.029997,0.970003,0.49995,0.50005,0.049995,0.950005,0.149985,0.850015,0.014999,0.985002,0.69993,0.30007,
                           0.069993,0.930007,0.209979,0.790021,0.020998,0.979002,0.349965,0.650035,0.034997,0.965004,0.104990,0.895011,0.010499,0.989501,0.89991,0.10009,0.089991,0.910009,0.269973,0.730027,
                           0.026997,0.973003,0.449955,0.550045,0.044996,0.955005,0.134987,0.865014,0.013499,0.986501,0.629937,0.370063,0.062994,0.937006,0.188981,0.811019,0.018898,0.981101,0.314969,0.685032,
                           0.031497,0.968503,0.094491,0.905509,0.009449,0.990551
                          };
      ...
      void testNoisyORNetInBN() {
        ...
        {
          // FILLING PARAMS
          const float t[16] = {0.1, 0.9, 0.8, 0.2,0.1, 0.9, 0.8, 0.2,0.1, 0.9, 0.8, 0.2,0.1, 0.9, 0.8, 0.2};
          int n = 16; const std::vector<float> v( t, t + n );
          pOneMore.fillWith( v );
        }
