...
namespace gum_tests {
  ...
  class BDeuPriorTestSuite: public CxxTest::TestSuite {
    public:
    void test1() {
      ...
      TS_ASSERT_EQUALS(prior.getType(), gum::learning::PriorType::BDeuPriorType)
      ...
      gum::learning::BDeuPrior apriori2(prior);
      ...
      gum::learning::BDeuPrior* apriori4 = prior.clone();
