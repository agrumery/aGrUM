...
namespace gum_tests {
  ...
  class AprioriNoAprioriTestSuite: public CxxTest::TestSuite {
    ...
    void test1() {
      ...
      TS_ASSERT_EQUALS(apriori.getType(), "NoApriori")
      ...
      TS_ASSERT_EQUALS(apriori2.getType(), "NoApriori")
      ...
      TS_ASSERT_EQUALS(apriori3.getType(), "NoApriori")
      ...
      TS_ASSERT_EQUALS(apriori4->getType(), "NoApriori")
      ...
      TS_ASSERT_EQUALS(apriori5.getType(), "NoApriori")
