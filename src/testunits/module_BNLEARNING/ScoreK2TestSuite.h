  ...
  class ScoreK2TestSuite: public CxxTest::TestSuite {
    ...
    void _test_no_range_no_nodeId2col() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
         gum::learning::ScoreK2::isAprioriCompatible(gum::learning::AprioriNoApriori::type::type));
      TS_GUM_ASSERT_THROWS_NOTHING(gum::learning::ScoreK2::isAprioriCompatible(apriori))
      TS_GUM_ASSERT_THROWS_NOTHING(
