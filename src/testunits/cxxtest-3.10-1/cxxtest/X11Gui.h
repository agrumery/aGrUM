  ...
  class X11Gui: public GuiListener {
    ...
    void parseCommandLine(int& argc, char** argv) {
      ...
      for (int i = 1; i + 1 < argc; ++i) {
        if (!strcmp(argv[i], "-title")) _programName = argv[++i];
        else if (!strcmp(argv[i], "-fn") || !strcmp(argv[i], "-font")) _fontName = argv[++i];
        ...
        else if (!strcmp(argv[i], "-green")) _greenName = argv[++i];
        else if (!strcmp(argv[i], "-yellow")) _yellowName = argv[++i];
        else if (!strcmp(argv[i], "-red")) _redName = argv[++i];
      }
    }

    void openDisplay() { _display = XOpenDisplay(nullptr); }
    ...
    void freeFontInfo() { XFreeFontInfo(nullptr, _fontInfo, 1); }
