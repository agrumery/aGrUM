...
//
#define __CXXTEST_MOCK_CLASS__DECLARATION(MOCK, TYPE, NAME, ARGS, REAL, CALL) \
  namespace CXXTEST_MOCK_NAMESPACE {                                          \
...
#define __CXXTEST_SUPPLY_CLASS__DECLARATION(MOCK, TYPE, NAME, ARGS, REAL, CALL) \
  namespace CXXTEST_MOCK_NAMESPACE {                                            \
    class Base_##MOCK: public CxxTest::Link {                                   \
      public:                                                                   \
      Base_##MOCK();                                                            \
...
#define __CXXTEST_SUPPLY_VOID_CLASS__DECLARATION(MOCK, NAME, ARGS, REAL, CALL) \
...
#define __CXXTEST_MOCK_COMMON_CLASS__IMPLEMENTATION(MOCK, NAME)      \
  namespace CXXTEST_MOCK_NAMESPACE {                                 \
    ...
    Base_##MOCK& Base_##MOCK::current() {                            \
      if (_list.empty()) static _Unimplemented_##MOCK unimplemented; \
      return *(Base_##MOCK*)_list.tail();                            \
    }                                                                \
  }

#define __CXXTEST_MOCK_CLASS__IMPLEMENTATION(MOCK, TYPE, NAME, ARGS, REAL, CALL) \
...
#define __CXXTEST_MOCK_VOID_CLASS__IMPLEMENTATION(MOCK, NAME, ARGS, REAL, CALL) \
  __CXXTEST_MOCK_COMMON_CLASS__IMPLEMENTATION(MOCK, NAME)                       \
  namespace CXXTEST_MOCK_NAMESPACE {                                            \
...
#define __CXXTEST_SUPPLY_CLASS__IMPLEMENTATION(MOCK, TYPE, NAME, ARGS, REAL, CALL) \
  __CXXTEST_MOCK_COMMON_CLASS__IMPLEMENTATION(MOCK, NAME)                          \
  namespace CXXTEST_MOCK_NAMESPACE {                                               \
    TYPE _Unimplemented_##MOCK::NAME ARGS {                                        \
      while (false)                                                                \
...
#define __CXXTEST_SUPPLY_VOID_CLASS__IMPLEMENTATION(MOCK, NAME, ARGS, REAL, CALL) \
  __CXXTEST_MOCK_COMMON_CLASS__IMPLEMENTATION(MOCK, NAME)                         \
  namespace CXXTEST_MOCK_NAMESPACE {                                              \
    void _Unimplemented_##MOCK::NAME ARGS {                                       \
      while (false)                                                               \
