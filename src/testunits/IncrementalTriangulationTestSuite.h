    ...
    class IncrementalTriangulationTestSuite: public CxxTest::TestSuite {
      public:
        ...
        void testElimSeq() {
          ...
          TS_ASSERT_EQUALS( elim4[0], 80U );
          TS_ASSERT_EQUALS( elim4[1], 30U );
          TS_ASSERT_EQUALS( elim4[2], 10U );
          TS_ASSERT_EQUALS( elim4[3], 70U );
          TS_ASSERT_EQUALS( elim4[4], 60U );
          TS_ASSERT_EQUALS( elim4[5], 40U );
          TS_ASSERT_EQUALS( elim4[6], 50U );
          TS_ASSERT_EQUALS( elim4[7], 20U );

          TS_ASSERT_EQUALS( triang.eliminationOrder( 80U ), 0U );
          TS_ASSERT_EQUALS( triang.eliminationOrder( 30U ), 1U );
          TS_ASSERT_EQUALS( triang.eliminationOrder( 10U ), 2U );
          TS_ASSERT_EQUALS( triang.eliminationOrder( 70U ), 3U );
          TS_ASSERT_EQUALS( triang.eliminationOrder( 60U ), 4U );
          TS_ASSERT_EQUALS( triang.eliminationOrder( 40U ), 5U );
          TS_ASSERT_EQUALS( triang.eliminationOrder( 50U ), 6U );
