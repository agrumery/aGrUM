...
namespace gum_tests {
  ...
  GUM_TEST(Constructor) { GUM_CHECK_ASSERT_THROWS_NOTHING(gum::NodeGraphPart ngp); }
  ...
  GUM_TEST(BigNodeGraphPart) { GUM_CHECK_ASSERT_THROWS_NOTHING(_privateTestBigNodeGraphPart_()); }
