...
namespace gum_tests {
  ...
  struct BijectionTestSuite {
    ...
    static void test_constructors1() {
      ...
      CHECK_EQ(bijection2.size(), (gum::Size) static_cast< gum::Size >(3));

      gum::Bijection< int, int > bij_bis(bijection);
      bij_bis.insert(8, 10);
      CHECK_EQ(bij_bis.size(), (gum::Size) static_cast< gum::Size >(4));
      ...
      delete bijection3;
      CHECK_EQ(bijection4.first(2), 1);
      CHECK_EQ(bijection4.first(3), 3);
      CHECK_EQ(bijection4.second(1), 2);
      CHECK_EQ(bijection4.second(3), 3);

      gum::Bijection< int, int > bij_ter(std::move(bij_bis));
      CHECK_EQ(bij_ter.size(), (gum::Size) static_cast< gum::Size >(4));

      gum::Bijection< int, int > bij5{std::pair< int, int >(3, 4), std::pair< int, int >(5, 6)};
      CHECK_EQ(bij5.size(), (gum::Size) static_cast< gum::Size >(2));

      bij5 = bijection;
      CHECK_EQ(bij5.size(), (gum::Size) static_cast< gum::Size >(3));
      CHECK(bij5.existsFirst(5));
      CHECK(bij5.existsFirst(3));

      bij5 = bij_ter;
      CHECK_EQ(bij5.size(), (gum::Size) static_cast< gum::Size >(4));
      CHECK(bij5.existsFirst(8));

      bij5 = std::move(bijection);
      CHECK_EQ(bij5.size(), static_cast< gum::Size >(3));
    }   // namespace gum_tests
    ...
    static void test_constructors2() {
      ...
      CHECK_EQ(bijection2.size(), static_cast< gum::Size >(3));

      gum::Bijection< std::string, std::string > bij_bis(bijection);
      bij_bis.insert("d", "bd");
      CHECK_EQ(bij_bis.size(), static_cast< gum::Size >(4));
      ...
      bijection4                                            = *bijection3;
      delete bijection3;
      CHECK_EQ(bijection4.first("a"), "b");
      CHECK_EQ(bijection4.first("b"), "a");
      CHECK_EQ(bijection4.second("a"), "b");
      CHECK_EQ(bijection4.second("b"), "a");

      gum::Bijection< std::string, std::string > bij_ter(std::move(bij_bis));
      CHECK_EQ(bij_ter.size(), static_cast< gum::Size >(4));

      gum::Bijection< std::string, std::string > bij5{
          std::pair< std::string, std::string >("3", "4"),
          std::pair< std::string, std::string >("5", "6")};
      CHECK_EQ(bij5.size(), static_cast< gum::Size >(2));
      ...
      bij5 = bij_ter;
      CHECK_EQ(bij5.size(), static_cast< gum::Size >(4));
    ...
    static void testMoves() {
      ...
      CHECK_EQ(bij2.size(), static_cast< gum::Size >(3));
      CHECK_EQ(bij2.second(3), 4);
    }
    ...
    static void testAccess1() {
      ...
      CHECK_EQ(bijection.first(2), 1);
      CHECK_EQ(bijection.first(4), 3);
      CHECK_EQ(bijection.first(6), 5);
      CHECK_EQ(bijection.second(1), 2);
      CHECK_EQ(bijection.second(3), 4);
      CHECK_EQ(bijection.second(5), 6);
      ...
      CHECK_EQ(bijection.size(), static_cast< gum::Size >(3));
    ...
    static void testResize() {
      ...
      CHECK_NE(bijection.capacity(), static_cast< gum::Size >(2));
    }
    ...
    static void testIterators1() {
      ...
      CHECK_EQ(nb, (gum::Size) static_cast< gum::Size >(8));
      ...
      CHECK_EQ(nb, (gum::Size) static_cast< gum::Size >(4));
    ...
    static void test_constructorsStar() {
      ...
      bijection4                              = *bijection3;
      delete bijection3;
      CHECK_EQ(bijection4.first((int*)2), (int*)1);
      CHECK_EQ(bijection4.first((int*)3), (int*)3);
      CHECK_EQ(bijection4.second((int*)1), (int*)2);
      CHECK_EQ(bijection4.second((int*)3), (int*)3);
    }
    ...
    static void testAccessStar() {
      ...
      CHECK_EQ(bijection.first((int*)2), (int*)1);
      CHECK_EQ(bijection.first((int*)4), (int*)3);
      CHECK_EQ(bijection.first((int*)6), (int*)5);
      CHECK_EQ(bijection.second((int*)1), (int*)2);
      CHECK_EQ(bijection.second((int*)3), (int*)4);
      CHECK_EQ(bijection.second((int*)5), (int*)6);
