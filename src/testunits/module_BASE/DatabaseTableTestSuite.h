...
namespace gum_tests {
  ...
  struct DatabaseTableTestSuite {
    ...
    static void test_db1() {
      {
        ...
        GUM_CHECK_EQ(database1.content().size(), static_cast< gum::Size >(0));
        GUM_CHECK_EQ(database1.variableNames().size(), static_cast< gum::Size >(0));
        ...
        GUM_CHECK_EQ(dom1.size(), std::size_t(3));
        GUM_CHECK_EQ(dom1[0], std::size_t(0));
        GUM_CHECK_EQ(dom1[1], std::size_t(0));
        GUM_CHECK_EQ(dom1[2], std::size_t(0));

        database.setVariableNames({"v1", "v2", "v3"}, false);
        GUM_CHECK_EQ(database.variableNames().size(), static_cast< gum::Size >(3));
        GUM_CHECK_EQ(database.nbVariables(), static_cast< std::size_t >(3));
        GUM_CHECK_EQ(database.variableNames()[0], "v1");
        GUM_CHECK_EQ(database.variableNames()[1], "v2");
        GUM_CHECK_EQ(database.variableNames()[2], "v3");
        database.setVariableNames({"x1", "x2", "x3", "x4", "x5"}, true);
        GUM_CHECK_EQ(database.variableNames()[0], "x2");
        GUM_CHECK_EQ(database.variableNames()[1], "x4");
        GUM_CHECK_EQ(database.variableNames()[2], "x5");
        ...
        GUM_CHECK_EQ(db.nbVariables(), static_cast< std::size_t >(3));
        ...
        GUM_CHECK_EQ(db2.nbVariables(), static_cast< std::size_t >(3));
        ...
        GUM_CHECK_EQ(db3.nbVariables(), static_cast< std::size_t >(3));
        GUM_CHECK_EQ(db3.content().size(), static_cast< gum::Size >(2));

        database.insertRow(row);
        gum::learning::DatabaseTable db4(std::move(database));
        GUM_CHECK_EQ(db4.variableNames().size(), static_cast< gum::Size >(3));
        GUM_CHECK_EQ(db4.nbVariables(), static_cast< std::size_t >(3));
        GUM_CHECK_EQ(db4.content().size(), static_cast< gum::Size >(3));

        GUM_CHECK_EQ(db.content().size(), static_cast< gum::Size >(2));
        db = db4;
        GUM_CHECK_EQ(db.content().size(), static_cast< gum::Size >(3));

        db2 = std::move(db4);
        GUM_CHECK_EQ(db2.variableNames().size(), static_cast< gum::Size >(3));
        GUM_CHECK_EQ(db2.nbVariables(), static_cast< std::size_t >(3));
        GUM_CHECK_EQ(db2.content().size(), static_cast< gum::Size >(3));

        gum::learning::DatabaseTable* db5 = db.clone();
        GUM_CHECK_EQ(db5->variableNames().size(), static_cast< gum::Size >(3));
        GUM_CHECK_EQ(db5->nbVariables(), static_cast< std::size_t >(3));
        GUM_CHECK_EQ(db5->content().size(), static_cast< gum::Size >(3));
        delete db5;

        gum::learning::DatabaseTable* db6 = db.clone();
        GUM_CHECK_EQ(db6->variableNames().size(), static_cast< gum::Size >(3));
        GUM_CHECK_EQ(db6->nbVariables(), static_cast< std::size_t >(3));
        GUM_CHECK_EQ(db6->content().size(), static_cast< gum::Size >(3));
        GUM_CHECK_EQ(db6->size(), static_cast< gum::Size >(3));

        delete db6;

        for (const auto& db_row: db) {
          GUM_CHECK_EQ(db_row.weight(), 1);
        }

        db.setAllRowsWeight(10.0);
        for (const auto& db_row: db) {
          GUM_CHECK_EQ(db_row.weight(), 10.0);
        }

        GUM_CHECK_EQ(db.weight(), 10.0 * db.size());
        ...
        for (const auto& row: db) {
          if (index % 2) {
            ...
            GUM_CHECK_EQ(db.weight(index), 2.0);
          } else {
            GUM_CHECK_EQ(row.weight(), 10.0);
            GUM_CHECK_EQ(db.weight(index), 10.0);
          }
          ++index;
        }
      }   // namespace gum_tests
    ...
    static void test_db2() {
      ...
      GUM_CHECK_EQ(database.size(), static_cast< gum::Size >(1));
      ...
      GUM_CHECK_EQ(handler.range().second, static_cast< std::size_t >(6));
      ...
      GUM_CHECK_EQ(handler.DBSize(), static_cast< gum::Size >(6));
      GUM_CHECK_EQ(handler.numRow(), static_cast< std::size_t >(0));
      uhandler.setRange(1, 4);
      GUM_CHECK_EQ(uhandler.size(), static_cast< gum::Size >(3));
      GUM_CHECK_EQ(uhandler.DBSize(), static_cast< gum::Size >(6));
      GUM_CHECK_EQ(uhandler.numRow(), static_cast< std::size_t >(0));
      handler.nextRow();
      GUM_CHECK_EQ(handler.numRow(), static_cast< std::size_t >(1));
      ...
      GUM_CHECK_EQ(handler2.range().second, static_cast< std::size_t >(4));
      GUM_CHECK_EQ(handler2.numRow(), static_cast< std::size_t >(1));
      handler2.nextRow();
      GUM_CHECK_EQ(handler2.numRow(), static_cast< std::size_t >(2));
      ...
      GUM_CHECK_EQ(uhandler2.range().second, static_cast< std::size_t >(4));
      GUM_CHECK_EQ(uhandler2.numRow(), static_cast< std::size_t >(0));
      uhandler2.nextRow();
      GUM_CHECK_EQ(uhandler2.numRow(), static_cast< std::size_t >(1));
      ...
      GUM_CHECK_EQ(handler3.range().first, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(handler3.range().second, static_cast< std::size_t >(4));
      GUM_CHECK_EQ(handler3.numRow(), static_cast< std::size_t >(2));
      ...
      GUM_CHECK_EQ(uhandler3.range().first, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(uhandler3.range().second, static_cast< std::size_t >(4));
      GUM_CHECK_EQ(uhandler3.numRow(), static_cast< std::size_t >(1));

      handler2 = handler;
      GUM_CHECK_EQ(handler.range().second, static_cast< std::size_t >(4));
      GUM_CHECK_EQ(handler.size(), static_cast< gum::Size >(3));
      GUM_CHECK_EQ(handler.DBSize(), static_cast< gum::Size >(6));
      GUM_CHECK_EQ(handler.numRow(), static_cast< std::size_t >(1));

      uhandler2 = uhandler;
      GUM_CHECK_EQ(uhandler.range().second, static_cast< std::size_t >(4));
      GUM_CHECK_EQ(uhandler.size(), static_cast< gum::Size >(3));
      GUM_CHECK_EQ(uhandler.DBSize(), static_cast< gum::Size >(6));
      GUM_CHECK_EQ(uhandler.numRow(), static_cast< std::size_t >(0));
      ...
      GUM_CHECK_EQ(uhandler2.nbVariables(), static_cast< std::size_t >(3));
    ...
    static void test_db3() {
      ...
      const auto dom1 = database.domainSizes();
      GUM_CHECK_EQ(dom1.size(), std::size_t(3));
      GUM_CHECK_EQ(dom1[0], std::size_t(3));
      GUM_CHECK_EQ(dom1[1], std::size_t(3));
      GUM_CHECK_EQ(dom1[2], std::size_t(3));
      GUM_CHECK_EQ(database.domainSize(0), dom1[0]);
      GUM_CHECK_EQ(database.domainSize(1), dom1[1]);
      GUM_CHECK_EQ(database.domainSize(2), dom1[2]);
...

      {
        ...
        GUM_CHECK_EQ(database.variableNames()[1], "x2");
        std::vector< std::string > names2{"y1", "y2", "y3"};
        database.setVariableNames(names2);
        GUM_CHECK_EQ(database.variableNames()[1], "y2");
    ...
    static void test_db4() {
      ...
      GUM_CHECK_EQ(database2.nbVariables(), static_cast< std::size_t >(3));
      ...
      GUM_CHECK_EQ(handler2.row()[0].cont_val, 4.0f);
      GUM_CHECK_EQ(handler3.row()[0].cont_val, 5.0f);
      ...
      GUM_CHECK_EQ(uhandler2.row()[0].cont_val, 4.0f);
      GUM_CHECK_EQ(uhandler3.row()[0].cont_val, 5.0f);
      database2.eraseLastRow();
      GUM_CHECK_EQ(uhandler2.row()[0].cont_val, 4.0f);
      ...
      GUM_CHECK_EQ(handler2.range().second, static_cast< std::size_t >(5));
      handler2.nextRow();
      handler2.nextRow();
      handler2.nextRow();
      handler3 = std::move(handler2);
      GUM_CHECK_EQ(handler3.range().second, static_cast< std::size_t >(5));
    ...
    static void test_db6() {
      ...
      GUM_CHECK_EQ(database.variableNames()[1], "v2");
      GUM_CHECK_EQ(database.variableNames()[2], "v3");
      GUM_CHECK_EQ(database.variable(0).name(), "v1");
      GUM_CHECK_EQ(database.variable(1).name(), "v2");
      GUM_CHECK_EQ(database.variable(2).name(), "v3");
      ...
      database.insertRow(row, xmiss);
      GUM_CHECK_EQ(database.content().size(), static_cast< gum::Size >(4));
      GUM_CHECK_EQ(database.nbRows(), static_cast< std::size_t >(4));
      ...
      CHECK(database.hasMissingValues());
      GUM_CHECK_EQ(database.nbVariables(), static_cast< std::size_t >(5));
      database.eraseTranslators(5, true);
      CHECK(!database.hasMissingValues());
      GUM_CHECK_EQ(database.nbVariables(), static_cast< std::size_t >(3));
      GUM_CHECK_EQ(database.content()[0].size(), static_cast< gum::Size >(3));
      ...
      GUM_CHECK_EQ(database.nbVariables(), static_cast< std::size_t >(2));
      GUM_CHECK_EQ(database.variableNames()[0], "v1");
      GUM_CHECK_EQ(database.variableNames()[1], "v3");
      GUM_CHECK_EQ(database.variable(0).name(), "v1");
      GUM_CHECK_EQ(database.variable(1).name(), "v3");
      GUM_CHECK_EQ(database.content()[0].size(), static_cast< gum::Size >(2));
      GUM_CHECK_EQ(database.content()[1].size(), static_cast< gum::Size >(2));
      GUM_CHECK_EQ(database.content()[2].size(), static_cast< gum::Size >(2));
      GUM_CHECK_EQ(database.content()[3].size(), static_cast< gum::Size >(2));
      ...
      database.insertRow(row3, xmiss);
      GUM_CHECK_EQ(database.content().size(), static_cast< gum::Size >(8));
    }
    ...
    static void test_ignored_colums() {
      ...
      gum::learning::DatabaseTable database(set);
      GUM_CHECK_EQ(database.content().size(), static_cast< gum::Size >(0));
      GUM_CHECK_EQ(database.variableNames().size(), static_cast< gum::Size >(6));
      ...
      database.insertRow(row);
      database.insertRow(row);
      GUM_CHECK_EQ(database.content().size(), std::size_t(2));
      GUM_CHECK_EQ(content[0][0].cont_val, 0.0f);
      GUM_CHECK_EQ(content[0][1].cont_val, 1.0f);
      GUM_CHECK_EQ(content[0][2].cont_val, 2.0f);
      GUM_CHECK_EQ(content[0][3].cont_val, 3.0f);
      GUM_CHECK_EQ(content[1][0].cont_val, 0.0f);
      GUM_CHECK_EQ(content[1][1].cont_val, 1.0f);
      GUM_CHECK_EQ(content[1][2].cont_val, 2.0f);
      GUM_CHECK_EQ(content[1][3].cont_val, 3.0f);

      database.ignoreColumn(0, true);
      GUM_CHECK_EQ(dbnames.size(), std::size_t(5));
      GUM_CHECK_EQ(dbnames[0], "v1");
      GUM_CHECK_EQ(dbnames[1], "v2");
      GUM_CHECK_EQ(dbnames[2], "v3");
      GUM_CHECK_EQ(dbnames[3], "v4");
      GUM_CHECK_EQ(database.content().size(), std::size_t(2));
      GUM_CHECK_EQ(database.content()[0].size(), std::size_t(5));
      GUM_CHECK_EQ(content[0][0].cont_val, 1.0f);
      GUM_CHECK_EQ(content[0][1].cont_val, 2.0f);
      GUM_CHECK_EQ(content[0][2].cont_val, 3.0f);
      GUM_CHECK_EQ(content[0][3].cont_val, 4.0f);
      GUM_CHECK_EQ(content[1][0].cont_val, 1.0f);
      GUM_CHECK_EQ(content[1][1].cont_val, 2.0f);
      GUM_CHECK_EQ(content[1][2].cont_val, 3.0f);
      GUM_CHECK_EQ(content[1][3].cont_val, 4.0f);

      database.ignoreColumn(1, false);
      GUM_CHECK_EQ(dbnames.size(), std::size_t(4));
      GUM_CHECK_EQ(dbnames[0], "v1");
      GUM_CHECK_EQ(dbnames[1], "v3");
      GUM_CHECK_EQ(dbnames[2], "v4");
      GUM_CHECK_EQ(dbnames[3], "v5");
      GUM_CHECK_EQ(database.content().size(), std::size_t(2));
      GUM_CHECK_EQ(database.content()[0].size(), std::size_t(4));
      GUM_CHECK_EQ(content[0][0].cont_val, 1.0f);
      GUM_CHECK_EQ(content[0][1].cont_val, 3.0f);
      GUM_CHECK_EQ(content[0][2].cont_val, 4.0f);
      GUM_CHECK_EQ(content[0][3].cont_val, 5.0f);
      GUM_CHECK_EQ(content[1][0].cont_val, 1.0f);
      GUM_CHECK_EQ(content[1][1].cont_val, 3.0f);
      GUM_CHECK_EQ(content[1][2].cont_val, 4.0f);
      GUM_CHECK_EQ(content[1][3].cont_val, 5.0f);
      ...
      GUM_CHECK_EQ(ignored_vect[2], std::size_t(6));

      database.ignoreColumn(3, true);
      GUM_CHECK_EQ(dbnames.size(), std::size_t(3));
      GUM_CHECK_EQ(dbnames[0], "v1");
      GUM_CHECK_EQ(dbnames[1], "v4");
      GUM_CHECK_EQ(dbnames[2], "v5");
      GUM_CHECK_EQ(database.content().size(), std::size_t(2));
      GUM_CHECK_EQ(database.content()[0].size(), std::size_t(3));
      GUM_CHECK_EQ(content[0][0].cont_val, 1.0f);
      GUM_CHECK_EQ(content[0][1].cont_val, 4.0f);
      GUM_CHECK_EQ(content[0][2].cont_val, 5.0f);
      GUM_CHECK_EQ(content[1][0].cont_val, 1.0f);
      GUM_CHECK_EQ(content[1][1].cont_val, 4.0f);
      GUM_CHECK_EQ(content[1][2].cont_val, 5.0f);

      database.ignoreColumn(5, true);
      GUM_CHECK_EQ(dbnames.size(), std::size_t(2));
      database.ignoreColumn(1, true);
      GUM_CHECK_EQ(dbnames.size(), std::size_t(1));
      GUM_CHECK_EQ(content[0][0].cont_val, 4.0f);
      GUM_CHECK_EQ(content[1][0].cont_val, 4.0f);
      database.ignoreColumn(4, true);
      GUM_CHECK_EQ(dbnames.size(), std::size_t(0));
      GUM_CHECK_EQ(database.content().size(), std::size_t(0));
      ...
      database2.ignoreColumn(3, true);
      {
        ...
        GUM_CHECK_EQ(ignored_vect.size(), std::size_t(1));
        GUM_CHECK_EQ(ignored_vect[0], std::size_t(0));
      }
      ...
      {
        const auto ignored_vect = database2.ignoredColumns();
        GUM_CHECK_EQ(ignored_vect.size(), std::size_t(6));
        GUM_CHECK_EQ(ignored_vect[0], std::size_t(0));
        GUM_CHECK_EQ(ignored_vect[4], std::size_t(4));
        GUM_CHECK_EQ(ignored_vect[5], std::size_t(6));
      }
      ...
      database2.insertTranslator(translator, 2);
      {
        ...
        GUM_CHECK_EQ(cols[0], std::size_t(5));
        GUM_CHECK_EQ(cols[1], std::size_t(2));

        const auto ignored_vect = database2.ignoredColumns();
        GUM_CHECK_EQ(ignored_vect.size(), std::size_t(5));
        GUM_CHECK_EQ(ignored_vect[0], std::size_t(0));
        GUM_CHECK_EQ(ignored_vect[1], std::size_t(1));
        GUM_CHECK_EQ(ignored_vect[2], std::size_t(3));
        GUM_CHECK_EQ(ignored_vect[3], std::size_t(4));
        GUM_CHECK_EQ(ignored_vect[4], std::size_t(6));
      }
    }
    ...
    static void test_insert_translators() {
      ...
      GUM_CHECK_EQ(vnames.size(), static_cast< gum::Size >(3));
      GUM_CHECK_EQ(vnames[0], "var0");
      GUM_CHECK_EQ(vnames[1], "var1");
      GUM_CHECK_EQ(vnames[2], "var2");
      ...
      gum::learning::DBRow< gum::learning::DBTranslatedValue > row3(
          ...
          1.0f);
      database.insertRow(std::move(row3), xmiss);
      GUM_CHECK_EQ(database.nbRows(), static_cast< std::size_t >(3));
    ...
    void test_reordering() {
      ...
      GUM_CHECK_EQ(database.needsReordering(1), false);
      CHECK(database.needsReordering(2));

      const auto& content = database.content();
      database.reorder(0);
      GUM_CHECK_EQ(content[0][0].discr_val, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(content[0][1].discr_val, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(content[0][2].discr_val, static_cast< std::size_t >(2));

      GUM_CHECK_EQ(content[1][0].discr_val, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(content[1][1].discr_val, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(content[1][2].discr_val, static_cast< std::size_t >(1));

      GUM_CHECK_EQ(content[2][0].discr_val, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(content[2][1].discr_val, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(content[2][2].discr_val, static_cast< std::size_t >(0));

      database.reorder();
      GUM_CHECK_EQ(content[0][0].discr_val, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(content[0][1].discr_val, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(content[0][2].discr_val, static_cast< std::size_t >(0));

      GUM_CHECK_EQ(content[1][0].discr_val, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(content[1][1].discr_val, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(content[1][2].discr_val, static_cast< std::size_t >(2));

      GUM_CHECK_EQ(content[2][0].discr_val, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(content[2][1].discr_val, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(content[2][2].discr_val, static_cast< std::size_t >(1));
    }
    ...
    void test_missing_vals() {
      ...
      const auto& vnames = database.variableNames();
      GUM_CHECK_EQ(vnames.size(), static_cast< gum::Size >(4));
      GUM_CHECK_EQ(vnames[0], "var0");
      GUM_CHECK_EQ(vnames[1], "var1");
      GUM_CHECK_EQ(vnames[2], "var2");
      GUM_CHECK_EQ(vnames[3], "var3");
    ...
    static void test_threads() {
      ...
      for (std::size_t i = 0; i < xsize; ++i)
        database.insertRow(row, xmiss);
      GUM_CHECK_EQ(database.content().size(), xsize);
      GUM_CHECK_EQ(database.nbRows(), xsize);
      CHECK(!database.hasMissingValues());
    ...
    static void test_changeTranslator() {
      ...
      GUM_CHECK_EQ(db1.content().size(), static_cast< gum::Size >(0));
      GUM_CHECK_EQ(db1.variableNames().size(), static_cast< gum::Size >(3));
      ...
      const auto& r1 = c1[0];
      const auto& r2 = c1[1];
      GUM_CHECK_EQ(r1[0].discr_val, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(r2[0].discr_val, static_cast< std::size_t >(2));
      ...
      GUM_CHECK_EQ(r1[2].discr_val, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(r2[2].discr_val, static_cast< std::size_t >(1));

      CHECK_NOTHROW(db1.changeTranslator(intvar, 1));
      GUM_CHECK_EQ(r1[1].discr_val, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(r2[1].discr_val, static_cast< std::size_t >(2));
    ...
    static void testBetter() {
      ...
      gum::learning::DatabaseTable db1(set);
      GUM_CHECK_EQ(db1.content().size(), static_cast< gum::Size >(0));
      GUM_CHECK_EQ(db1.variableNames().size(), static_cast< gum::Size >(7));
      ...
      const auto better = db1.betterTranslators();
      CHECK(!better.empty());
      GUM_CHECK_EQ(better.size(), static_cast< gum::Size >(4));

      GUM_CHECK_EQ(better[0].first, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(better[0].second->variable()->varType(), gum::VarType::INTEGER);
      GUM_CHECK_EQ(better[1].first, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(better[1].second->variable()->varType(), gum::VarType::CONTINUOUS);
      GUM_CHECK_EQ(better[2].first, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(better[2].second->variable()->varType(), gum::VarType::RANGE);
      GUM_CHECK_EQ(better[3].first, static_cast< std::size_t >(4));
      GUM_CHECK_EQ(better[3].second->variable()->varType(), gum::VarType::RANGE);
      ...
      GUM_CHECK_EQ(row0[0].discr_val, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(row1[0].discr_val, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(row2[0].discr_val, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(row3[0].discr_val, static_cast< std::size_t >(3));
      ...
      GUM_CHECK_EQ(row3[1].cont_val, std::numeric_limits< float >::max());

      // col2: range(1-4)
      GUM_CHECK_EQ(row0[2].discr_val, static_cast< std::size_t >(3));
      GUM_CHECK_EQ(row1[2].discr_val, static_cast< std::size_t >(1));
      GUM_CHECK_EQ(row2[2].discr_val, std::numeric_limits< std::size_t >::max());
      GUM_CHECK_EQ(row3[2].discr_val, static_cast< std::size_t >(0));

      // col4: range(1-4)
      GUM_CHECK_EQ(row0[4].discr_val, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(row1[4].discr_val, static_cast< std::size_t >(2));
      GUM_CHECK_EQ(row2[4].discr_val, static_cast< std::size_t >(0));
      GUM_CHECK_EQ(row3[4].discr_val, static_cast< std::size_t >(0));
    }
