...
namespace gum_tests {
  ...
  GUM_TEST(MeekRuleR3_nofire_adjacent) {
    gum::MixedGraph mg;
    for (unsigned int i = 0; i < 4; ++i)
      mg.addNodeWithId(i);
    mg.addArc(2, 1);
  ...
  GUM_TEST(MeekRulesR1Cascade_R2) {
    gum::MixedGraph mg;
  ...
  GUM_TEST(MeekRulesR1R2FromPDAG) {
    gum::MixedGraph mg;
  ...
  GUM_TEST(MeekRulesR1R2FromPDAG_cpdag) {
    gum::MixedGraph mg;
    for (unsigned int i = 0; i < 8; ++i)
      mg.addNodeWithId(i);
