  ...
  struct DBRowGeneratorEMTestSuite {
    ...
    static void test_basic() {
...

      {
        ...
        CHECK((xoutput_row1[1].discr_val) == (std::size_t(1)));
        CHECK((xoutput_row1[2].discr_val) == (std::size_t(1)));
        CHECK((xoutput_row1[3].discr_val) == (std::size_t(0)));
        CHECK(!generator.hasRows());
      }

      {
        ...
        CHECK((xoutput_row2[1].discr_val) == (std::size_t(1)));
        CHECK((xoutput_row2[2].discr_val) == (std::size_t(1)));
        CHECK((xoutput_row2[3].discr_val) == (std::size_t(0)));
        CHECK(!generator.hasRows());
      }
      ...
      generator.setColumnsOfInterest(cols_of_interest1);
      {
        ...
        CHECK((xoutput_row3[3].discr_val) == (std::size_t(0)));
        ...
        CHECK((xoutput_row3b[3].discr_val) == (std::size_t(0)));
      }
      ...
      CHECK((generator2.columnsOfInterest()[1]) == (std::size_t(3)));
      ...
      CHECK((generator3.columnsOfInterest()[1]) == (std::size_t(3)));
      ...
      CHECK((generator4.columnsOfInterest()[1]) == (std::size_t(3)));
      ...
      CHECK((generator5.columnsOfInterest()[1]) == (std::size_t(3)));
      ...
      CHECK((generator6->columnsOfInterest()[1]) == (std::size_t(3)));
      ...
      CHECK((generator7->columnsOfInterest()[1]) == (std::size_t(3)));
