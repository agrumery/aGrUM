...
namespace gum_tests {
  ...
  GUM_TEST(_addEdge_circle_circle_default_) {
  ...
  GUM_TEST(_addEdge_explicit_marks_) {
  ...
  GUM_TEST(_addEdge_duplicate_noop_) {
  ...
  GUM_TEST(_markAt_returns_correct_endpoint_) {
  ...
  GUM_TEST(_isDefinitelyDirected_) {
    gum::PAG g;
    g.addNodeWithId(0);
    g.addNodeWithId(1);
  ...
  GUM_TEST(_reorientAllWith_circle_) {
    gum::PAG g;
    g.addNodeWithId(0);
    g.addNodeWithId(1);
    g.addNodeWithId(2);
  ...
  GUM_TEST(_eraseEdge_removes_marks_) {
    gum::PAG g;
    g.addNodeWithId(0);
    g.addNodeWithId(1);
    g.addEdge(0, 1);
  ...
  GUM_TEST(_eraseNode_removes_marks_) {
  ...
  GUM_TEST(_clearEdges_keeps_nodes_) {
    gum::PAG g = buildTriangle();
    g.clearEdges();
  ...
  GUM_TEST(_copy_constructor_copies_marks_) {
    gum::PAG g;
    g.addNodeWithId(0);
    g.addNodeWithId(1);
    g.addEdge(0, 1, gum::EdgeMark::Tail, gum::EdgeMark::Arrowhead);
  ...
  GUM_TEST(_copy_assignment_copies_marks_) {
    gum::PAG g;
    g.addNodeWithId(0);
    g.addNodeWithId(1);
  ...
  GUM_TEST(_toMixedGraph_tail_arrow_becomes_arc_) {
    gum::PAG g;
    g.addNodeWithId(0);
    g.addNodeWithId(1);
    g.addEdge(0, 1, gum::EdgeMark::Tail, gum::EdgeMark::Arrowhead);   // 0 → 1
  ...
  GUM_TEST(_toMixedGraph_bidirected_becomes_double_arc_) {
    gum::PAG g;
    g.addNodeWithId(0);
    g.addNodeWithId(1);
    g.addEdge(0, 1, gum::EdgeMark::Arrowhead, gum::EdgeMark::Arrowhead);   // 0 ↔ 1
  ...
  GUM_TEST(_toMixedGraph_circle_circle_becomes_edge_) {
    gum::PAG g;
    g.addNodeWithId(0);
    g.addNodeWithId(1);
    g.addEdge(0, 1);   // Circle-Circle
  ...
  GUM_TEST(_toString_no_crash_) {
    gum::PAG g = buildTriangle();
    g.setMarkAt(0, 1, gum::EdgeMark::Arrowhead);
    CHECK(!g.toString().empty());
  }

  GUM_TEST(_toDot_no_crash_) {
    gum::PAG g = buildTriangle();
    CHECK(!g.toDot().empty());
  }
