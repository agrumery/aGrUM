...
namespace gum_tests {
  ...
  struct DBTranslator4IntegerVariableTestSuite {
    ...
    static void test_trans1() {
      ...
      CHECK((translator3.translate("3").discr_val) == ((std::size_t)1));
      ...
      CHECK((translator3.variable()->toString()) == ("X1:Integer({1|3|10|12})"));
      CHECK((translator3.domainSize()) == (static_cast< gum::Size >(4)));
    ...
    static void test_trans2() {
      {
        ...
        CHECK((translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("10"));
        CHECK((translator.variable()->toString()) == ("X1:Integer({1|3|10|12})"));
        ...
        CHECK((translator2.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("3"));
        CHECK((translator2.variable()->toString()) == ("X2:Integer({1|2|3|4})"));
        ...
        CHECK((translator4.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("3"));
        CHECK((translator4.variable()->toString()) == ("X2:Integer({1|2|3|4})"));
        ...
        CHECK((translator5.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("10"));
        CHECK((translator5.variable()->toString()) == ("X1:Integer({1|3|10|12})"));
        ...
        CHECK((translator6.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("3"));
        CHECK((translator6.variable()->toString()) == ("X2:Integer({1|2|3|4})"));
        ...
        CHECK((translator7->translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("3"));
        CHECK((translator7->variable()->toString()) == ("X2:Integer({1|2|3|4})"));
        ...
        CHECK((translator8.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("3"));
        CHECK((translator8.variable()->toString()) == ("X2:Integer({1|2|3|4})"));
        ...
        CHECK((translator9.translate("3").discr_val) == ((std::size_t)1));
        ...
        CHECK((translator9.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("10"));
        CHECK((translator9.variable()->toString()) == ("X1:Integer({1|3|10|12})"));

        translator8 = std::move(translator9);
        CHECK((translator8.translate("1").discr_val) == ((std::size_t)0));
        CHECK((translator8.translate("3").discr_val) == ((std::size_t)1));
        ...
        CHECK((translator8.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
              == ("10"));
        CHECK((translator8.variable()->toString()) == ("X1:Integer({1|3|10|12})"));
