...
#define GUM_CURRENT_SUITE  MultiDimNoisyORCompound
#define GUM_CURRENT_MODULE GUMBASE

namespace gum_tests {

  struct MultiDimNoisyORCompoundTestSuite {
    public:
    ...
    static void testComputationInNoisyORCompound() {
      gum::LabelizedVariable cold("Cold", "", 2);
      gum::LabelizedVariable flu("Flu", "", 2);
      gum::LabelizedVariable malaria("Malaria", "", 2);
      gum::LabelizedVariable fever("Fever", "", 2);
    ...
    static void testComputationInNoisyORCompound2() {
  ...
  GUM_TEST_ACTIF(ComputationInNoisyORCompound)
  GUM_TEST_ACTIF(ComputationInNoisyORCompound2)
}   // namespace gum_tests
