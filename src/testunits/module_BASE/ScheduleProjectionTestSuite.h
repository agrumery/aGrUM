  ...
  class ScheduleProjectionTestSuite: public CxxTest::TestSuite {
    ...
    void test_construct() {
      ...
      gum::ScheduleProjection< gum::Potential< double > > myproj(
         f1, del_vars1, myProjectMax);
      TS_ASSERT(!myproj.implyDeletion());

      const gum::ScheduleMultiDim< gum::Potential< double > >& res =
         myproj.result();
      TS_ASSERT(res.isAbstract());

      const gum::ScheduleProjection< gum::Potential< double > >& myprojconst(
         myproj);
      TS_ASSERT(!myprojconst.implyDeletion());
      const gum::ScheduleMultiDim< gum::Potential< double > >& resconst =
         myprojconst.result();
      ...
      myproj2.execute();
      const gum::ScheduleMultiDim< gum::Potential< double > >& xres2 =
         myproj2.result();
      TS_ASSERT(xres2.multiDim() == res.multiDim());
      TS_ASSERT(xres2.multiDim() == res2);

      gum::ScheduleProjection< gum::Potential< double > > myproj3(
         f2, del_vars2, myProjectMin);
      TS_ASSERT(!myproj3.implyDeletion());
      TS_ASSERT(myproj3 != myproj);
      const gum::ScheduleMultiDim< gum::Potential< double > >& xxres3 =
         myproj3.result();
      ...
      gum::ScheduleProjection< gum::Potential< double > > myproj4b(
         std::move(myproj4));
      ...
      gum::ScheduleProjection< gum::Potential< double > > myproj5(
         f1, del_vars1, myProjectMin);
      TS_ASSERT(!myproj5.implyDeletion());
      gum::ScheduleProjection< gum::Potential< double > >* myproj6 =
         myproj5.clone();
      ...
      const gum::Sequence< const gum::IScheduleMultiDim<>* >& args =
         myproj6->args();
      ...
      const gum::Sequence< const gum::IScheduleMultiDim<>* >& xresults =
         myproj5.results();
      TS_ASSERT(xresults.size() == gum::Size(1));
      TS_ASSERT(myproj5.result() == *(xresults[0]));

      const auto&                                      myproj5const = myproj5;
      const gum::Sequence< const gum::IScheduleMultiDim<>* >& xresultsconst =
         myproj5const.results();
      ...
      gum::ScheduleProjection< gum::Potential< double > > myproj7(
         f1, del_vars1, myProjectMax);
      ...
      gum::ScheduleProjection< gum::Potential< double > > myproj8(
         f2, del_vars2, myProjectMax);
     ...
     gum::ScheduleProjection< gum::Potential< double > > myproj9(
         f2, del_vars1, myProjectMax);
    ...
    void testConstants() {
      ...
      gum::Potential< double > pot1b =
         const_cast< gum::ScheduleMultiDim< gum::Potential<double> >& >(
            myproj1b.result()).exportMultiDim();
