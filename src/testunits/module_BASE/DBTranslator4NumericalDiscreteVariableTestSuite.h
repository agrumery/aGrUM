...
namespace gum_tests {
  ...
  struct DBTranslator4NumericalDiscreteVariableTestSuite {
    public:
    // namespace gum_tests
  };
  ...
  GUM_TEST(_trans1) {
    ...
    CHECK_EQ(translator.translate("3.5").discr_val, (std::size_t)1);
    ...
    try {
      ...
      CHECK_EQ(xvar_discr.label(1), "3.5");
    ...
    CHECK_EQ(translator2.translate("3.5").discr_val, (std::size_t)1);
    ...
    CHECK_EQ(translator3.translate("3.5").discr_val, (std::size_t)1);
    ...
    CHECK_EQ(translator3.variable()->toString(), "X1:NumericalDiscrete({1|3.5|10|12})");
    CHECK_EQ(translator3.domainSize(), static_cast< gum::Size >(4));
  ...
  GUM_TEST(_trans2) {
    {
      ...
      CHECK_EQ(translator.variable()->toString(), "X1:NumericalDiscrete({1|3.5|10|12})");
      ...
      CHECK((translator2.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
            == ("3.5"));
      CHECK_EQ(translator2.variable()->toString(), "X2:NumericalDiscrete({1|2|3.5|4})");
      ...
      CHECK((translator4.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
            == ("3.5"));
      CHECK_EQ(translator4.variable()->toString(), "X2:NumericalDiscrete({1|2|3.5|4})");
      ...
      CHECK((translator5.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
            == ("10"));
      CHECK_EQ(translator5.variable()->toString(), "X1:NumericalDiscrete({1|3.5|10|12})");
      ...
      CHECK((translator6.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
            == ("3.5"));
      CHECK_EQ(translator6.variable()->toString(), "X2:NumericalDiscrete({1|2|3.5|4})");
      ...
      CHECK((translator7->translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
            == ("3.5"));
      CHECK_EQ(translator7->variable()->toString(), "X2:NumericalDiscrete({1|2|3.5|4})");
      ...
      CHECK((translator8.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
            == ("3.5"));
      CHECK_EQ(translator8.variable()->toString(), "X2:NumericalDiscrete({1|2|3.5|4})");
      ...
      CHECK_EQ(translator9.translate("3.5").discr_val, (std::size_t)1);
      ...
      CHECK((translator9.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
            == ("10"));
      CHECK_EQ(translator9.variable()->toString(), "X1:NumericalDiscrete({1|3.5|10|12})");

      translator8 = std::move(translator9);
      CHECK_EQ(translator8.translate("1").discr_val, (std::size_t)0);
      CHECK_EQ(translator8.translate("3.5").discr_val, (std::size_t)1);
      ...
      CHECK((translator8.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}))
            == ("10"));
      CHECK_EQ(translator8.variable()->toString(), "X1:NumericalDiscrete({1|3.5|10|12})");
