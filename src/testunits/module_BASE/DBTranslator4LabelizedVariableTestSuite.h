...
namespace gum_tests {
  ...
  struct DBTranslator4LabelizedVariableTestSuite {
    ...
    void xtest_trans5() {
      ...
      CHECK_EQ(translator.translate("2").discr_val, (std::size_t)2);
      ...
      CHECK_EQ(translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "2");
      CHECK_EQ(translator.variable()->toString(), "X1:Labelized({1|4|2})");
      ...
      CHECK_EQ(translator2.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "1");
      CHECK_EQ(translator2.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "2");
      CHECK_EQ(translator2.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "4");
      CHECK_EQ(translator2.variable()->toString(), "X2:Labelized({1|2|4})");
      ...
      CHECK_EQ(translator3.translate("4").discr_val, (std::size_t)1);
      CHECK_EQ(translator3.translate("2").discr_val, (std::size_t)2);
      CHECK_EQ(translator3.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "1");
      CHECK_EQ(translator3.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "4");
      CHECK_EQ(translator3.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "2");
      CHECK_EQ(translator3.variable()->toString(), "X1:Labelized({1|4|2})");
      ...
      CHECK_EQ(translator4.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "1");
      CHECK_EQ(translator4.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "2");
      CHECK_EQ(translator4.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "4");
      CHECK_EQ(translator4.variable()->toString(), "X2:Labelized({1|2|4})");
      ...
      CHECK_EQ(translator5.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "1");
      CHECK_EQ(translator5.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "4");
      CHECK_EQ(translator5.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "2");
      CHECK_EQ(translator5.variable()->toString(), "X1:Labelized({1|4|2})");
      ...
      CHECK_EQ(translator6.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "1");
      CHECK_EQ(translator6.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "2");
      CHECK_EQ(translator6.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "4");
      CHECK_EQ(translator6.variable()->toString(), "X2:Labelized({1|2|4})");
      ...
      CHECK_EQ(translator7->variable()->toString(), "X2:Labelized({1|2|4})");
      ...
      CHECK_EQ(translator5.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "1");
      CHECK_EQ(translator5.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "2");
      CHECK_EQ(translator5.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "4");
      CHECK_EQ(translator5.variable()->toString(), "X2:Labelized({1|2|4})");
      ...
      CHECK_EQ(translator3.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "1");
      CHECK_EQ(translator3.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "2");
      CHECK_EQ(translator3.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "4");
      CHECK_EQ(translator3.variable()->toString(), "X2:Labelized({1|2|4})");
  ...
  GUM_TEST(_trans1) {
    ...
    CHECK_EQ(translator.translate("toto").discr_val, (std::size_t)0);
    CHECK_EQ(translator.translate("toto").discr_val, (std::size_t)0);
    ...
    CHECK_EQ(translator.translate("toto").discr_val, (std::size_t)0);
    CHECK_EQ(translator.translate("titi").discr_val, (std::size_t)1);
    ...
    CHECK_EQ(translator2.translate("toto").discr_val, (std::size_t)0);
    CHECK_EQ(translator2.translate("titi").discr_val, (std::size_t)1);
    ...
    CHECK_EQ(translator2.translate("??").discr_val, (std::size_t)2);
    ...
    CHECK_EQ(translator3.translate("toto").discr_val, (std::size_t)0);
    CHECK_EQ(translator3.translate("titi").discr_val, (std::size_t)1);
    ...
    CHECK_EQ(translator3.translate("??").discr_val, (std::size_t)2);
  ...
  GUM_TEST(_trans3) {
    ...
    CHECK_EQ(translator.translate("toto").discr_val, (std::size_t)0);
    CHECK_EQ(translator.translate("tutu").discr_val, (std::size_t)2);
    CHECK((translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}})) == ("toto"));
    CHECK((translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}})) == ("titi"));
    ...
    CHECK((translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}})) == ("toto"));
    CHECK((translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}})) == ("titi"));
    CHECK((translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}})) == ("tutu"));
    ...
    CHECK_EQ(translator3.domainSize(), static_cast< gum::Size >(3));
  ...
  GUM_TEST(_trans6) {
    ...
    CHECK_EQ(translator.translate("toto").discr_val, (std::size_t)0);
    CHECK_EQ(translator.translate("toto").discr_val, (std::size_t)0);
    CHECK_EQ(translator.translate("N/A").discr_val, std::numeric_limits< std::size_t >::max());
    CHECK_EQ(translator.translate("?").discr_val, std::numeric_limits< std::size_t >::max());
    CHECK_EQ(translator.translate("???").discr_val, (std::size_t)2);
  ...
  GUM_TEST(_trans7) {
    ...
    CHECK_EQ((translator << "7").discr_val, (std::size_t)0);
    CHECK_EQ((translator >> gum::learning::DBTranslatedValue{std::size_t{0}}), "7");
    CHECK_EQ(translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "7");
    CHECK_EQ(translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "1");
    CHECK_EQ(translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "3");
    ...
    CHECK_EQ(new_order[1], (std::size_t)0);
    CHECK_EQ(new_order[2], (std::size_t)1);
    ...
    CHECK_EQ(translator.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "7");
    ...
    CHECK_EQ(translator2.domainSize(), static_cast< gum::Size >(3));

    CHECK_EQ((translator2 << "7").discr_val, (std::size_t)2);
    CHECK_EQ((translator2 >> gum::learning::DBTranslatedValue{std::size_t{2}}), "7");
    CHECK_EQ(translator2.translateBack(gum::learning::DBTranslatedValue{std::size_t{0}}), "1");
    CHECK_EQ(translator2.translateBack(gum::learning::DBTranslatedValue{std::size_t{1}}), "3");
    CHECK_EQ(translator2.translateBack(gum::learning::DBTranslatedValue{std::size_t{2}}), "7");
    back = translator2.translateBack(
        gum::learning::DBTranslatedValue{std::numeric_limits< std::size_t >::max()});
    CHECK(translator2.missingSymbols().exists(back));

    gum::Set< std::string > missing_kept2{"N/A", "toto"};
    CHECK_EQ(translator2.missingSymbols(), missing_kept2);

    auto new_order2 = translator2.reorder();
    CHECK_EQ(new_order2.size(), static_cast< gum::Size >(0));
  }
