...
namespace gum_tests {
  ...
  GUM_TEST(_trans1) {
    ...
    CHECK(std::stof(translator.translateBack(gum::learning::DBTranslatedValue{-5.34f})) == -5.34f);
  ...
  GUM_TEST(_trans2) {
    {
      ...
      CHECK(std::stof(translator5->translateBack(gum::learning::DBTranslatedValue{5.3f})) == 5.3f);
