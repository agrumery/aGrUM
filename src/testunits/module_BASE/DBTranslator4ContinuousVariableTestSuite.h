...
namespace gum_tests {
  ...
  class DBTranslator4ContinuousVariableTestSuite: public CxxTest::TestSuite {
    ...
    void test_trans1() {
      ...
      TS_ASSERT(translator.missingValue().cont_val == std::numeric_limits< float >::max());
      ...
      TS_ASSERT(translator2.translate("N/A").cont_val == std::numeric_limits< float >::max());
      TS_ASSERT(translator2.translate("xxx").cont_val == std::numeric_limits< float >::max());
      ...
      TS_ASSERT(translator3.translate("N/A").cont_val == std::numeric_limits< float >::max());
      TS_ASSERT(translator3.translate("xxx").cont_val == std::numeric_limits< float >::max());
      ...
      TS_ASSERT(translator4.translate("20").cont_val == std::numeric_limits< float >::max());
      ...
      TS_ASSERT(translator5.translate("-10").cont_val == std::numeric_limits< float >::max());
    ...
    void test_trans2() {
      {
        ...
        gum::learning::DBTranslator4ContinuousVariable< MyAlloc > translator(var, missing, true);
        TS_ASSERT(!translator.missingSymbols().exists("2"));
        TS_ASSERT(!translator.missingSymbols().exists("4"));
        TS_ASSERT(translator.translate("-10").cont_val == std::numeric_limits< float >::max());
        ...
        gum::learning::DBTranslator4ContinuousVariable< MyAlloc > translator2(translator);
        TS_ASSERT(!translator2.missingSymbols().exists("2"));
        TS_ASSERT(!translator2.missingSymbols().exists("4"));
        TS_ASSERT(translator2.translate("-10").cont_val == std::numeric_limits< float >::max());
        ...
        gum::learning::DBTranslator4ContinuousVariable< MyAlloc > translator3(translator2);
        TS_ASSERT(!translator3.missingSymbols().exists("2"));
        TS_ASSERT(!translator3.missingSymbols().exists("4"));
        TS_ASSERT(translator3.translate("-10").cont_val == std::numeric_limits< float >::max());
        ...
        TS_ASSERT(!translator4.missingSymbols().exists("2"));
        TS_ASSERT(!translator4.missingSymbols().exists("4"));
        TS_ASSERT(translator4.translate("-10").cont_val == std::numeric_limits< float >::max());
        ...
        MyAlloc< gum::learning::DBTranslator4ContinuousVariable< MyAlloc > > allocator(
           translator5->getAllocator());
