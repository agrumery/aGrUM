...
namespace gum_tests {
  ...
  class ScheduleTestSuite: public CxxTest::TestSuite {
    ...
    void test_construct1() {
      ...
      TS_ASSERT(xf1 == f1);
      TS_ASSERT_THROWS(schedule.insertScheduleMultiDim(f1),
                       gum::DuplicateScheduleMultiDim);
      TS_ASSERT_THROWS(schedule.insertTable(pot1, true, 1),
                       gum::DuplicateScheduleMultiDim);
      ...
      TS_ASSERT_THROWS(schedule.insertScheduleMultiDim(abstract_f),
                       gum::AbstractScheduleMultiDim);

      TS_ASSERT_THROWS(schedule.insertOperation(comb1), gum::UnknownScheduleMultiDim);
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
         schedule.emplaceBinaryCombination(result1, result3, myadd));
      ...
      const gum::ScheduleBinaryCombination< gum::Potential< double >,
         gum::Potential< double >,gum::Potential< double > >& xxcomb4 =
         dynamic_cast< const gum::ScheduleBinaryCombination<
            gum::Potential< double >, gum::Potential< double >,
               gum::Potential< double > >& > (xcomb4);
      const gum::ScheduleMultiDim< gum::Potential< double > >& xres4 =
         xxcomb4.result();
      std::vector< gum::Potential< double > > vect4;
      gum::ScheduleStorage< gum::Potential< double >, std::vector >
         store4(xres4,vect4);
     ...
     gum::ScheduleOperation<>& op2 =
         const_cast<gum::ScheduleOperation<>&>(
            schedule3.operation(gum::NodeId(2)));
      op2.execute();
      ...
      TS_ASSERT(available_operations.contains(gum::NodeId(2)));
       ...
       comb2.execute();
      const gum::ScheduleMultiDim< gum::Potential< double > >& op2_res =
      ...
      gum::ScheduleOperation<>& op1 =
         const_cast<gum::ScheduleOperation<>&>(
            schedule3.operation(gum::NodeId(1)));
      op1.execute();
      ...
      TS_ASSERT_THROWS(
         schedule3.updateAfterExecution(gum::NodeId(3), available_nodes, true),
                       gum::UnexecutedScheduleOperation);
      TS_ASSERT_THROWS(
         schedule3.updateAfterExecution(gum::NodeId(1), available_nodes, true),
                       gum::UnknownScheduleOperation);
      TS_ASSERT_THROWS(
         schedule3.updateAfterExecution(gum::NodeId(4), available_nodes, true),
                       gum::UnavailableScheduleOperation);

      comb1.execute();
      const gum::ScheduleMultiDim< gum::Potential< double > >& op1_res =
         dynamic_cast< const gum::ScheduleMultiDim< gum::Potential< double > >& >(
            *op1.results()[0]);
      ...
      gum::ScheduleOperation<>& op3 =
         const_cast<gum::ScheduleOperation<>&>(
            schedule3.operation(gum::NodeId(3)));
      op3.execute();
      schedule3.updateAfterExecution(gum::NodeId(3), available_nodes, true);
      ...
      comb3.execute();
      const gum::ScheduleMultiDim< gum::Potential< double > >& op3_res =
         dynamic_cast< const gum::ScheduleMultiDim< gum::Potential< double > >& >(
            *op3.results()[0]);
      ...
      gum::ScheduleOperation<>& op4 =
         const_cast<gum::ScheduleOperation<>&>(
            schedule3.operation(gum::NodeId(4)));
      TS_ASSERT(!op2_res.isAbstract());
      op4.execute();
      TS_ASSERT(op2_res.isAbstract());
      schedule3.updateAfterExecution(gum::NodeId(4), available_nodes, true);
      ...
      TS_ASSERT(available_operations.contains(gum::NodeId(6)));
       ...
       gum::ScheduleOperation<>& op6 =
         const_cast<gum::ScheduleOperation<>&>(
            schedule3.operation(gum::NodeId(6)));
      op6.execute();
      ...
      comb4.execute();
      const gum::ScheduleMultiDim< gum::Potential< double > >& op6_res =
         dynamic_cast< const gum::ScheduleMultiDim< gum::Potential< double > >& >(
            *op6.results()[0]);
