  ...
  class MultiDimLogitTestSuite: public CxxTest::TestSuite {
    public:
      ...
      void testComputationInLogit() {
        ...
        gum::LabelizedVariable coeur( "coeur", "", 0 ); coeur.addLabel( "NON" ).addLabel( "OUI" );

        gum::MultiDimLogit<float> p( 14.4937 );
        p << coeur << age << taux << angine; // taux, angine and coeur are causes of coeur
        ...
        float witness_proba[] = {0.8786,0.5807,0.3912,0.3773,0.2127,0.8760,1-0.0163,1-0.0710,1-0.3765};
        int nbr = 9;
