    ...
    void test_row2() {
      {
        ...
        gum::learning::DBRow< gum::learning::DBCell, MyAlloc > row4(4, gum::learning::DBCell(1), 2);
        TS_ASSERT(row4.size() == 4);
        TS_ASSERT(row4[3] == gum::learning::DBCell(1));
        TS_ASSERT(row4.weight() == 2);

        gum::learning::DBRow< gum::learning::DBCell, MyAlloc > row5{gum::learning::DBCell(2),
                                                                    gum::learning::DBCell(3),
