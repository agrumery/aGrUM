...
class CliqueGraphTestSuite: public CxxTest::TestSuite {
  private:
    void fillSets( gum::NodeSet& A,gum::NodeSet& B,gum::NodeSet& C,gum::NodeSet& D,gum::NodeSet& E ) {
      A<<1<<2;
      B<<2<<3<<4;
      C<<3<<4<<5;
      D<<2<<4<<6;
  ...
  public:
    ...
    gum::NodeSet A,B,C,D,E;fillSets( A,B,C,D,E );
      ...
      TS_ASSERT( firstClique != secondClique && firstClique != thirdClique && secondClique != thirdClique );
    }
