...
namespace gum_tests {
  ...
  private:
    ...
    gum::MultiDimArray<float>* proj ( const gum::MultiDimArray<float>& table,
  ...
  public:
    ...
    void test_MultiDimImplementation() {
      ...
      gum::MultiDimImplementation<float>* t4 = projectMaxMultiDimArray ( &t1,del_vars );
    ...
    void test_potentials() {
      ...
      gum::Potential<float>* t2 = new gum::Potential<float> ( projectMax ( t1, del_vars ) );
      ...
      gum::Potential<float>* t4 = new gum::Potential<float> ( projectMax ( t1, proj_set ) );
      t3 = proj ( t1, proj_set, 0.0f );
      TS_ASSERT ( *t4 == *t3 );
      ...
      proj_set.insert ( vars[9] );
      proj_set.insert ( vars[1] );
      gum::Potential<float>* t5 = new gum::Potential<float> ( projectMax ( t1, proj_set ) );
      delete t5;
