...
namespace gum_tests {
  ...
  struct DirichletPriorFromDatabaseTestSuite {
    ...
    static void test1() {   // create the translator set
      ...
      GUM_CHECK_EQ(prior.weight(), 2.0 * db_size);
      ...
      GUM_CHECK_EQ(vect[0], 2401.0);
      GUM_CHECK_EQ(vect[1], 251.0);
      GUM_CHECK_EQ(vect[2], 151.0);
      ...
      GUM_CHECK_EQ(vect[0], 401.0);    // 0,0
      GUM_CHECK_EQ(vect[1], 151.0);    // 1,0
      GUM_CHECK_EQ(vect[2], 1.0);      // 2,0
      GUM_CHECK_EQ(vect[3], 2001.0);   // 0,1
      GUM_CHECK_EQ(vect[4], 1.0);      // 1,1
      GUM_CHECK_EQ(vect[5], 151.0);    // 2,1
      GUM_CHECK_EQ(vect[6], 1.0);      // 0,2
      GUM_CHECK_EQ(vect[7], 101.0);    // 1,2
      GUM_CHECK_EQ(vect[8], 1.0);      // 2,2
      ...
      GUM_CHECK_EQ(vect[0], 1.0);      // 0,0
      GUM_CHECK_EQ(vect[1], 151.0);    // 1,0
      GUM_CHECK_EQ(vect[2], 1.0);      // 2,0
      GUM_CHECK_EQ(vect[3], 401.0);    // 0,1
      GUM_CHECK_EQ(vect[4], 101.0);    // 1,1
      GUM_CHECK_EQ(vect[5], 151.0);    // 2,1
      GUM_CHECK_EQ(vect[6], 2001.0);   // 0,2
      GUM_CHECK_EQ(vect[7], 1.0);      // 1,2
      GUM_CHECK_EQ(vect[8], 1.0);      // 2,2

      vect.clear();
      vect.resize(3, 1.0);
      prior.addConditioningPseudoCount(idset3, vect);
      GUM_CHECK_EQ(vect[0], 151.0);
      GUM_CHECK_EQ(vect[1], 651.0);
      GUM_CHECK_EQ(vect[2], 2001.0);


      gum::learning::DirichletPriorFromDatabase prior2(prior);
      GUM_CHECK_EQ(prior2.weight(), 2.0 * db_size);
      prior2.setWeight(1.0 * db_size);
      GUM_CHECK_EQ(prior2.weight(), db_size);

      GUM_CHECK_EQ(prior2.getType(), gum::learning::PriorType::DirichletPriorType);

      vect.clear();
      vect.resize(3, 1.0);
      prior2.addJointPseudoCount(idset1, vect);
      GUM_CHECK_EQ(vect[0], 1201.0);
      GUM_CHECK_EQ(vect[1], 126.0);
      GUM_CHECK_EQ(vect[2], 76.0);
      ...
      GUM_CHECK_EQ(vect[0], 201.0);    // 0,0
      GUM_CHECK_EQ(vect[1], 76.0);     // 1,0
      GUM_CHECK_EQ(vect[2], 1.0);      // 2,0
      GUM_CHECK_EQ(vect[3], 1001.0);   // 0,1
      GUM_CHECK_EQ(vect[4], 1.0);      // 1,1
      GUM_CHECK_EQ(vect[5], 76.0);     // 2,1
      GUM_CHECK_EQ(vect[6], 1.0);      // 0,2
      GUM_CHECK_EQ(vect[7], 51.0);     // 1,2
      GUM_CHECK_EQ(vect[8], 1.0);      // 2,2
      ...
      GUM_CHECK_EQ(vect[1], 76.0);     // 1,0
      GUM_CHECK_EQ(vect[2], 1.0);      // 2,0
      GUM_CHECK_EQ(vect[3], 201.0);    // 0,1
      GUM_CHECK_EQ(vect[4], 51.0);     // 1,1
      GUM_CHECK_EQ(vect[5], 76.0);     // 2,1
      GUM_CHECK_EQ(vect[6], 1001.0);   // 0,2
      GUM_CHECK_EQ(vect[7], 1.0);      // 1,2
      GUM_CHECK_EQ(vect[8], 1.0);      // 2,2
      ...
      GUM_CHECK_EQ(vect[0], 76.0);
      GUM_CHECK_EQ(vect[1], 326.0);
      GUM_CHECK_EQ(vect[2], 1001.0);


      gum::learning::DirichletPriorFromDatabase prior3(std::move(prior2));
      GUM_CHECK_EQ(prior3.weight(), db_size);
      prior3.setWeight(2.0 * db_size);
      GUM_CHECK_EQ(prior3.weight(), 2.0 * db_size);
      ...
      GUM_CHECK_EQ(prior4->weight(), 2.0 * db_size);
      prior4->setWeight(1.0 * db_size);
      GUM_CHECK_EQ(prior4->weight(), 1.0 * db_size);

      GUM_CHECK_EQ(prior4->getType(), gum::learning::PriorType::DirichletPriorType);
    ...
    static void test2() {
      ...
      GUM_CHECK_EQ(prior2.weight(), 2.0 * db_size);
      prior2.setWeight(1.0 * db_size);
      GUM_CHECK_EQ(prior2.weight(), 1.0 * db_size);
      ...
      gum::learning::DirichletPriorFromDatabase prior3(std::move(prior2));
      GUM_CHECK_EQ(prior3.weight(), 1.0 * db_size);
      prior3.setWeight(2.0 * db_size);
      GUM_CHECK_EQ(prior3.weight(), 2.0 * db_size);
      ...
      vect.clear();
      prior3.addConditioningPseudoCount(idset1, vect);
      GUM_CHECK_EQ(vect.size(), std::size_t(0));
