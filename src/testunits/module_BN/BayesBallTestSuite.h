...
namespace gum_tests {
  ...
  GUM_TEST(GenericChainNoEvidence) {
    gum::DAG dag;
    auto     a = dag.addNode();
    auto     b = dag.addNode();
    auto     c = dag.addNode();
  ...
  GUM_TEST(GenericChainHardEvidence) {
    gum::DAG dag;
    auto     a = dag.addNode();
    auto     b = dag.addNode();
    auto     c = dag.addNode();
  ...
  GUM_TEST(GenericColliderBlocked) {
    gum::DAG dag;
    auto     a = dag.addNode();
    auto     b = dag.addNode();
    auto     c = dag.addNode();
  ...
  GUM_TEST(GenericColliderSoftEvidence) {
    gum::DAG dag;
    auto     a = dag.addNode();
    auto     b = dag.addNode();
    auto     c = dag.addNode();
  ...
  GUM_TEST(GenericColliderHardEvidence) {
    gum::DAG dag;
    auto     a = dag.addNode();
    auto     b = dag.addNode();
    auto     c = dag.addNode();
  ...
  GUM_TEST(GenericForkHardEvidenceBlocks) {
    gum::DAG dag;
    auto     a = dag.addNode();
    auto     b = dag.addNode();
    auto     c = dag.addNode();
  ...
  GUM_TEST(GenericForkNoEvidence) {
    gum::DAG dag;
    auto     a = dag.addNode();
    auto     b = dag.addNode();
    auto     c = dag.addNode();
  ...
  GUM_TEST(GenericDConnectedVsRequisite) {
    gum::DAG dag;
    auto     a = dag.addNode();
    auto     b = dag.addNode();
    auto     c = dag.addNode();
  ...
  GUM_TEST(RelevantTensors) {
    ...
    CHECK_NOTHROW(gum::BayesBall::requisiteNodes(bn.internalDag(),
                                                 ...
                                                 softEvidence,
                                                 requisite));
    CHECK_NOTHROW(gum::BayesBall::relevantTensors(bn, query, hardEvidence, softEvidence, tensors));
