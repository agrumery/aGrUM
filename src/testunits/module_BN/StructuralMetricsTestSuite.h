...
namespace gum_tests {
  ...
  GUM_TEST(_sid_paper_figure2_h1) {
  ...
  GUM_TEST(_sid_paper_figure2_h2) {
  ...
  GUM_TEST(_sum_invariant_digraph) {
  ...
  GUM_TEST(_sum_invariant_undigraph) {
