...
namespace gum_tests {
  ...
  GUM_TEST(ConstructorFromStream) {
    std::string             file = GET_RESSOURCES_PATH("bifxml/BNBIFXMLReader_file1.bifxml");
    gum::BayesNet< double > net;
  ...
  GUM_TEST(Read_file2_from_ifstream) {
    std::string                   file = GET_RESSOURCES_PATH("bifxml/BNBIFXMLReader_file2.bifxml");
    gum::BayesNet< double >*      net  = new gum::BayesNet< double >();
    std::ifstream                 ifs(file);
    gum::BIFXMLBNReader< double > reader(net, ifs);
  ...
  GUM_TEST(Read_file2_from_istringstream) {
    std::string        file = GET_RESSOURCES_PATH("bifxml/BNBIFXMLReader_file2.bifxml");
    std::ifstream      ifs(file);
  ...
  GUM_TEST(Read_network_name_from_file) {
  ...
  GUM_TEST(Read_network_name_from_string) {
...
<DEFINITION>
  ...
  GUM_TEST(Read_from_inline_string) {
...
<DEFINITION>
  ...
  GUM_TEST(Read_from_stream_invalid_xml) {
