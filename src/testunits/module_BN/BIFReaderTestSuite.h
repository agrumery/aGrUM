...
namespace gum_tests {
  ...
  struct BIFReaderTestSuite {
    ...
    static void testRead_file1() {
      ...
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(2));
    ...
    static void testRead_file3() {
      ...
      GUM_CHECK_ASSERT_THROWS_NOTHING(nbrErr = reader.proceed());
      GUM_CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(3));
      // 3 warnings
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
      GUM_CHECK_NE(net, nullptr);
      ...
      if (net != nullptr) {
        ...
        GUM_CHECK_EQ(var_2.label(0), "foo");

        GUM_CHECK_EQ(var_2.label(1), "bar");
        ...
        GUM_CHECK_EQ(var_5.name(), "n5");

        GUM_CHECK_EQ(var_5.domainSize(), static_cast< gum::Size >(3));

        GUM_CHECK_EQ(var_5.label(0), "space");

        GUM_CHECK_EQ(var_5.label(1), "final");

        GUM_CHECK_EQ(var_5.label(2), "frontiere");
    ...
    static void testBarley() {
      ...
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(96));
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(107));
    ...
    static void testCarpo() {
      ...
      GUM_CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(361));
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
    ...
    static void testDiabetes() {
      ...
      GUM_CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(826));
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
    ...
    static void testLink() {
      ...
      GUM_CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(724));
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
    ...
    static void testMildew() {
      ...
      GUM_CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(70));
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
    ...
    static void testMunin1() {
      ...
      GUM_CHECK_ASSERT_THROWS_NOTHING(nbrErr = reader.proceed());
      GUM_CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(372));
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
    ...
    static void testPigs() {
      ...
      GUM_CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(441));
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
    ...
    void dBN_INRA_regression_testing() {
      {
        ...
        GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(3));
        GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(3));
      }
      {
        gum::BayesNet< double >  net;
    ...
    static void testWater() {
      ...
      GUM_CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
      GUM_CHECK_EQ(reader.warnings(), static_cast< gum::Size >(64));
      GUM_CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
