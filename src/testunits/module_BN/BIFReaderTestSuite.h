...
namespace gum_tests {
    ...
    void dBN_INRA_regression_testing() {
      {
        ...
        CHECK_EQ(reader.warnings(), static_cast< gum::Size >(3));
        CHECK_EQ(reader.errors(), static_cast< gum::Size >(3));
      }
      {
        gum::BayesNet< double >  net;
        gum::BIFReader< double > reader(&net, std::string(GET_RESSOURCES_PATH("bif/dBN.bif")));
        CHECK_EQ(reader.warnings(), static_cast< gum::Size >(2));
  ...
  GUM_TEST(Barley) {
    ...
    CHECK_EQ(reader.warnings(), static_cast< gum::Size >(96));
    CHECK_EQ(reader.errors(), static_cast< gum::Size >(107));
  ...
  GUM_TEST(Carpo) {
    ...
    CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
    CHECK_EQ(reader.warnings(), static_cast< gum::Size >(361));
    CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
  ...
  GUM_TEST(Link) {
    ...
    CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
    CHECK_EQ(reader.warnings(), static_cast< gum::Size >(724));
    CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
  ...
  GUM_TEST(Mildew) {
    ...
    CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
    CHECK_EQ(reader.warnings(), static_cast< gum::Size >(70));
    CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
  ...
  GUM_TEST(Munin1) {
    ...
    GUM_CHECK_ASSERT_THROWS_NOTHING(nbrErr = reader.proceed());
    CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
    CHECK_EQ(reader.warnings(), static_cast< gum::Size >(372));
    CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
  ...
  GUM_TEST(Pigs) {
    ...
    CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
    CHECK_EQ(reader.warnings(), static_cast< gum::Size >(441));
    CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
  ...
  GUM_TEST(Water) {
    ...
    CHECK_EQ(nbrErr, static_cast< gum::Size >(0));
    CHECK_EQ(reader.warnings(), static_cast< gum::Size >(64));
    CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));

    if (net) delete net;
  }

  GUM_TEST(BIFNameRoundtrip) {
