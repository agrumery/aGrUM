...
namespace gum_tests {
  ...
  struct NoPriorTestSuite {
    ...
    static void test1() {   // create the translator set
      ...
      CHECK((prior.weight()) == (0.0));
      prior.setWeight(4.0);
      CHECK((prior.weight()) == (0.0));

      CHECK((prior.getType()) == (gum::learning::PriorType::NoPriorType));
      ...
      CHECK((prior2.weight()) == (0.0));
      prior2.setWeight(4.0);
      CHECK((prior2.weight()) == (0.0));

      CHECK((prior2.getType()) == (gum::learning::PriorType::NoPriorType));
      ...
      CHECK((prior3.weight()) == (0.0));
      prior3.setWeight(4.0);
      CHECK((prior3.weight()) == (0.0));

      CHECK((prior3.getType()) == (gum::learning::PriorType::NoPriorType));
      ...
      CHECK((prior4->weight()) == (0.0));
      prior4->setWeight(4.0);
      CHECK((prior4->weight()) == (0.0));

      CHECK((prior4->getType()) == (gum::learning::PriorType::NoPriorType));
      ...
      prior5 = prior;
      CHECK((prior5.weight()) == (0.0));
      prior5.setWeight(4.0);
      CHECK((prior5.weight()) == (0.0));

      CHECK((prior5.getType()) == (gum::learning::PriorType::NoPriorType));
