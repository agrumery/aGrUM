...
namespace gum_tests {
  ...
  GUM_TEST(_asia_stable_vs_unstable_) {
    AsiaDB                       db;
  ...
  GUM_TEST(_asia_ForbiddenGraph_) {
    AsiaDB                       db;
    gum::learning::IndepTestChi2 chi2(db.parser, db.prior);
  ...
  GUM_TEST(_asia_MandatoryGraph_) {
    AsiaDB                       db;
    gum::learning::IndepTestChi2 chi2(db.parser, db.prior);
  ...
  GUM_TEST(_forbidden_pairs_not_in_skeleton_) {
  ...
  GUM_TEST(_parameter_accessors_) {
  ...
  GUM_TEST(_learnSkeleton_is_undirected_) {
  ...
  GUM_TEST(_alpha_one_skeleton_complete_) {
  ...
  GUM_TEST(_skeleton_depth0_monotone_in_alpha_) {
  ...
  GUM_TEST(_maxCondSetSize_zero_not_fewer_edges_) {
  ...
  GUM_TEST(_orientation_produces_arcs_) {
  ...
  GUM_TEST(_latentVariables_accessible_after_learn_) {
  ...
  GUM_TEST(_sorted_ucpriority_basic_) {
    AsiaDB                       db;
    gum::learning::IndepTestChi2 chi2(db.parser, db.prior);
  ...
  GUM_TEST(_sorted_same_skeleton_as_standard_) {
  ...
  GUM_TEST(_default_ucpriority_is_standard_) {
    gum::learning::PC search;
    CHECK(search.ucPriority() == gum::learning::PC::UCPriority::Standard);
  ...
  GUM_TEST(_copy_constructor_same_result_) {
  ...
  GUM_TEST(_move_constructor_same_result_) {
  ...
  // Phase B: exhaustive sepset flag
  GUM_TEST(_exhaustive_sepset_default_false_) {
    gum::learning::PC search;
    CHECK(search.exhaustiveSepSet() == false);
  }

  GUM_TEST(_exhaustive_sepset_flag_roundtrip_) {
    gum::learning::PC search;
  ...
  GUM_TEST(_exhaustive_sepset_copy_preserves_flag_) {
    gum::learning::PC search;
    search.setExhaustiveSepSet(true);
  ...
  GUM_TEST(_exhaustive_sepset_produces_valid_result_) {
    AsiaDB                       db;
    gum::learning::IndepTestChi2 chi2(db.parser, db.prior);
    gum::learning::PC            search;
    search.setIndependenceTest(chi2);
  ...
  GUM_TEST(_exhaustive_sepset_same_skeleton_as_standard_) {
    AsiaDB                       db;
    gum::learning::IndepTestChi2 chi2a(db.parser, db.prior);
    gum::learning::IndepTestChi2 chi2b(db.parser, db.prior);
