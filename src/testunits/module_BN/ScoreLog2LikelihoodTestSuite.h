...
#define GUM_CURRENT_SUITE  ScoreLog2Likelihood
#define GUM_CURRENT_MODULE BN

namespace gum_tests {

  struct ScoreLog2LikelihoodTestSuite {
    private:
    ...
    static void _test_no_range_no_nodeId2col() {
      ...
      GUM_CHECK_ASSERT_THROWS_NOTHING(gum::learning::ScoreLog2Likelihood::isPriorCompatible(
          gum::learning::PriorType::SmoothingPriorType));
      GUM_CHECK_ASSERT_THROWS_NOTHING(gum::learning::ScoreLog2Likelihood::isPriorCompatible(prior));
