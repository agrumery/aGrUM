...
#define GUM_CURRENT_SUITE  ScoreMDL
#define GUM_CURRENT_MODULE BN

namespace gum_tests {

  struct ScoreMDLTestSuite {
    private:
    ...
    static void _test_no_range_no_nodeId2col() {
      ...
      gum::learning::ScoreMDL       score(parser, prior);

      GUM_CHECK_ASSERT_THROWS_NOTHING(
          gum::learning::ScoreMDL::isPriorCompatible(gum::learning::PriorType::SmoothingPriorType));
      GUM_CHECK_ASSERT_THROWS_NOTHING(gum::learning::ScoreMDL::isPriorCompatible(prior));
      GUM_CHECK_ASSERT_THROWS_NOTHING(
    ...
    static void _test_no_range_has_nodeId2col() {
      ...
      gum::learning::ScoreMDL       score(parser, prior, nodeId2columns);
    ...
    static void _test_has_range_no_nodeId2col() {
      ...
      gum::learning::SmoothingPrior prior(database);
      gum::learning::ScoreMDL       score(parser, prior, ranges);
    ...
    static void _test_has_range_has_nodeId2col() {
      ...
      gum::learning::SmoothingPrior prior(database, nodeId2columns);
      gum::learning::ScoreMDL       score(parser, prior, ranges, nodeId2columns);
    ...
    static void test_multicore() {
      ...
      for (std::size_t i = std::size_t(1); i < std::size_t(24); ++i) {
        ...
        GUM_CHECK_ASSERT_THROWS_NOTHING(gum::learning::ScoreMDL::isPriorCompatible(
