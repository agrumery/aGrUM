...
namespace gum_tests {
 ...
 class [[maybe_unused]] XDSLBNReaderTestSuite: public CxxTest::TestSuite {
   ...
   GUM_INACTIVE_TEST(Read_file2_float) {
     std::string              file = GET_RESSOURCES_PATH("xdsl/BNXDSLReader_file2.xdsl");
     gum::BayesNet< double >* net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Read_dog_double) {
     // from Charniak, Bayesian networks Without Tears, AI Magazine, 1991
     std::string                   file = GET_RESSOURCES_PATH("xdsl/dog.xdsl");
   ...
   GUM_INACTIVE_TEST(Read_file2_double) {
     std::string              file = GET_RESSOURCES_PATH("xdsl/BNXDSLReader_file2.xdsl");
     gum::BayesNet< double >* net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Read_file3) {
     std::string              file = GET_RESSOURCES_PATH("xdsl/BNXDSLReader_file3.xdsl");
     gum::BayesNet< double >* net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Alarm) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/alarm.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Unexisting) {
     std::string              file = "Schmurtz";
     gum::BayesNet< double >* net  = new gum::BayesNet< double >();

     TS_GUM_ASSERT_THROWS_NOTHING(gum::XDSLBNReader< double > reader(net, file))
     gum::XDSLBNReader< double > reader(net, file);
   ...
   void Carpo() {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/carpo.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Diabetes) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/Diabetes.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Hailfinder) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/hailfinder.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Insurance) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/insurance.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Link) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/Link.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Mildew) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/Mildew.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Munin1) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/Munin1.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Pigs) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/Pigs.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
   ...
   GUM_INACTIVE_TEST(Water) {
     std::string                   file = GET_RESSOURCES_PATH("xdsl/Water.xdsl");
     auto                          net  = new gum::BayesNet< double >();
     gum::XDSLBNReader< double > reader(net, file);
