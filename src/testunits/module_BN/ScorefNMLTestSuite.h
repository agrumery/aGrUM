...
#define GUM_CURRENT_SUITE  ScorefNML
#define GUM_CURRENT_MODULE BN

namespace gum_tests {

  struct ScorefNMLTestSuite {
    private:
    static double _score_(const std::vector< double >& N_ijk, const std::vector< double >& N_ij) {
      double score   = 0;
      double N       = 0;
      double penalty = 0;
    ...
    static void _test_no_range_no_nodeId2col() {
      ...
      gum::learning::ScorefNML      score(parser, prior);

      GUM_CHECK_ASSERT_THROWS_NOTHING(gum::learning::ScorefNML::isPriorCompatible(
          gum::learning::PriorType::SmoothingPriorType));
      GUM_CHECK_ASSERT_THROWS_NOTHING(gum::learning::ScorefNML::isPriorCompatible(prior));
    ...
    static void _test_no_range_has_nodeId2col() {
      ...
      gum::learning::ScorefNML      score(parser, prior, nodeId2columns);
    ...
    static void _test_has_range_no_nodeId2col() {
      ...
      gum::learning::SmoothingPrior prior(database);
      gum::learning::ScorefNML      score(parser, prior, ranges);
    ...
    static void _test_has_range_has_nodeId2col() {
      ...
      gum::learning::SmoothingPrior prior(database, nodeId2columns);
      gum::learning::ScorefNML      score(parser, prior, ranges, nodeId2columns);
