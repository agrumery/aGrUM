...
namespace gum_tests {
  ...
  GUM_TEST(Insertion) {
    ...
    gum::NodeId ind = 0;
    GUM_CHECK_ASSERT_THROWS_NOTHING(const gum::DiscreteVariable& varPtr = topo.variable(idList[0]);
                                    ind                                 = topo.nodeId(varPtr););
    CHECK_EQ(idList[0], ind);

    CHECK_EQ(*((gum::LabelizedVariable*)&topo.variable(idList[0])), *var1);
    CHECK_EQ(*((gum::LabelizedVariable*)&topo.variable(idList[1])), *var2);
    CHECK_EQ(*((gum::LabelizedVariable*)&topo.variable(idList[2])), *var3);
    CHECK_EQ(*((gum::LabelizedVariable*)&topo.variable(idList[3])), *var4);
    CHECK_EQ(*((gum::LabelizedVariable*)&topo.variable(idList[4])), *var5);
  }
  ...
  GUM_TEST(MoralGraph) {
    ...
    CHECK_EQ(graph, _getRealMoralGraph_(topo, idList));
  }
