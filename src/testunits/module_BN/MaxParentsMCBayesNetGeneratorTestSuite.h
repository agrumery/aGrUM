  ...
  class MaxParentsMCBayesNetGeneratorTestSuite : public CxxTest::TestSuite {
    ...
    void testCreationDeletionFloat() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
          gen = new gum::MaxParentsMCBayesNetGenerator<float>( 30, 70, 3, 4, 30,
                                                               40, 50 ) );
    ...
    void testCreationDeletionFloatCPT() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
          gen = new gum::MaxParentsMCBayesNetGenerator<float>( 30, 70, 4, 4, 20,
                                                               10, 30 ) );
      TS_GUM_ASSERT_THROWS_NOTHING( delete gen );
    }
    ...
    void testCreationDeletionDouble() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
          gen = new gum::MaxParentsMCBayesNetGenerator<double>( 30, 70, 4, 4,
                                                                20, 10, 30 ) );
      TS_GUM_ASSERT_THROWS_NOTHING( delete gen );
    }
    ...
    void testGenerationBNDouble() {
      ...
      gum::MaxParentsMCBayesNetGenerator<double> gen( 30, 70, 5, 4, 30, 40,
                                                      50 );
    ...
    void testGenerationfromBNFloat() {
      ...
      gum::MaxParentsMCBayesNetGenerator<float> gen( 30, 70, 10, 4, 30, 40,
                                                     50 );
      gum::BayesNet<float>* bn = new gum::BayesNet<float>();
      gen.generateBN( *bn );
      TS_GUM_ASSERT_THROWS_NOTHING(
          gum::MaxParentsMCBayesNetGenerator<float> gen2( *bn, 4, 30, 40,
                                                          50 ) );
    ...
    void testGenerationfromBNDouble() {
      ...
      gen.generateBN( *bn );
      TS_GUM_ASSERT_THROWS_NOTHING(
          gum::MaxParentsMCBayesNetGenerator<double> gen2( *bn, 4, 30, 40,
                                                           50 ) );
    ...
    void testGenerationBNDoubleCPT() {
      ...
      gum::MaxParentsMCBayesNetGenerator<double> gen( 30, 70, 3, 4, 30, 40,
                                                      50 );
      gum::BayesNet<double>* bn = new gum::BayesNet<double>();
      gen.generateBN( *bn );
      TS_GUM_ASSERT_THROWS_NOTHING( gen.disturbBN( *bn ) );
    ...
    void testInferenceDouble() {
      ...
      gum::MaxParentsMCBayesNetGenerator<double> gen( 30, 70, 8, 4, 30, 40,
                                                      50 );
      gum::BayesNet<double>* bn = new gum::BayesNet<double>();
      gen.generateBN( *bn );
      // Test for inference
