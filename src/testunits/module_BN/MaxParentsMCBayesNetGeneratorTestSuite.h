  ...
  class MaxParentsMCBayesNetGeneratorTestSuite : public CxxTest::TestSuite {
    ...
    void testCreationDeletionFloat() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
          gen = new gum::MaxParentsMCBayesNetGenerator<float>(
              30, 70, 3, 4, 30, 40, 50 ) );
    ...
    void testGenerationBNDouble() {
      ...
      gum::MaxParentsMCBayesNetGenerator<double> gen(
          30, 70, 5, 4, 30, 40, 50 );
    ...
    void testGenerationfromBNFloat() {
      ...
      gum::MaxParentsMCBayesNetGenerator<float> gen(
          30, 70, 10, 4, 30, 40, 50 );
      gum::BayesNet<float>* bn = new gum::BayesNet<float>();
      gen.generateBN( *bn );
      TS_GUM_ASSERT_THROWS_NOTHING(
          gum::MaxParentsMCBayesNetGenerator<float> gen2(
              *bn, 4, 30, 40, 50 ) );
    ...
    void testGenerationfromBNDouble() {
      ...
      gen.generateBN( *bn );
      TS_GUM_ASSERT_THROWS_NOTHING(
          gum::MaxParentsMCBayesNetGenerator<double> gen2(
              *bn, 4, 30, 40, 50 ) );
