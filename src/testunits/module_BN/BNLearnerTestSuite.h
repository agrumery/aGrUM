...
namespace gum_tests {
  ...
  GUM_TEST(_induceTypes) {
    {
      ...
      gum::learning::BNLearner< double > learner2(GET_RESSOURCES_PATH("csv/asia.csv"), {"?"}, true);
  ...
  GUM_TEST(_constraintMiic_PossibleEdges) {
  ...
  GUM_TEST(_asia_constraintMiic_) {
  ...
  GUM_TEST(_alarm_constraintMiic) {
  ...
  GUM_TEST(_asia_with_domain_sizes) {
  ...
  GUM_TEST(asia_with_user_modalities_string_min) {
  ...
  GUM_TEST(_asia_with_user_modalities_string_incorrect) {
  ...
  GUM_TEST(_asia_with_user_modalities_numbers) {
    gum::learning::BNLearner< double > learner(GET_RESSOURCES_PATH("csv/asia.csv"));
  ...
  GUM_TEST(_asia_with_user_modalities_numbers_incorrect) {
    auto bn = gum::BayesNet< double >::fastPrototype(
  ...
  GUM_TEST(_asia_param_from_bn_float) {
    gum::learning::BNLearner< double > learner(GET_RESSOURCES_PATH("csv/asia3.csv"));
  ...
  GUM_TEST(_asia_param_bn_with_not_matching_variable) {
    auto s = gum::fastVariable("smoking{false|true}");
    auto l = gum::fastVariable("lung_cancer{false|true}");
    auto b = gum::fastVariable("bronchitis{false|true}");
    auto v = gum::fastVariable("visit_to_Asia{false|true}");
  ...
  GUM_TEST(_asia_param_bn_with_subset_of_variables_in_base) {
    auto s = gum::fastVariable("smoking{false|true}");
    auto t = gum::fastVariable("tuberculosis{false|true}");
    auto o = gum::fastVariable("tuberculos_or_cancer{false|true}");
    auto d = gum::fastVariable("dyspnoea{false|true}");
  ...
  GUM_TEST(_asia_param_bn_with_unknow_modality) {
    auto s = gum::fastVariable("smoking{false|true}");
    auto t = gum::fastVariable("tuberculosis{false|true}");
    auto o = gum::fastVariable("tuberculos_or_cancer{false|true}");
    auto d = gum::fastVariable("dyspnoea{false|true}");
    ...
    CHECK_THROWS_AS(
        gum::learning::BNLearner< double > learner(GET_RESSOURCES_PATH("csv/asia3-faulty.csv"), bn),
  ...
  GUM_TEST(_listener) {
    ...
    }
    {
      ...
      CHECK((listen.getNbr()) == doctest::Approx(static_cast< gum::Size >(15)).epsilon(1));   // 75
      CHECK_EQ(listen.getMess(), "stopped on request");
      CHECK_EQ(learner.messageApproximationScheme(), "stopped on request");
    }
    {
  ...
  GUM_TEST(_DBNTonda) {
    ...
    CHECK((learn4.variable(learn1.idFromName("wl_0")).toString()) == ("wl_0:Labelized({0|1|2|3})"));
  }

  GUM_TEST(_asia_with_missing_values) {
    CHECK_THROWS_AS(
        {
  ...
  GUM_TEST(_setSliceOrderWithNames) {
    gum::learning::BNLearner< double > learner(GET_RESSOURCES_PATH("csv/asia3.csv"));
    ...
    CHECK_THROWS_AS(learner3.setSliceOrder(
  ...
  GUM_TEST(NonRegressionZeroCount) {
    //////////////////////////
  ...
  GUM_TEST(ConditionalMutualInformation) {
    gum::learning::BNLearner< double > learner(GET_RESSOURCES_PATH("csv/asia3.csv"));
  ...
  GUM_TEST(_mapping_DBCOLUMN_NODEID) {
  ...
  GUM_TEST(NonRegressionGHCWithInitialDAG) {
