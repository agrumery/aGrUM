  ...
  class DirTestSuite: public CxxTest::TestSuite {
    ...
    public:
      ...
      void testPath() {
        ...
        TS_ASSERT ( gum::Directory ( "./undossierauhasard/" ).path() == "./undossierauhasard/" );
      }

      void testAbsolutePath() {
        TS_ASSERT ( gum::Directory ( "./undossierauhasard/" ).absolutePath() == "" );
        TS_ASSERT ( gum::Directory ( "./" ).absolutePath() == gum::Directory ( "../dir/" ).absolutePath() );
        TS_ASSERT ( gum::Directory ( "/usr/" ).absolutePath() == gum::Directory ( "/usr/../usr/" ).absolutePath() );
        TS_ASSERT ( gum::Directory ( "./dir1/" ).absolutePath() == gum::Directory ( "./dir2/../dir1/" ).absolutePath() );
        TS_ASSERT ( gum::Directory ( "./dir1/" ).absolutePath() != gum::Directory ( "./dir2/" ).absolutePath() );
        TS_ASSERT ( gum::Directory ( "./dir1/" ).absolutePath() != gum::Directory ( "./dir1/../dir2/" ).absolutePath() );
      }
      ...
      void testParent() {
        ...
        TS_ASSERT ( gum::Directory ( "./" ).parent().absolutePath() == gum::Directory ( "../dir/" ).parent().absolutePath() );
        TS_ASSERT ( gum::Directory ( "./" ).parent().absolutePath() == gum::Directory ( "../" ).absolutePath() );
        TS_ASSERT ( gum::Directory ( "./dir1/" ).parent().absolutePath() == gum::Directory ( "./dir1/../dir2/" ).parent().absolutePath() );
        TS_ASSERT ( gum::Directory ( "./dir1/" ).parent().absolutePath() != gum::Directory ( "./dir1/../" ).parent().absolutePath() );
      }
  };
