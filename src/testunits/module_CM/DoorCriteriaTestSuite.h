...
namespace gum_tests {
  ...
  GUM_TEST(Backdoor_EmptySetWhenNoParents) {
  ...
  GUM_TEST(Backdoor_SingleConfounderMinimal) {
  ...
  GUM_TEST(Backdoor_MinimalityFilter) {
  ...
  GUM_TEST(Frontdoor_Classic_Mediator) {
  ...
  GUM_TEST(Frontdoor_FailsWhenZDoesNotInterceptAllDirectedPaths) {
  ...
  GUM_TEST(ExistsUnblockedDirectedPath_and_NodesOnDirectedPaths) {
  ...
  GUM_TEST(Backdoor_DescendantInZIsRejected) {
  ...
  GUM_TEST(Backdoor_pyAgrumExample1) {
    // X -> Z, Z -> Y; conditioning on Z is invalid for backdoor sets
  ...
  GUM_TEST(Frontdoor_NoDirectedPath_ReturnsEmptyEnumeration) {
  ...
  GUM_TEST(Backdoor_TwoConfounders_EnumerationAndPruning) {
  ...
  GUM_TEST(Frontdoor_TwoMediators_EnumerationAndPruning) {
  ...
  GUM_TEST(Backdoor_HasBackdoorPath_Equivalence) {
  ...
  GUM_TEST(Frontdoor_RejectsZInBackdoorReach) {
  ...
  GUM_TEST(Frontdoor_PrunesImpossibleByFD3) {
  ...
  GUM_TEST(Frontdoor_NoDiPath_PrunesParentsOfX) {
  ...
  GUM_TEST(BackdoorReach_ContainsParents) {
    auto        bn  = gum::BayesNet< double >::fastPrototype("M->X;M->Y");
    const auto& dag = bn.internalDag();
  ...
  GUM_TEST(ExistsUnblockedDirectedPath_EndpointsNotBlocked) {
  ...
  GUM_TEST(Backdoor_DeterministicOrderAndNoDup) {
  ...
  GUM_TEST(Backdoor_Rejects_X_or_Y_in_Z) {
  ...
  GUM_TEST(Frontdoor_Rejects_X_or_Y_in_Z) {
  ...
  GUM_TEST(Frontdoor_Fails_With_Direct_XY_Edge) {
  ...
  GUM_TEST(Frontdoor_Enumeration_MinimalVsSupersets_Z3Hub) {
    ...
    {
      auto fds_min = gum::DoorCriteria::enumerateFrontdoorSets(dag,
                                                               idX,
  ...
  GUM_TEST(Frontdoor_Enumeration_Excludes_XY) {
  ...
  GUM_TEST(Frontdoor_NoDirectedPath_EnumeratesSingletons) {
    using BN = gum::BayesNet< double >;
  ...
  GUM_TEST(LexLess_PrefixBeforeExtension) {
  ...
  GUM_TEST(LexLess_GlobalSortedOrder) {
