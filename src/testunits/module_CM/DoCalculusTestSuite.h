...
namespace gum_tests {
  ...
  GUM_TEST(GetBackDoorTree_Simpson_StructureAndManualParity) {
  ...
  GUM_TEST(GetBackDoorTree_EmptyZ_ReducesToP_Y_given_X) {
  ...
  GUM_TEST(GetFrontDoorTree_ClassicMediator_ParityWithManual) {
  ...
  GUM_TEST(FormulaBuilders_Preconditions_ThrowOnLatentsAndEmptyZ) {
    auto                       bn = gum::BayesNet< double >::fastPrototype("X->Z;Z->Y");
    gum::CausalModel< double > cm(bn);
  ...
  GUM_TEST(IDC_Promotion_Reduces_Smoke) {
  ...
  GUM_TEST(IDC_Promotion_OnCollider_Smoke) {
  ...
  GUM_TEST(ID_AncestorRestriction_AST_DoesNotMention_Irrelevant) {
  ...
  GUM_TEST(ID_MultiComponent_Product_Smoke) {
