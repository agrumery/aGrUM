...
namespace gum_tests {
  ...
  struct CausalFormulaTestSuite {
    ...
    static void testtest_observational_conditional() {
      ...
      auto ast_denominator_leaf
          = std::make_unique< gum::ASTjointProba< double > >(NameSet{"X", "Y"});
    ...
    static void testLatexQueryRendering() {
    ...
    static void testFullLatex_And_Eval() {
    ...
    static void testToString_DelegatesToRoot() {
      auto                       bn = gum::BayesNet< double >::fastPrototype("A->B");
      gum::CausalModel< double > cm(bn);
      auto                       ast
          = std::make_unique< gum::ASTposteriorProba< double > >(bn, NameSet{"B"}, NameSet{"A"});
