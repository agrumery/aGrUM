...
namespace gum_tests {
  ...
  GUM_TEST(SimpleBN) {
    ...
    gum::CausalModel< double > cm(bn, {{"Hidden", {bn.idFromName("A"), bn.idFromName("B")}}}, true);
  ...
  GUM_TEST(InducedCausalSubModel_DropsSingletonLatent) {
  ...
  GUM_TEST(ParentsChildrenAndConnectedComponents) {
  ...
  GUM_TEST(BackdoorWithObservedConfounder) {
  ...
  GUM_TEST(BackdoorWithLatentOnly_NoObservedSet) {
    auto                       bn = gum::BayesNet< double >::fastPrototype("X->Y");
    gum::CausalModel< double > cm(bn);
  ...
  GUM_TEST(FrontdoorClassicWithLatent_ReturnsMediator) {
  ...
  GUM_TEST(FrontdoorFailsWithDirectEdge) {
  ...
  GUM_TEST(ThrowsWhenCauseOrEffectIsLatent) {
    auto                       bn = gum::BayesNet< double >::fastPrototype("X->Z;Z->Y");
    gum::CausalModel< double > cm(bn);
  ...
  GUM_TEST(AddLatentVariable_RejectsNameCollision) {
