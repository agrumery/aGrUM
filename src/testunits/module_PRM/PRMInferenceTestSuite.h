  ...
  class PRMInferenceTestSuite: public CxxTest::TestSuite {
    ...
    public:
      ...
      void testEvidence() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( g_ve = new gum::prm::GroundedInference<double>( *prm, prm->system( "aSys" ) ) );
      ...
      void testSmallGrdInference() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( ve = new gum::VariableElimination<double> ( bn ) );
        TS_GUM_ASSERT_THROWS_NOTHING( g_ve = new gum::prm::GroundedInference<double>( *small, small->system( "microSys" ) ) );
        TS_GUM_ASSERT_THROWS_NOTHING( g_ve->setBNInference( ve ) );
        // Building query
        {
          const gum::prm::Instance<double>& instance = small->system( "microSys" ).get( "c" );
          const gum::prm::Attribute<double>& attribute = instance.get( "can_print" );
          gum::prm::PRMInference<double>::Chain chain = std::make_pair( &instance, &attribute );
        ...
        {
          const gum::prm::Instance<double>& instance = small->system( "microSys" ).get( "p" );
        ...
        {
          const gum::prm::Instance<double>& instance = small->system( "microSys" ).get( "pow" );
      ...
      void testSmallSVEInference() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( sve = new gum::prm::SVE<double>( *small, small->system( "microSys" ) ) );
        {
          const gum::prm::Instance<double>& instance = small->system( "microSys" ).get( "c" );
          const gum::prm::Attribute<double>& attribute = instance.get( "can_print" );
          gum::prm::PRMInference<double>::Chain chain = std::make_pair( &instance, &attribute );
      ...
      void testSmallSVEDInference() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( sved = new gum::prm::SVED<double>( *small, small->system( "microSys" ) ) );
        {
          const gum::prm::Instance<double>& instance = small->system( "microSys" ).get( "c" );
          const gum::prm::Attribute<double>& attribute = instance.get( "can_print" );
          gum::prm::PRMInference<double>::Chain chain = std::make_pair( &instance, &attribute );
      ...
      void testSmallStructInference() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( inf = new gum::prm::StructuredInference<double>( *small, small->system( "microSys" ) ) );
        {
          const gum::prm::Instance<double>& instance = small->system( "microSys" ).get( "c" );
          const gum::prm::Attribute<double>& attribute = instance.get( "can_print" );
          gum::prm::PRMInference<double>::Chain chain = std::make_pair( &instance, &attribute );
      ...
      void testInference() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( g_ve = new gum::prm::GroundedInference<double>( *prm, prm->system( "aSys" ) ) );
        TS_GUM_ASSERT_THROWS_NOTHING( g_ve->setBNInference( ve ) );
        TS_GUM_ASSERT_THROWS_NOTHING( g_ss = new gum::prm::GroundedInference<double>( *prm, prm->system( "aSys" ) ) );
        TS_GUM_ASSERT_THROWS_NOTHING( g_ss->setBNInference( ss ) );
        TS_GUM_ASSERT_THROWS_NOTHING( g_vebb = new gum::prm::GroundedInference<double>( *prm, prm->system( "aSys" ) ) );
        ...
        for(const auto node : bn.nodes()) {
          ...
          try {
            ...
            const gum::prm::Instance<double>& instance = prm->system( "aSys" ).get( bn.variableNodeMap().name( node ).substr( 0, pos ) );
            const gum::prm::Attribute<double>& attribute = instance.get( bn.variableNodeMap().name( node ).substr( pos+1 ) );
            gum::prm::PRMInference<double>::Chain chain = std::make_pair( &instance, &attribute );
            std::string dot = ".";
      ...
      void testEvidenceSioux() {
        ...
        // Adding evidence
        {
          const gum::prm::Instance<double>& instance = prm->system( "aSys" ).get( "bw_printers[0]" );
          const gum::prm::Attribute<double>& attribute = instance.get( "(t_degraded)equipState" );
          gum::Potential<double> e;
          e.add( attribute.type().variable() );
          e.fill( ( double ) 0.0 );
          gum::Instantiation inst( e );
      ...
      void testEvidenceSioux2() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( g_ve = new gum::prm::SVE<double>( *prm, prm->system( "aSys" ) ) );
        // Adding evidence
        {
          const gum::prm::Instance<double>& instance = prm->system( "aSys" ).get( "bw_printers[0]" );
          const gum::prm::Attribute<double>& attribute = instance.get( "(t_degraded)equipState" );
      ...
      //   SVED<double>* g_ve = 0;
      //   TS_GUM_ASSERT_THROWS_NOTHING(g_ve = new SVED<double>(*prm, prm->system("aSys")));
      //   // Adding evidence
      //   {
      //     const gum::prm::Instance<double>& instance = prm->system("aSys").get("bw_printers[0]");
      //     const gum::prm::Attribute<double>& attribute = instance.get("(t_degraded)equipState");
      ...
      //     PRMInference<double>::Chain chain = std::make_pair(&instance, &attribute);
      //     TS_GUM_ASSERT_THROWS_NOTHING(g_ve->addEvidence(chain, e));
      //     TS_ASSERT(g_ve->hasEvidence(chain));
      //     TS_ASSERT(g_ve->hasEvidence(chain.first));
      //   }
      ...
      //     const gum::prm::Instance<double>& q_i = prm->system("aSys").get("pow");
      //     const gum::prm::Attribute<double>& q_a = q_i.get("state");
      //     PRMInference<double>::Chain q_chain = std::make_pair(&q_i, &q_a);
      //     gum::Potential<double> m;
