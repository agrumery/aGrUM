  ...
  class InterfaceGraphTestSuite: public CxxTest::TestSuite {
    ...
    public:
      ...
      void testConstructorDestructor() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING ( ig = new gum::prm::gspan::InterfaceGraph<double> ( __prm->system ( "microSys" ) ) );
      ...
      void generateLayer ( std::vector<gum::prm::LayerGenerator<double>::LayerData>& v, size_t layer_count ) {
