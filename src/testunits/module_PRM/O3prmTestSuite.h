...
namespace gum_tests {
  ...
  GUM_TEST(Classes) {
    try {
      gum::prm::o3prm::O3prmReader< double > reader;
      GUM_CHECK_ASSERT_THROWS_NOTHING(reader.readFile(GET_RESSOURCES_PATH("o3prm/printers.o3prm")));
      CHECK_EQ(reader.warnings(), static_cast< gum::Size >(0));
      CHECK_EQ(reader.errors(), static_cast< gum::Size >(0));
  ...
  GUM_TEST(ComplexPrinters_2) {
    try {
      ...
      // Interfaces
      gum::prm::PRMInterface< double >& Equipment = prm->getInterface("fr.lip6.printers.Equipment");
  ...
  // GUM_TEST(ComplexPrinters_8) -- disabled: test body was already commented out before this
  // migration GUM_TEST(ComplexPrinters_9) -- disabled: test body was already commented out before
  // this migration
  ...
  GUM_TEST(SystemParamClass) {
    try {
      ...
      GUM_CHECK_ASSERT_THROWS_NOTHING(prm->getClass("fr.lip6.printers.ParamClass<lambda=0.4,t=4>"));
      GUM_CHECK_ASSERT_THROWS_NOTHING(
