  ...
  class O3prmTestSuite : public CxxTest::TestSuite {
    ...
    void testTypes() {
      try {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING(reader.readFile(
            "../../../src/testunits/ressources/o3prm/types.o3prm"));
    ...
    void testClasses() {
      try {
        gum::prm::o3prm::O3prmReader<double> reader;
        TS_GUM_ASSERT_THROWS_NOTHING(reader.readFile(
            "../../../src/testunits/ressources/o3prm/printers.o3prm"));
        TS_ASSERT_EQUALS(reader.warnings(), (gum::Size)0);
        TS_ASSERT_EQUALS(reader.errors(), (gum::Size)0);
    ...
    void testComplexPrinters_8() {
      try {
        ...
        TS_ASSERT(not BWPrinter.isInputNode(
            BWPrinter["(fr.lip6.printers.t_ink)hasInk"]));
        TS_ASSERT(
            BWPrinter.isInnerNode(BWPrinter["(fr.lip6.printers.t_ink)hasInk"]));
        // Boolean hasPaper
    ...
    void testComplexPrinters_9() {
      try {
        ...
        // boolean equipState
        TS_ASSERT(
            not ColorPrinter.isOutputNode(ColorPrinter["(boolean)equipState"]));
        TS_ASSERT(
            not ColorPrinter.isInputNode(ColorPrinter["(boolean)equipState"]));
        TS_ASSERT(
        ...
        // Boolean hasPaper
        TS_ASSERT(
            not ColorPrinter.isOutputNode(ColorPrinter["(boolean)hasPaper"]));
        TS_ASSERT(
    ...
    void testComplexPrintersSystems1() {
      try {
        gum::prm::o3prm::O3prmReader<double> reader;
        TS_GUM_ASSERT_THROWS_NOTHING(
            reader.readFile("../../../src/testunits/ressources/o3prm/"
                            "complexprinters_system.o3prm"));
        TS_ASSERT_EQUALS(reader.warnings(), (gum::Size)0);
        TS_ASSERT_EQUALS(reader.errors(), (gum::Size)0);
    ...
    void testEasyWriting() {
      try {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING(reader.readFile(
            GET_PATH_STR("o3prmr/systems/MySystem.o3prm"), "systems"));
    ...
    void testSystemParamClass() {
      try {
        gum::prm::o3prm::O3prmReader<double> reader;
        std::string file = "../../../src/testunits/ressources/o3prm/"
                           "complexprinters_system.o3prm";
        std::string package = "fr.lip6.printers";
        TS_GUM_ASSERT_THROWS_NOTHING(reader.readFile(file, package));
        gum::prm::PRM<double>* prm = reader.prm();
    ...
    void testVisitAsiaTwoClassesBN() {
      try {
        ...
        gum::prm::o3prm::O3prmReader<double> reader;
        std::string file = "../../../src/testunits/ressources/o3prm/"
                           "AsiaClassAndSystemWithTwoClasses.o3prm";
        std::string package = "";
        reader.readFile(file, package);
        auto prm = reader.prm();
        gum::prm::Class<double> const* asia = nullptr;
    ...
    void testFileNotFoundInResDir() {
      ...
      gum::prm::o3prm::O3prmReader<double> reader;
      std::string file =
          "../../../src/testunits/ressources/o3prm/ThisFileDoesNotExist.o3prm";
      std::string package = "";
      // Act & Assert
      TS_ASSERT_THROWS_NOTHING(reader.readFile(file, package));
      TS_ASSERT_DIFFERS(reader.errors(), (gum::Size)0);
    ...
    void testAsiaWithErrors() {
      try {
        ...
        gum::prm::o3prm::O3prmReader<double> reader;
        std::string file =
            "../../../src/testunits/ressources/o3prm/AsiaWithError.o3prm";
        std::string package = "";
        // Act
        TS_ASSERT_THROWS_NOTHING(reader.readFile(file, package));
        // Assert
