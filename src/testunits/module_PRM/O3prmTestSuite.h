  ...
  class O3prmTestSuite : public CxxTest::TestSuite {
    ...
    void testHamza() {
      try {
        // Arrange
        gum::prm::o3prm::O3prmReader<double> reader;
        std::string file = "/Users/lto/Projects/o3prm/Hamza/printers_systems.o3prm";
        // Act
        reader.addClassPath( "/Users/lto/Projects/o3prm/Hamza/" );
        TS_ASSERT_THROWS_NOTHING( reader.readFile( file ) );
        // Assert
        TS_ASSERT_EQUALS( reader.errors(), (gum::Size)0 );
        if ( reader.errors() ) {
          reader.showElegantErrorsAndWarnings();
