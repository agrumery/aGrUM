...
public:
    ...
    void testComplexPrintersGrd() {
        try {
            ...
            si->interpretFile ( GET_RESSOURCES_PATH ( "o3prmr/ComplexPrinters/fr/lip6/printers/request.o3prmr" ) );
            auto prm = si->prm();
    ...
    void testADDWithoutSlash() {
        try {
            ...
            TS_GUM_ASSERT_THROWS_NOTHING ( si.interpretFile ( GET_RESSOURCES_PATH ( "o3prmr/ADD/Request.o3prmr" ) ) );
