...
namespace gum_tests {
  ...
  class [[maybe_unused]] PRMAggregateTestSuite: public CxxTest::TestSuite {
    ...
    GUM_TEST(LabelOperationNotAllowed) {
      // Arrange
