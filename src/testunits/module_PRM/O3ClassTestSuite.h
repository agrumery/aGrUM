...
namespace gum_tests {
  ...
  class O3ClassTestSuite : public CxxTest::TestSuite {
    ...
    void testSimpleRulesError1() {
      ...
      std::getline( output, line );
      auto msg = std::stringstream();
      msg << "|5 col 15| Attribute error : Illegal CPT value 1.1";
      TS_ASSERT_EQUALS( line, msg.str() );
      TS_ASSERT_EQUALS( prm.classes().size(), 1 );
    }
    ...
    void testClassWithReferenceError1() {
      ...
      std::getline( output, line );
      auto msg = std::stringstream();
      msg << "|9 col 29| Slot chain error : Link myfoo in chain myfoo.state "
             "not found";
      TS_ASSERT_EQUALS( line, msg.str() );
      TS_ASSERT_EQUALS( prm.classes().size(), 1 );
    }
    ...
    void testClassWithReferenceError2() {
      ...
      std::getline( output, line );
      auto msg = std::stringstream();
      msg << "|9 col 29| Slot chain error : Link stat in chain myFoo.stat not "
             "found";
      TS_ASSERT_EQUALS( line, msg.str() );
      TS_ASSERT_EQUALS( prm.classes().size(), 1 );
    }
    ...
    void testClassWithReferenceError3() {
      ...
      std::getline( output, line );
      auto msg = std::stringstream();
      msg << "|8 col 29| Slot chain error : Link myFoo in chain myFoo.state "
             "not found";
      TS_ASSERT_EQUALS( line, msg.str() );
      TS_ASSERT_EQUALS( prm.classes().size(), 1 );
    }
    ...
    void testClassWithReferenceError4() {
      ...
      std::getline( output, line );
      auto msg = std::stringstream();
      msg << "|6 col 1| Reference Slot error : Class Foo cannot reference "
             "subclass Bar";
      TS_ASSERT_EQUALS( line, msg.str() );
      TS_ASSERT_EQUALS( prm.classes().size(), 2 );
    }
    ...
    void testClassWithReferenceError5() {
      ...
      std::getline( output, line );
      auto msg = std::stringstream();
      msg << "|2 col 1| Reference Slot error : Class Bar cannot reference "
             "super class Foo";
      TS_ASSERT_EQUALS( line, msg.str() );
      TS_ASSERT_EQUALS( prm.classes().size(), 2 );
    }
    ...
    void testClassWithReferenceError6() {
      ...
      std::getline( output, line );
      auto msg = std::stringstream();
      msg << "|7 col 1| Reference Slot error : Class Foo cannot reference "
             "subclass Bar";
      TS_ASSERT_EQUALS( line, msg.str() );
    }
    ...
    void testOrAggregate() {
      ...
      const auto& bar = prm.getClass( "Bar" );
      TS_ASSERT_EQUALS( bar.attributes().size(), 0 );
      TS_ASSERT_EQUALS( bar.aggregates().size(), 1 );
      TS_ASSERT_EQUALS( bar.referenceSlots().size(), 1 );
    ...
    void testOrAggregateArray() {
      ...
      TS_ASSERT_EQUALS( bar.attributes().size(), 0 );
      TS_ASSERT_EQUALS( bar.aggregates().size(), 1 );
      TS_ASSERT_EQUALS( bar.referenceSlots().size(), 2 );
      TS_ASSERT( bar.exists( "myFoos" ) );
      TS_ASSERT( gum::prm::ClassElement<double>::isReferenceSlot(
          bar.get( "myFoos" ) ) );
      const auto& myFoo = static_cast<const gum::prm::ReferenceSlot<double>&>(
