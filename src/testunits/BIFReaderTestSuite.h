  ...
  class BIFReaderTestSuite: public CxxTest::TestSuite {
    public:
      ...
      void testRead_file3() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( isOK = reader.proceed() );
        TS_ASSERT( isOK ); TS_ASSERT_EQUALS( reader.warnings(), ( gum::Size )3 );
        // 3 warnings
        TS_ASSERT_EQUALS( reader.errors(), ( gum::Size ) 0 );
        TS_ASSERT( net != 0 );
      ...
      void testCarpo() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( isOK = reader.proceed() );
        TS_ASSERT( isOK ); TS_ASSERT_EQUALS( reader.warnings(), ( gum::Size )361 );
        TS_ASSERT_EQUALS( reader.errors(), ( gum::Size ) 0 );
      ...
      void testDiabetes() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( isOK = reader.proceed() );
        TS_ASSERT( isOK ); TS_ASSERT_EQUALS( reader.warnings(), ( gum::Size )826 );
        TS_ASSERT_EQUALS( reader.errors(), ( gum::Size ) 0 );
      ...
      void testLink() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( isOK = reader.proceed() );
        TS_ASSERT( isOK ); TS_ASSERT_EQUALS( reader.warnings(), ( gum::Size )724 );
        TS_ASSERT_EQUALS( reader.errors(), ( gum::Size ) 0 );
      ...
      void testMildew() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING( isOK = reader.proceed() );
        TS_ASSERT( isOK ); TS_ASSERT_EQUALS( reader.warnings(), ( gum::Size )70 );
        TS_ASSERT_EQUALS( reader.errors(), ( gum::Size ) 0 );
