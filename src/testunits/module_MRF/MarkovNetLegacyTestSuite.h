...
>>>>>>>> df1b713db ([aGrUM] renaming gum::MarkovNetwok to gum::MarkovRandomField. Using MRF instead of MN when needed.):src/testunits/module_MRF/MarkovRandomFieldTestSuite.h
