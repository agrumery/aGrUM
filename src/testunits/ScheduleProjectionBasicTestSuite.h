...
namespace gum {
  ...
  namespace tests {
    ...
    schedule_proj_mysum ( const gum::MultiDimImplementation<float>& t,
                          const gum::Set<const DiscreteVariable*>& del_vars ) {
    ...
    public:
      void test_construct1 () {
        ...
        ScheduleMultiDim<float> tt2 = myproj.project ( t1, del_vars, schedule );
        ...
        mymultiproj.setProjector ( schedule_proj_mymin );
        t2 = mymultiproj.project ( *( t1.getContent() ), del_vars );
        myproj.setProjector ( schedule_proj_mymin );
        ...
        ScheduleProjectionBasic<float> xxx = myproj;
        ...
        ScheduleProjectionBasic<float>* yyy = myproj.newFactory ();
