...
namespace gum_tests {
  ...
  class DBRowGeneratorTestSuite : public CxxTest::TestSuite {
    ...
    void test_identity() {
      ...
      gum::learning::DBRowGeneratorIdentity<>
        generator4 ( std::move ( generator2 ), alloc );
      ...
      gum::learning::DBRowGeneratorIdentity<>
        generator5 ( std::move ( generator3 ) );
      ...
      gum::learning::DBRowGeneratorIdentity<>*
        generator6 = generator4.clone ( alloc );
