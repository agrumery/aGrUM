  ...
  class DBTranslator4RangeVariableTestSuite : public CxxTest::TestSuite {
    ...
    void test_trans1() {
      ...
      TS_ASSERT( translator.translateBack
                 ...
                 == "-1" );
      TS_ASSERT( translator.translateBack
                 (gum::learning::DBTranslatedValue{std::size_t{6}})
                 == "0" );
      ...
      TS_ASSERT( translator2.translate ( "xxx" ).discr_val ==
                 std::numeric_limits<std::size_t>::max () );
      TS_ASSERT_THROWS( translator2.translate ( "yyy" ),
                        gum::TypeError );
      TS_ASSERT_THROWS( translator2.translate ( "1" ),
      ...
      gum::learning::DBTranslator4RangeVariable<>
        translator4 ( var, missing2, true, 3 );
      ...
      TS_ASSERT( translator4.translateBack
                 (gum::learning::DBTranslatedValue{std::size_t{2}})
                 == "4" );
      TS_ASSERT_THROWS( translator4.translateBack (gum::learning::DBTranslatedValue{std::size_t{3}}), gum::UnknownLabelInDatabase );
    }
    ...
    void test_trans4() {
     ...
     gum::learning::DBTranslator4RangeVariable<>
      ...
      gum::learning::DBTranslator4RangeVariable<MyAlloc>
        translator4 ( translator2, MyAlloc<gum::learning::DBTranslatedValue> () );
      ...
      MyAlloc<gum::learning::DBTranslator4RangeVariable<MyAlloc>>
    ...
    void xtest_trans5() {
      ...
      gum::learning::DBTranslator4RangeVariable<LearningAlloc>
        translator ( std::vector<std::string>(), 1000, alloc );
      TS_GUM_ASSERT_THROWS_NOTHING( translator.translate ( "3" ) );
      TS_ASSERT( translator.translate ( "3" ).discr_val == 0 );
      TS_ASSERT( translator.translateBack
                 (gum::learning::DBTranslatedValue{std::size_t{0}})
      ...
      gum::learning::DBTranslator4RangeVariable<LearningAlloc>
        translator6 ( std::move ( translator ) );
    ...
    void test_trans6() {
      ...
      TS_ASSERT( translator.translateBack
                 (gum::learning::DBTranslatedValue{std::size_t{5}})
                 == "7" );
      TS_ASSERT( ( translator.translateBack (gum::learning::DBTranslatedValue{std::numeric_limits<std::size_t>::max ()} ) == "N/A" ) || ( translator.translateBack (gum::learning::DBTranslatedValue{std::numeric_limits<std::size_t>::max ()} ) == "toto" ) );
