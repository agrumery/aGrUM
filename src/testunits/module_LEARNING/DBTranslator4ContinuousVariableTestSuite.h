  ...
  class DBTranslator4ContinuousVariableTestSuite : public CxxTest::TestSuite {
    ...
    void test_trans1() {
      ...
      TS_ASSERT( std::stof( translator.translateBack
                            (gum::learning::DBTranslatedValue{3.0f})) == 3 );
      ...
      TS_ASSERT( std::stof(translator.translateBack
                           (gum::learning::DBTranslatedValue{-5.34f})) == -5.34f );
      TS_ASSERT( std::stof(translator.translateBack
      ...
      TS_ASSERT( std::stof ( translator4.translateBack
                             (gum::learning::DBTranslatedValue{5.3f}) ) == 5.3f );
      TS_ASSERT_THROWS( translator4.translateBack
                        (gum::learning::DBTranslatedValue{50.0f}), gum::UnknownLabelInDatabase );
      TS_ASSERT_THROWS( translator4.translateBack
                        (gum::learning::DBTranslatedValue{-50.0f}),gum::UnknownLabelInDatabase );
      TS_ASSERT( translator4.missingSymbols().exists
                 ( translator4.translateBack
                   ( gum::learning::DBTranslatedValue
                    { std::numeric_limits<float>::max() } ) ) );
      

      gum::learning::DBTranslator4ContinuousVariable<>
        translator5 ( var, missing4, true );
      ...
      TS_ASSERT( translator5.translate ( "-10" ).cont_val ==
                 std::numeric_limits<float>::max () );
      TS_ASSERT_THROWS( translator5.translate ( "-11" ),
    ...
    void test_trans2() {
      ...
      gum::learning::DBTranslator4ContinuousVariable<MyAlloc>
      ...
      TS_ASSERT( std::stof ( translator.translateBack
                             (gum::learning::DBTranslatedValue{5.3f}) ) == 5.3f );
      TS_ASSERT_THROWS( translator.translateBack
                        (gum::learning::DBTranslatedValue{50.0f}), gum::UnknownLabelInDatabase );
      TS_ASSERT_THROWS( translator.translateBack
                        (gum::learning::DBTranslatedValue{-50.0f}),gum::UnknownLabelInDatabase );
      ...
      TS_ASSERT( std::stof ( translator2.translateBack
                             (gum::learning::DBTranslatedValue{5.3f}) ) == 5.3f );
      TS_ASSERT_THROWS( translator2.translateBack
                        (gum::learning::DBTranslatedValue{50.0f}), gum::UnknownLabelInDatabase );
      TS_ASSERT_THROWS( translator2.translateBack
                        (gum::learning::DBTranslatedValue{-50.0f}),gum::UnknownLabelInDatabase );
      ...
      TS_ASSERT( std::stof ( translator5->translateBack
                             (gum::learning::DBTranslatedValue{5.3f}) ) == 5.3f );
      TS_ASSERT_THROWS( translator5->translateBack
                        (gum::learning::DBTranslatedValue{50.0f}), gum::UnknownLabelInDatabase );
      TS_ASSERT_THROWS( translator5->translateBack
                        (gum::learning::DBTranslatedValue{-50.0f}),gum::UnknownLabelInDatabase );
      TS_ASSERT( translator5->missingSymbols().exists
                 ( translator5->translateBack
                   ( gum::learning::DBTranslatedValue
                     { std::numeric_limits<float>::max() } ) ) );
