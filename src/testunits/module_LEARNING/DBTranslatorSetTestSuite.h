...
namespace gum_tests {
  ...
  class DBTranslatorSetTestSuite : public CxxTest::TestSuite {
    ...
    void test_trans1() {
      ...
      TS_ASSERT( set.translateBack
                 ( gum::learning::DBTranslatedValue{std::size_t{0}}, 1 )
                 == "toto" );
      TS_ASSERT( std::stof ( set.translateBack
                             ( gum::learning::DBTranslatedValue{7.42f}, 0 ) )
                 == 7.42f );
      TS_ASSERT( set.translateBack
                 ( gum::learning::DBTranslatedValue{std::size_t{2}}, 2 )
                 == "???" );
      ...
      gum::learning::DBTranslator4LabelizedVariable<>
        xtrans = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<>&> ( set.translator ( 1 ) );
      ...
      gum::learning::DBTranslator4LabelizedVariable<>
        xtransb = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<>&> ( set.translatorSafe ( 1 ) );
      ...
      gum::LabelizedVariable var = dynamic_cast<const gum::LabelizedVariable&>
        ( set.variable ( 1 ) );
      TS_ASSERT ( var.domainSize () == 2 );
      TS_ASSERT ( var.label ( 0 ) == "toto" );
      TS_ASSERT ( var.label ( 1 ) == "titi" );

      gum::LabelizedVariable varb = dynamic_cast<const gum::LabelizedVariable&>
        ( set.variableSafe ( 1 ) );
    ...
    void test_trans2() {
      ...
      std::vector<std::string> missing { "?", "N/A", "???" };
      gum::learning::DBTranslator4LabelizedVariable<MyAlloc>
        translator1 ( missing, 3 );
      ...
      gum::learning::DBTranslator4LabelizedVariable<MyAlloc>
        xtrans = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<MyAlloc>&> ( set.translator ( 1 ) );
      TS_ASSERT( xtrans.translate ( "toto" ).discr_val == 0 );
      TS_ASSERT( xtrans.translate ( "titi" ).discr_val == 1 );
      TS_ASSERT( xtrans.translate ( "???" ).discr_val ==
                 std::numeric_limits<std::size_t>::max () );
      ...
      gum::learning::DBTranslator4LabelizedVariable<MyAlloc>
        xtrans2 = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<MyAlloc>&> ( set2.translator ( 1 ) );
      ...
      gum::learning::DBTranslator4LabelizedVariable<MyAlloc>
        xtrans3 = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<MyAlloc>&> ( set3.translator ( 1 ) );
      TS_ASSERT( xtrans3.translate ( "toto" ).discr_val == 0 );
      TS_ASSERT( xtrans3.translate ( "titi" ).discr_val == 1 );

      gum::learning::DBTranslatorSet<MyAlloc>
        set4 ( set, MyAlloc<gum::learning::DBTranslatedValue> () );
      ...
      gum::learning::DBTranslator4LabelizedVariable<MyAlloc>
        xtrans4 = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<MyAlloc>&> ( set4.translator ( 1 ) );
    ...
    void test_trans3() {
      ...
      TS_ASSERT( set4->translate ( row3, 2 ).discr_val == 1 );
      gum::learning::DBTranslator4LabelizedVariable<>
        xtrans4 = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<>&> ( set4->translator ( 1 ) );
      TS_ASSERT( xtrans4.translate ( "toto" ).discr_val == 0 );
      TS_ASSERT( xtrans4.translate ( "titi" ).discr_val == 1 );
    ...
    void test_trans4() {
      ...
      gum::learning::DBTranslator4LabelizedVariable<MyAlloc>
        xtrans4b = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<MyAlloc>&> ( set4->operator[] ( 1 ) );
      TS_ASSERT( xtrans4b.translate ( "toto" ).discr_val == 0 );
      TS_ASSERT( xtrans4b.translate ( "titi" ).discr_val == 1 );

      gum::learning::DBTranslator4LabelizedVariable<MyAlloc>
        xtrans4t = dynamic_cast<const gum::learning::DBTranslator4LabelizedVariable<MyAlloc>&> ( set4->translatorSafe ( 1 ) );
