  ...
  class DatabaseTableTestSuite : public CxxTest::TestSuite {
    ...
    void test_db1() {
      {
        ...
        gum::learning::DatabaseTable<>
          db2 ( db, std::allocator<gum::learning::DBTranslatedValue> () );
    ...
    void test_db2() {
      ...
      gum::learning::DBRow<gum::learning::DBTranslatedValue>
        row( 3, gum::learning::DBTranslatedValue {std::size_t(1)}, 1.0 );
      database.insertRow( row );
      ...
      database.insertRow( row );
      database.insertRow( row );
      database.insertRow( std::move( row ) );
    ...
    void test_db3() {
      ...
      std::vector<gum::learning::DBRow<gum::learning::DBTranslatedValue>>
        vectx ( 4, row2 );
      database.insertRows( vectx );
      TS_ASSERT( database.content().size() == 11 );
      std::vector<gum::learning::DBRow<gum::learning::DBTranslatedValue>>
        vecty ( 2, row );
      database.insertRows( std::move ( vecty ) );
    ...
    void test_db4() {
      ...
      TS_ASSERT( database.nbVariables() == 3 );
      gum::learning::DBRow<gum::learning::DBTranslatedValue>
        row( 3, gum::learning::DBTranslatedValue { 2.0f } );
      database.insertRow( row );
      database.insertRow( row );
      database.insertRow( row );
      database.insertRow( row );
      ...
      gum::learning::DBRow<gum::learning::DBTranslatedValue>
        row2( 2, gum::learning::DBTranslatedValue { 2.0f } );
      TS_ASSERT_THROWS( database2.insertRow( row2 ), gum::InvalidArgument );

      gum::learning::DBRow<gum::learning::DBTranslatedValue>
        row3( 3, gum::learning::DBTranslatedValue { 4.0f } );
      gum::learning::DBRow<gum::learning::DBTranslatedValue>
        row4( 3, gum::learning::DBTranslatedValue { 5.0f } );
      database2.insertRows( {row3, row4} );
    ...
    void test_db6() {
      ...
      TS_ASSERT_THROWS( database.insertTranslator ( translator, 4 ),
      ...
      TS_ASSERT_THROWS( database.insertTranslator ( translator, 5 ),
                        gum::OperationNotAllowed );

      TS_GUM_ASSERT_THROWS_NOTHING ( database.eraseTranslator ( 10 ) );
      database.eraseTranslator ( 1 );
      ...
      gum::learning::DBRow<gum::learning::DBTranslatedValue>
        row3( 2, gum::learning::DBTranslatedValue { 4.0f } );
    ...
    void test_db_parallel () {
      {
        ...
        std::vector<gum::learning::DatabaseTable<>::Handler*>
          handlers ( num_threads );
        std::vector<std::thread*> threads ( num_threads );
        std::vector<int> nb ( num_threads );
        
        for ( unsigned int i = 0; i < num_threads; ++i ) {
          threads[i] =
            new std::thread ( &DatabaseTableTestSuite::__create_handler,
                              this, &database, &( handlers[i] ), &( nb[i] ) );
        }
   ...
   void test_db_parallel2 () {
     {
       ...
       std::vector<gum::learning::DatabaseTable<>::HandlerSafe*>
         handlers ( num_threads );
       std::vector<std::thread*> threads ( num_threads );
       std::vector<int> nb ( num_threads );
    ...
    void test_ignored_colums () {
      ...
      TS_ASSERT_THROWS( database2.insertTranslator ( translator, 1 ),
                        gum::OperationNotAllowed );
      database2.insertTranslator ( translator, 2 );
      {
        const auto cols = database2.inputColumns ();
        TS_ASSERT( cols[0] == std::size_t(2) );
        TS_ASSERT( cols[1] == std::size_t(5) );
