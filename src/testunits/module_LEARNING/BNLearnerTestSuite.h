...
namespace gum_tests {
  ...
  class BNLearnerTestSuite : public CxxTest::TestSuite {
    ...
    void test_asia_with_user_modalities_numbers() {
      ...
      gum::learning::BNLearner<float> learner( GET_RESSOURCES_PATH( "asia.csv" ),
                                               modals );
      learner.useGreedyHillClimbing();
      learner.setMaxIndegree( 10 );
      learner.useScoreLog2Likelihood();
...
#undef createBoolVar
      ...
      TS_ASSERT_THROWS( gum::BayesNet<float> bn2 =
...
#undef createBoolVar
    ...
    void test_listener() {
      ...
      {
        gum::learning::BNLearner<double> learner( GET_RESSOURCES_PATH( "asia2.csv" ) );
        aSimpleBNLeanerListener listen( learner );
    ...
    void test_DBNTonda() {
      ...
      for ( I1.setFirst(), I2.setFirst(), I3.setFirst(); !I1.end();
        ...
        TS_ASSERT_EQUALS( I1.toString(),
                          I2.toString() );  // same modalities orders
        TS_ASSERT_EQUALS( I1.toString(),
                          I3.toString() );   // same modalities orders
