...
namespace gum_tests {
  ...
  public:
    ...
    struct MyCounter : public gum::learning::Counter<> {
      ...
      getConditioningCounts ( unsigned int index ) {
      ...
      getAllNodes ( unsigned int index ) const noexcept {
    ...
    void test1 () {
      ...
      counter.clear ();
      {
        ...
        TS_ASSERT ( compare_vect3 ( vecty, counter.getConditioningCounts ( id1 ), {1,2,3} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter.getConditioningCounts ( id2 ), {2,1,3} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter.getConditioningCounts ( id3 ), {3,1,2} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter.getConditioningCounts ( id4 ), {3,2,1} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter.getConditioningCounts ( id5 ), {1,3,2} ) );
      }
      ...
      counter.clear ();
      {
        ...
        TS_ASSERT ( compare_vect3 ( vecty, counter2.getConditioningCounts ( id1 ), {1,2,3} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter2.getConditioningCounts ( id2 ), {2,1,3} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter2.getConditioningCounts ( id3 ), {3,1,2} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter2.getConditioningCounts ( id4 ), {3,2,1} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter2.getConditioningCounts ( id5 ), {1,3,2} ) );
        ...
        TS_ASSERT ( compare_vect3 ( vecty, counter3.getConditioningCounts ( id1 ), {1,2,3} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter3.getConditioningCounts ( id2 ), {2,1,3} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter3.getConditioningCounts ( id3 ), {3,1,2} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter3.getConditioningCounts ( id4 ), {3,2,1} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter3.getConditioningCounts ( id5 ), {1,3,2} ) );
        ...
        TS_ASSERT ( compare_vect3 ( vecty, counter4.getConditioningCounts ( id1 ), {1,2,3} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter4.getConditioningCounts ( id2 ), {2,1,3} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter4.getConditioningCounts ( id3 ), {3,1,2} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter4.getConditioningCounts ( id4 ), {3,2,1} ) );
        TS_ASSERT ( compare_vect3 ( vecty, counter4.getConditioningCounts ( id5 ), {1,3,2} ) );
