  ...
  class CounterTestSuite : public CxxTest::TestSuite {
    ...
    void test1() {
      ...
      counter.clear();
      {
        ...
        TS_ASSERT(
            compare_vect3( vectx, counter.getAllCounts( id1 ), {1, 2, 3} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter.getAllCounts( id2 ), {2, 1, 3} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter.getAllCounts( id3 ), {3, 1, 2} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter.getAllCounts( id4 ), {3, 2, 1} ) );
        TS_ASSERT(
      ...
      counter.clear();
      {
        ...
        TS_ASSERT(
            compare_vect3( vectx, counter2.getAllCounts( id1 ), {1, 2, 3} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter2.getAllCounts( id2 ), {2, 1, 3} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter2.getAllCounts( id3 ), {3, 1, 2} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter2.getAllCounts( id4 ), {3, 2, 1} ) );
        TS_ASSERT(
        ...
        TS_ASSERT(
            compare_vect3( vectx, counter3.getAllCounts( id1 ), {1, 2, 3} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter3.getAllCounts( id2 ), {2, 1, 3} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter3.getAllCounts( id3 ), {3, 1, 2} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter3.getAllCounts( id4 ), {3, 2, 1} ) );
        TS_ASSERT(
        ...
        TS_ASSERT(
            compare_vect3( vectx, counter4.getAllCounts( id1 ), {1, 2, 3} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter4.getAllCounts( id2 ), {2, 1, 3} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter4.getAllCounts( id3 ), {3, 1, 2} ) );
        TS_ASSERT(
            compare_vect3( vectx, counter4.getAllCounts( id4 ), {3, 2, 1} ) );
        TS_ASSERT(
