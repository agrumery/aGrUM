...
namespace gum_tests {
  ...
  class RawDatabaseTableTestSuite : public CxxTest::TestSuite {
    ...
    void test_db1() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING( database.setVariableNames( {"x1", "x2" },
                                                               false ) );
      TS_GUM_ASSERT_THROWS_NOTHING( database.setVariableNames( {"x1", "x2" },
                                                               true ) );
    ...
    void test_db1_bis() {
      ...
      gum::learning::RawDatabaseTable<MyAlloc>
        db2 ( db, MyAlloc<gum::learning::DBTranslatedValue> () );
      TS_ASSERT( db2.variableNames().size() == 3 );
      TS_ASSERT( db2.nbVariables() == 3 );
      TS_ASSERT( db2.content().size() == 1 );
    ...
    void test_db3() {
      ...
      gum::learning::DBRow<gum::learning::DBCell>
        row2 ( 3, gum::learning::DBCell(5) );
      database.insertRow( row2 );
      gum::learning::DBRow<gum::learning::DBCell>
        row3 ( 3, gum::learning::DBCell(3) );
    ...
    void test_db4() {
      ...
      gum::learning::DBRow<gum::learning::DBCell>
        row2( 4, gum::learning::DBCell(2) );
      TS_ASSERT_THROWS( database2.insertRow( row2 ), gum::SizeError );

      gum::learning::DBRow<gum::learning::DBCell>
        row3( 3, gum::learning::DBCell(4) );
      gum::learning::DBRow<gum::learning::DBCell>
        row4( 3, gum::learning::DBCell(5) );
      database2.insertRows( {row3, row4} );
      typename gum::learning::RawDatabaseTable<>::HandlerSafe
        handler2( database2 );
      typename gum::learning::RawDatabaseTable<>::HandlerSafe
        handler3( database2 );
    ...
    void test_db6() {
      ...
      for ( int i = 0; i < 5; i++ ) row3[i] = std::to_string (i);
    ...
    void test_db_parallel () {
      ...
      std::vector<gum::learning::RawDatabaseTable<>::Handler*>
      ...
      for ( unsigned int i = 0; i < num_threads; ++i ) {
        threads[i] =
          new std::thread ( &RawDatabaseTableTestSuite::__create_handler,
    ...
    void test_db_parallel2 () {
      ...
      std::vector<gum::learning::RawDatabaseTable<>::HandlerSafe*>
        handlers ( num_threads );
      std::vector<std::thread*> threads ( num_threads );
      std::vector<int> nb ( num_threads );
