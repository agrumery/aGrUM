...
namespace gum_tests {
  ...
  class ScorefNML2TestSuite : public CxxTest::TestSuite {
    private:
    ...
    void test1() {
      ...
      gum::learning::ScorefNML2<> score2(score);
      ...
      gum::learning::ScorefNML2<> score3(std::move(score2));
      ...
      gum::learning::ScorefNML2<>* score4 = score3.clone();
