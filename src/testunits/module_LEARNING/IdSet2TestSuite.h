...
namespace gum_tests {
  ...
  class IdSet2TestSuite : public CxxTest::TestSuite {
    public:
    void test1() {
      gum::learning::IdSet2<> set;
      ...
      gum::learning::IdSet2<> cond_set1 = set1.conditionalIdSet();
      ...
      gum::learning::IdSet2<> cond_set1b = set1b.conditionalIdSet();
      TS_ASSERT(cond_set1b.nbLHSIds() == std::size_t(0));
      TS_ASSERT(cond_set1b.size() == std::size_t(0));

      gum::learning::IdSet2<> set5(node0, seq1, false, std::allocator< int >());
      ...
      gum::learning::IdSet2<> cond_set5 = set5.conditionalIdSet();
      ...
      gum::learning::IdSet2<> set7(set5, std::allocator< int >());
      TS_ASSERT(set7 == set6);

      gum::learning::IdSet2<> set8(std::move(set2));
      TS_ASSERT(set8 == set3);
      TS_ASSERT(set8.nbLHSIds() == std::size_t(1));
      TS_ASSERT(set8[0] == node0);

      gum::learning::IdSet2<> set9(std::move(set3), std::allocator< int >());
      TS_ASSERT(set9 == set8);
      TS_ASSERT(set9.nbLHSIds() == std::size_t(1));
      TS_ASSERT(set9[0] == node0);

      gum::learning::IdSet2<> set10(std::move(set5), std::allocator< int >());
      ...
      gum::learning::IdSet2<> set11(std::move(set6));
      ...
      gum::learning::IdSet2<>* set12 = set10.clone(std::allocator< int >());
      ...
      gum::learning::IdSet2<>* set13 = set10.clone();
      ...
      gum::learning::IdSet2<> set20(node1, node0, seq1, true);
      ...
      gum::learning::IdSet2<> set21(node1, node0, seq1, false);
      ...
      gum::learning::IdSet2<> set22(node1, node0, node2, seq1, true);
      ...
      gum::learning::IdSet2<> set23(node1, node0, node2, seq1, false);
      ...
      typename gum::learning::IdSet2<>::iterator iter3;
      ...
      gum::learning::IdSet2<> set28(0, std::vector< gum::NodeId >{2, 1}, true);
      xnb = 0;
