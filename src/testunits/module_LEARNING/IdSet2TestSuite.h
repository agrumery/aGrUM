...
namespace gum_tests {
  ...
  class IdSet2TestSuite : public CxxTest::TestSuite {
    ...
    void test1() {
      ...
      gum::learning::IdSet2<> set14 ( node1, node0, empty, true, false,
                                      std::allocator<int> () );
      ...
      gum::learning::IdSet2<> set16 ( node1, node0, empty, false, false,
                                      std::allocator<int> () );
      ...
      gum::learning::IdSet2<> set18 ( node1, node0, seq1, true, false,
                                      std::allocator<int> () );
      ...
      gum::learning::IdSet2<> set19 ( node1, node0, seq1, false, false,
                                      std::allocator<int> () );
