  ...
  public:
   void test_Ixy_NoCorr() {
      ...
      TS_ASSERT_DELTA(score.score(1, 6, std::vector<gum::NodeId>{0}),
                      __I(parser,1,6,std::vector<gum::NodeId>{0}), 0.001);
      TS_ASSERT_DELTA(score.score(2, 6, std::vector<gum::NodeId>{}),
                      __I(parser,2,6), 0.001);
      ...
      TS_ASSERT_DELTA(score.score(2, 6, 5, std::vector<gum::NodeId>{1}),
                      __I(parser,2,6,5,std::vector<gum::NodeId>{1}), 0.001);
      ...
      TS_ASSERT_DELTA( score.score(0, 6, 5, std::vector<gum::NodeId>{1, 4}),
                       __I(parser,0,6,5,std::vector<gum::NodeId>{1, 4}), 1e-4);
      TS_ASSERT_DELTA(score.score(6, 0, 5, std::vector<gum::NodeId>{1, 4}),
                      __I(parser,6,0,5,std::vector<gum::NodeId>{1, 4}), 1e-4);
    }
    ...
    void test_Ixy_Kmdl() {
      ...
      TS_ASSERT_DELTA(score.score(4, 7, std::vector<gum::NodeId>{5}),
                      __I(parser,4,7,std::vector<gum::NodeId>{5}) - 2*cst, 1e-5);
      TS_ASSERT_DELTA(score.score(1, 6, std::vector<gum::NodeId>{0}),
                      __I(parser,1,6,std::vector<gum::NodeId>{0}) - 2*cst, 1e-4);
      TS_ASSERT_DELTA(score.score(2, 6, std::vector<gum::NodeId>{}),
                      __I(parser,2,6) - cst, 1e-4);
      ...
      TS_ASSERT_DELTA(score.score(2, 6, 5, std::vector<gum::NodeId>{1}),
                      __I(parser,2,6,5,std::vector<gum::NodeId>{1}) + 2*cst, 1e-4);
