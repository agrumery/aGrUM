  ...
  class DBTranslator4LabelizedVariableTestSuite : public CxxTest::TestSuite {
    ...
    void test_trans1() {
      ...
      TS_ASSERT_THROWS( translator3.translateBack
                        ( gum::learning::DBTranslatedValue{std::size_t{3}} ), gum::UnknownLabelInDatabase );
    ...
    void test_trans2() {
      ...
      TS_ASSERT( translator3.translateBack (gum::learning::DBTranslatedValue{std::size_t{2}})
                 == "??" );
      TS_ASSERT_THROWS( translator3.translateBack (gum::learning::DBTranslatedValue{std::size_t{3}}), gum::UnknownLabelInDatabase );
    ...
    void test_trans3() {
     ...
     std::vector<std::string> missing { "?", "N/A", "???" };
      ...
      TS_ASSERT( translator.translateBack (gum::learning::DBTranslatedValue{std::size_t{2}})
       ...
       gum::learning::DBTranslator4LabelizedVariable<MyAlloc>
        translator3 ( var, missing, true, 3 );
      TS_GUM_ASSERT_THROWS_NOTHING( translator3.translate ( "toto" ) );
      TS_GUM_ASSERT_THROWS_NOTHING( translator3.translate ( "titi" ) );
      TS_ASSERT( translator3.translate ( "toto" ).discr_val == 0 );
      TS_ASSERT( translator3.translate ( "titi" ).discr_val == 1 );
      ...
      TS_ASSERT_THROWS( gum::learning::DBTranslator4LabelizedVariable<>
                        translator4 ( var, missing, true, 2 ), gum::SizeError );
    }
    ...
    void xtest_trans5() {
      ...
      LearningAlloc<gum::learning::DBTranslator4LabelizedVariable<LearningAlloc>>
    ...
    void test_trans7() {
      ...
      TS_ASSERT( translator2.translateBack (gum::learning::DBTranslatedValue{std::size_t{2}})
                 == "7" );
      back = translator2.translateBack (gum::learning::DBTranslatedValue{std::numeric_limits<std::size_t>::max ()} );
