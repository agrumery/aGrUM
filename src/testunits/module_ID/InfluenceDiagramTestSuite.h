...
namespace gum_tests {
  ...
  class InfluenceDiagramTestSuite : public CxxTest::TestSuite {
    ...
    void fill( gum::InfluenceDiagram<float>& id,
               gum::List<gum::NodeId>& idList ) {
      fillTopo( id, idList );
    ...
    void testCopyConstructor() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
          copy = new gum::InfluenceDiagram<float>( source ) );
    ...
    void testInsertion_1() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
          idList.insert( id.addChanceNode( *chanceVar3 ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          idList.insert( id.addChanceNode( *chanceVar5 ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          idList.insert( id.addUtilityNode( *utilityVar1 ) ) );
    ...
    void testInsertion_2() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
          idList.insert( id.addChanceNode( *chanceVar1 ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          idList.insert( id.addChanceNode( *chanceVar4 ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          idList.insert( id.addUtilityNode( *utilityVar2 ) ) );
      ...
      TS_ASSERT_THROWS( id.addUtilityNode( *utilityVar3 ),
                        gum::InvalidArgument );
      delete utilityVar3;
    }
    ...
    void testEraseArc() {
      ...
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[0], idList[4] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[4], idList[9] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[4], idList[5] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[5], idList[1] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[1], idList[7] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[3], idList[10] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[5], idList[2] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[1], idList[9] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[2], idList[6] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[6], idList[8] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[7], idList[8] ) ) );
      TS_GUM_ASSERT_THROWS_NOTHING(
          id.eraseArc( gum::Arc( idList[8], idList[10] ) ) );
    ...
    void testTableCoherencyVarRemoval() {
      ...
      gum::Size dmnSize_1 = id.variable( idList[7] ).domainSize() *
                            id.variable( idList[6] ).domainSize();
      ...
      gum::Size dmnSize_3 = id.variable( idList[3] ).domainSize() *
                            id.variable( idList[8] ).domainSize();
      ...
      TS_ASSERT(
          id.utility( idList[10] ).contains( id.variable( idList[8] ) ) );
      TS_ASSERT(
          id.utility( idList[10] ).contains( id.variable( idList[10] ) ) );
