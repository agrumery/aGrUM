  ...
  class BIFXMLIDReaderTestSuite: public CxxTest::TestSuite {
    public:
      void testConstuctor() {
        ...
        TS_GUM_ASSERT_THROWS_NOTHING ( reader = new gum::BIFXMLIDReader<float> ( &net, file ) );
      ...
      void testRead_file2_float() {
        ...
        if ( net != 0 ) {
          ...
          const gum::UtilityTable<float>& utUtilityVar1 = net->utility ( idMap["utilityVar1"] );
          ...
          const gum::UtilityTable<float>& utUtilityVar2 = net->utility ( idMap["utilityVar2"] );
