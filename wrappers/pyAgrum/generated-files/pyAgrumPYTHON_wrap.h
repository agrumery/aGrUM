...
public:
    ...
    virtual gum::DiscreteVariable::Type type() const;
...
public:
    SwigDirector_LazyPropagation_double(PyObject *self, gum::BayesNet< double > const &BN);
    SwigDirector_LazyPropagation_double(PyObject *self, gum::BayesNet< double > const &BN, std::vector< gum::NodeId,std::allocator< gum::NodeId > > const &elim_order);
...
public:
    SwigDirector_GibbsInference_double(PyObject *self, gum::BayesNet< double > const &BN);
