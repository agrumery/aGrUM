...
class BNDatabaseGenerator(object):
    ...
    def drawSamples(self, *args) -> float:
        ...
        Generate and stock a database generated by sampling the Bayesian network, returns the og2likelihood of this database.

        If evs is given, the samples are stored only if there are compatible with these observations.
