...
def RandomDistribution(*args):
  """RandomDistribution(gum::Size n) -> Vector_double"""
...
class CredalNet_double(_object):
    ...
    def credalNet_currentCpt(self):
        """credalNet_currentCpt(CredalNet_double self) -> gum::Property< std::vector< std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::allocator< std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::onNodes const &"""
        return _pyAgrum.CredalNet_double_credalNet_currentCpt(self)

    def credalNet_srcCpt(self):
        """credalNet_srcCpt(CredalNet_double self) -> gum::Property< std::vector< std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > >,std::allocator< std::vector< std::vector< double,std::allocator< double > >,std::allocator< std::vector< double,std::allocator< double > > > > > > >::onNodes const &"""
...
class CNInferenceEngine_double(_object):
    ...
    def getT0Cluster(self):
        """getT0Cluster(CNInferenceEngine_double self) -> gum::Property< std::vector< gum::NodeId,std::allocator< gum::NodeId > > >::onNodes const &"""
        return _pyAgrum.CNInferenceEngine_double_getT0Cluster(self)

    def getT1Cluster(self):
        """getT1Cluster(CNInferenceEngine_double self) -> gum::Property< std::vector< gum::NodeId,std::allocator< gum::NodeId > > >::onNodes const &"""
    ...
    def insertEvidence(self, *args):
        ...
        insertEvidence(CNInferenceEngine_double self, gum::Property< std::vector< double,std::allocator< double > > >::onNodes const & evidence)
        """
