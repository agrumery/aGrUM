...
class MeekRules(object):
    ...
    def orientAllEdges(self, *args) -> None:
        return _pyAgrum.MeekRules_orientAllEdges(self, *args)

    def propagatesOrientations(self, *args) -> None:
        return _pyAgrum.MeekRules_propagatesOrientations(self, *args)
