...
class Vector_long(object):
    ...
    def iterator(self) -> "swig::SwigPyIterator *":
        return _pyAgrum.Vector_long_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self) -> bool:
        return _pyAgrum.Vector_long___nonzero__(self)

    def __bool__(self) -> bool:
        return _pyAgrum.Vector_long___bool__(self)

    def __len__(self) -> "std::vector< int >::size_type":
        return _pyAgrum.Vector_long___len__(self)

    def __getslice__(self, i: "std::vector< int >::difference_type", j: "std::vector< int >::difference_type") -> List[int]:
        return _pyAgrum.Vector_long___getslice__(self, i, j)

    def __setslice__(self, *args) -> None:
        return _pyAgrum.Vector_long___setslice__(self, *args)

    def __delslice__(self, i: "std::vector< int >::difference_type", j: "std::vector< int >::difference_type") -> None:
        return _pyAgrum.Vector_long___delslice__(self, i, j)

    def __delitem__(self, *args) -> None:
        return _pyAgrum.Vector_long___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< int >::value_type const &":
        return _pyAgrum.Vector_long___getitem__(self, *args)

    def __setitem__(self, *args) -> None:
        return _pyAgrum.Vector_long___setitem__(self, *args)

    def pop(self) -> "std::vector< int >::value_type":
        return _pyAgrum.Vector_long_pop(self)

    def append(self, x: "std::vector< int >::value_type const &") -> None:
        return _pyAgrum.Vector_long_append(self, x)

    def empty(self) -> bool:
        return _pyAgrum.Vector_long_empty(self)

    def size(self) -> "std::vector< int >::size_type":
        return _pyAgrum.Vector_long_size(self)

    def swap(self, v: "Vector_long") -> None:
        return _pyAgrum.Vector_long_swap(self, v)

    def begin(self) -> "std::vector< int >::iterator":
        return _pyAgrum.Vector_long_begin(self)

    def end(self) -> "std::vector< int >::iterator":
        return _pyAgrum.Vector_long_end(self)

    def rbegin(self) -> "std::vector< int >::reverse_iterator":
        return _pyAgrum.Vector_long_rbegin(self)

    def rend(self) -> "std::vector< int >::reverse_iterator":
        return _pyAgrum.Vector_long_rend(self)

    def clear(self) -> None:
        return _pyAgrum.Vector_long_clear(self)

    def get_allocator(self) -> "std::vector< int >::allocator_type":
        return _pyAgrum.Vector_long_get_allocator(self)

    def pop_back(self) -> None:
        return _pyAgrum.Vector_long_pop_back(self)

    def erase(self, *args) -> "std::vector< int >::iterator":
        return _pyAgrum.Vector_long_erase(self, *args)

    def __init__(self, *args):
        _pyAgrum.Vector_long_swiginit(self, _pyAgrum.new_Vector_long(*args))

    def push_back(self, x: "std::vector< int >::value_type const &") -> None:
        return _pyAgrum.Vector_long_push_back(self, x)

    def front(self) -> "std::vector< int >::value_type const &":
        return _pyAgrum.Vector_long_front(self)

    def back(self) -> "std::vector< int >::value_type const &":
        return _pyAgrum.Vector_long_back(self)

    def assign(self, n: "std::vector< int >::size_type", x: "std::vector< int >::value_type const &") -> None:
        return _pyAgrum.Vector_long_assign(self, n, x)

    def resize(self, *args) -> None:
        return _pyAgrum.Vector_long_resize(self, *args)

    def insert(self, *args) -> None:
        return _pyAgrum.Vector_long_insert(self, *args)

    def reserve(self, n: "std::vector< int >::size_type") -> None:
        return _pyAgrum.Vector_long_reserve(self, n)

    def capacity(self) -> "std::vector< int >::size_type":
        return _pyAgrum.Vector_long_capacity(self)
    __swig_destroy__ = _pyAgrum.delete_Vector_long

# Register Vector_long in _pyAgrum:
_pyAgrum.Vector_long_swigregister(Vector_long)
