...
class MeekRules(object):
    ...
    def orientAllEdges(self, graph: "MixedGraph", _latentCouples_: List[Tuple[int,int]]) -> None:
        return _pyAgrum.MeekRules_orientAllEdges(self, graph, _latentCouples_)

    def propagatesOrientations(self, graph: "MixedGraph", _latentCouples_: List[Tuple[int,int]]) -> None:
        return _pyAgrum.MeekRules_propagatesOrientations(self, graph, _latentCouples_)

    def orientToPDAG(self, *args) -> "pyAgrum.PDAG":
        return _pyAgrum.MeekRules_orientToPDAG(self, *args)

    def orientToDAG(self, *args) -> "pyAgrum.DAG":
        return _pyAgrum.MeekRules_orientToDAG(self, *args)
