...
* :py:class:`pyAgrum.Potential` include tensor operators (see for instance this `notebook <http://www-desir.lip6.fr/~phw/aGrUM/docs/last/notebooks/05-Demo_potentials.ipynb.html>`_).
