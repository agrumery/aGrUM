...
class IteratorError(GumException):
    ...
    def __init__(self, *args):
        r"""
        __init__(IteratorError self, std::string const & aMsg, std::string const & aType="Error in iterator") -> IteratorError
        __init__(IteratorError self, IteratorError src) -> IteratorError
        """
...
class ArgumentError(GumException):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArgumentError self, std::string const & aMsg, std::string const & aType="Argument error") -> ArgumentError
        __init__(ArgumentError self, ArgumentError src) -> ArgumentError
        """
