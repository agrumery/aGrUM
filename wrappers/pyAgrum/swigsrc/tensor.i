...
%extend gum::Tensor<double> {
  ...
  %pythoncode {
    ...
    def var_names(self):
        ...
        Warnings
        --------
            This methods is deprecated. Please use gum.Tensor.names and note the change in the order !
    ...
    def var_dims(self):
        ...
        Warnings
        --------
            This methods is deprecated. Please use gum.Tensor.shape and note the change in the order !
