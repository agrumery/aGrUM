...
def availableMNExts():
    warnings.warn("""
** pyAgrum.availableMNExts() is deprecated since pyAgrum>1.17.2. Please use pyAgrum.availableMRFExts() instead.
""", DeprecationWarning, stacklevel=2)
    return availableMRFExts()


def loadMN(*args, **kwargs):
    warnings.warn("""
** pyAgrum.loadMN() is deprecated since pyAgrum>1.17.2. Please use pyAgrum.loadMRF() instead.
""", DeprecationWarning, stacklevel=2)
    return loadMRF(*args, **kwargs)


def saveMN(*args, **kwargs):
    warnings.warn("""
