# MODIFIED VERSION OF SWIG_ADD_MODULE FOR AGRUM (cpp generated file in outdir)
# 2013 Piere-Henri WUILLMEIN
...
#
macro(GUM_SWIG_ADD_SOURCE_TO_MODULE name outfiles infile)
  ...
  add_custom_command(
    ...
    ${swig_generated_file_fullname}
    COMMAND sed
    ARGS -i 's/\\bRelevantPotentialsFinderType\\b/gum::RelevantPotentialsFinderType/g'
    ${swig_generated_file_fullname}
    COMMAND sed
...
# Create Swig module
#
macro(GUM_SWIG_ADD_MODULE name language)
  ...
  foreach(it ${swig_dot_i_sources})
    GUM_SWIG_ADD_SOURCE_TO_MODULE(${name} swig_generated_source ${it})
