...
class ArgumentError(GumException):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArgumentError self, std::string const & aMsg, std::string const & aType="Reference error") -> ArgumentError
...
_pyAgrum.ReferenceError_swigregister(ArgumentError)
