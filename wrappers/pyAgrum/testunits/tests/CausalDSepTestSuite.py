...
class TestDSep(pyAgrumTestCase):
    ...
    def setUp(self):
        ...
        self.iA, self.iB, self.iC, self.iD, self.iE, self.iF, self.iG, self.iH = [
            self.bn.idFromName(s) for s in "ABCDEFGH"]
        self.tous = {self.iA, self.iB, self.iC,
                     self.iD, self.iE, self.iF, self.iG, self.iH}
    ...
    def test_minimalCondSet4A(self):
        ...
        r = self.bn.minimalCondSet(
            self.iA, {self.iB, self.iC, self.iE, self.iF, self.iG})
        self.assertEqual(r, {self.iB, self.iC})

        r = self.bn.minimalCondSet(
            self.iA, {self.iC, self.iE, self.iF, self.iG})
    ...
    def test_minimalCondSet4C(self):
        ...
        r = self.bn.minimalCondSet(
            self.iC, {self.iB, self.iE, self.iF, self.iG})
        self.assertEqual(r, {self.iE, self.iB})

        r = self.bn.minimalCondSet(
            self.iC, {self.iC, self.iE, self.iF, self.iG})
        self.assertEqual(r, {self.iC})
    ...
    def test_minimaCondSetForJoint(self):
        ...
        r = self.bn.minimalCondSet(
            {self.iA, self.iB}, self.tous - {self.iA, self.iB})
        self.assertEqual(r, {self.iC, self.iD})
        r = self.bn.minimalCondSet(
            {self.iC, self.iE}, self.tous - {self.iC, self.iE})
...
class TestBackDoors(pyAgrumTestCase):
    ...
    def test_backdoors(self):
        ...
        self.assertTrue(self.hasNoBackDoor(
            "N0<-N1->N2;N0<-N3->N2;N0<-N4->N2;N2->N0;N1->N4", "N1", "N0"))
        ...
        self.assertTrue(self.hasNoBackDoor(
            ...
            "N1",
            "N0"))
        self.assertTrue(self.hasBackDoor(
