...
class ShapMarginalTestCase(pyAgrumTestCase):
  ...
  def test__shap_ndim(self):
    ...
    self.assertAlmostEqual(0.0, expl["Id"], 5)
    self.assertAlmostEqual(0.0, expl["SepalLengthCm"], 5)
    self.assertNotAlmostEqual(0.0, expl["SepalWidthCm"], 5)
